...
title: 'Chapter 526: Quest: King''s Cross Limbo'
description: 'Quest: King''s Cross Limbo - Implementation details and reference'
tags:
  - vii chronicle
  - 37 year 7 part 2
---
...
**Quest: King''s Cross Limbo** is a King''s Cross Limbo quest that takes place during Year 7. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: King''s Cross Limbo quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: King''s Cross Limbo quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: King''s Cross Limbo quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: King''s Cross Limbo | Official quest name |
| **Quest ID** | quest__king__s_cross_limbo | Unique identifier |
| **Quest Type** | King''s Cross Limbo | Classification |
...
/**
 * Implementation of the Quest: King''s Cross Limbo quest.
 * advances the main story
 */
public class QuestKingsCrossLimboQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__king__s_cross_limbo";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestKingsCrossLimboQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 7);
...
public static final Quest QUESTKINGSCROSSLIMBO = register(
    new QuestKingsCrossLimboQuest(),
