...
title: 'Chapter 451: Quest: Tom Riddle''s Diary'
description: 'Quest: Tom Riddle''s Diary - Implementation details and reference'
tags:
  - vii chronicle
  - 31 year 2
---
...
**Quest: Tom Riddle''s Diary** is a Tom Riddle''s Diary quest that takes place during Year 2. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: Tom Riddle''s Diary quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: Tom Riddle''s Diary quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: Tom Riddle''s Diary quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: Tom Riddle''s Diary | Official quest name |
| **Quest ID** | quest__tom_riddle__s_diary | Unique identifier |
| **Quest Type** | Tom Riddle''s Diary | Classification |
...
/**
 * Implementation of the Quest: Tom Riddle''s Diary quest.
 * advances the main story
 */
public class QuestTomRiddlesDiaryQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__tom_riddle__s_diary";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestTomRiddlesDiaryQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 2);
...
public static final Quest QUESTTOMRIDDLESDIARY = register(
    new QuestTomRiddlesDiaryQuest(),
