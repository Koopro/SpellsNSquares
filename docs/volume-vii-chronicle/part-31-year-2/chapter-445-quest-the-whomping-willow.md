...
title: 'Chapter 445: Quest: The Whomping Willow'
description: 'Quest: The Whomping Willow - Implementation details and reference'
tags:
  - vii chronicle
  - 31 year 2
---
...
**Quest: The Whomping Willow** is a The Whomping Willow quest that takes place during Year 2. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: The Whomping Willow quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: The Whomping Willow quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: The Whomping Willow quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: The Whomping Willow | Official quest name |
| **Quest ID** | quest__the_whomping_willow | Unique identifier |
| **Quest Type** | The Whomping Willow | Classification |
...
/**
 * Implementation of the Quest: The Whomping Willow quest.
 * advances the main story
 */
public class QuestTheWhompingWillowQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__the_whomping_willow";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestTheWhompingWillowQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 2);
...
public static final Quest QUESTTHEWHOMPINGWILLOW = register(
    new QuestTheWhompingWillowQuest(),
