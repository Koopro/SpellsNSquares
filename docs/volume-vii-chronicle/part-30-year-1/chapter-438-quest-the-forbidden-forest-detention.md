...
title: 'Chapter 438: Quest: The Forbidden Forest Detention'
description: 'Quest: The Forbidden Forest Detention - Implementation details and reference'
tags:
  - vii chronicle
  - 30 year 1
---
...
**Quest: The Forbidden Forest Detention** is a The Forbidden Forest Detention quest that takes place during Year 1. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: The Forbidden Forest Detention quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: The Forbidden Forest Detention quest is part of the main story progression and plays a crucial role in the narrative.

**Quest Chain:**
Part of the Year 1 quest chain

**Story Context:**
This quest occurs during Year 1 and is part of the main storyline.
...
A comprehensive step-by-step guide for completing the Quest: The Forbidden Forest Detention quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: The Forbidden Forest Detention | Official quest name |
| **Quest ID** | quest__the_forbidden_forest_detention | Unique identifier |
| **Quest Type** | The Forbidden Forest Detention | Classification |
| **Year** | Year 1 | Story year |
...
/**
 * Implementation of the Quest: The Forbidden Forest Detention quest.
 * advances the main story
 */
public class QuestTheForbiddenForestDetentionQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__the_forbidden_forest_detention";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestTheForbiddenForestDetentionQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 1);
...
public static final Quest QUESTTHEFORBIDDENFORESTDETENTION = register(
    new QuestTheForbiddenForestDetentionQuest(),
