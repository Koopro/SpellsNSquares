...
title: 'Chapter 432: Quest: First Classes'
description: 'Quest: First Classes - Implementation details and reference'
tags:
  - vii chronicle
  - 30 year 1
---
...
**Quest: First Classes** is a First Classes quest that takes place during Year 1. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: First Classes quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: First Classes quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: First Classes quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: First Classes | Official quest name |
| **Quest ID** | quest__first_classes | Unique identifier |
| **Quest Type** | First Classes | Classification |
...
/**
 * Implementation of the Quest: First Classes quest.
 * advances the main story
 */
public class QuestFirstClassesQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__first_classes";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestFirstClassesQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 1);
...
public static final Quest QUESTFIRSTCLASSES = register(
    new QuestFirstClassesQuest(),
