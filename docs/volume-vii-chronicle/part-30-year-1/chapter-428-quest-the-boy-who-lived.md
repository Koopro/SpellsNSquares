...
title: 'Chapter 428: Quest: The Boy Who Lived'
description: 'Quest: The Boy Who Lived - Implementation details and reference'
tags:
  - vii chronicle
  - 30 year 1
---
...
**Quest: The Boy Who Lived** is a The Boy Who Lived quest that takes place during Year 1. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: The Boy Who Lived quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: The Boy Who Lived quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: The Boy Who Lived quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: The Boy Who Lived | Official quest name |
| **Quest ID** | quest__the_boy_who_lived | Unique identifier |
| **Quest Type** | The Boy Who Lived | Classification |
...
/**
 * Implementation of the Quest: The Boy Who Lived quest.
 * advances the main story
 */
public class QuestTheBoyWhoLivedQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__the_boy_who_lived";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestTheBoyWhoLivedQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 1);
...
public static final Quest QUESTTHEBOYWHOLIVED = register(
    new QuestTheBoyWhoLivedQuest(),
