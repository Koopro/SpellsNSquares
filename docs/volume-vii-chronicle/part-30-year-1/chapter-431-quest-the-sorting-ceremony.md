...
title: 'Chapter 431: Quest: The Sorting Ceremony'
description: 'Quest: The Sorting Ceremony - Implementation details and reference'
tags:
  - vii chronicle
  - 30 year 1
---
...
**Quest: The Sorting Ceremony** is a The Sorting Ceremony quest that takes place during Year 1. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: The Sorting Ceremony quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: The Sorting Ceremony quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: The Sorting Ceremony quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: The Sorting Ceremony | Official quest name |
| **Quest ID** | quest__the_sorting_ceremony | Unique identifier |
| **Quest Type** | The Sorting Ceremony | Classification |
...
/**
 * Implementation of the Quest: The Sorting Ceremony quest.
 * advances the main story
 */
public class QuestTheSortingCeremonyQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__the_sorting_ceremony";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestTheSortingCeremonyQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 1);
...
public static final Quest QUESTTHESORTINGCEREMONY = register(
    new QuestTheSortingCeremonyQuest(),
