...
title: 'Chapter 485: Quest: Umbridge''s Inspection'
description: 'Quest: Umbridge''s Inspection - Implementation details and reference'
tags:
  - vii chronicle
  - 34 year 5
---
...
**Quest: Umbridge''s Inspection** is a Umbridge''s Inspection quest that takes place during Year 5. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: Umbridge''s Inspection quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: Umbridge''s Inspection quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: Umbridge''s Inspection quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: Umbridge''s Inspection | Official quest name |
| **Quest ID** | quest__umbridge__s_inspection | Unique identifier |
| **Quest Type** | Umbridge''s Inspection | Classification |
...
/**
 * Implementation of the Quest: Umbridge''s Inspection quest.
 * advances the main story
 */
public class QuestUmbridgesInspectionQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__umbridge__s_inspection";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestUmbridgesInspectionQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 5);
...
public static final Quest QUESTUMBRIDGESINSPECTION = register(
    new QuestUmbridgesInspectionQuest(),
