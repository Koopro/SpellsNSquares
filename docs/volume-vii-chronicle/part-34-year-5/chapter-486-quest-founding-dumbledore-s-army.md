...
title: 'Chapter 486: Quest: Founding Dumbledore''s Army'
description: 'Quest: Founding Dumbledore''s Army - Implementation details and reference'
tags:
  - vii chronicle
  - 34 year 5
---
...
**Quest: Founding Dumbledore''s Army** is a Founding Dumbledore''s Army quest that takes place during Year 5. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: Founding Dumbledore''s Army quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: Founding Dumbledore''s Army quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: Founding Dumbledore''s Army quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: Founding Dumbledore''s Army | Official quest name |
| **Quest ID** | quest__founding_dumbledore__s_army | Unique identifier |
| **Quest Type** | Founding Dumbledore''s Army | Classification |
...
/**
 * Implementation of the Quest: Founding Dumbledore''s Army quest.
 * advances the main story
 */
public class QuestFoundingDumbledoresArmyQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__founding_dumbledore__s_army";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestFoundingDumbledoresArmyQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 5);
...
public static final Quest QUESTFOUNDINGDUMBLEDORESARMY = register(
    new QuestFoundingDumbledoresArmyQuest(),
