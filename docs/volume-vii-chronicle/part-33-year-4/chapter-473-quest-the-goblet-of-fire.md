...
title: 'Chapter 473: Quest: The Goblet of Fire'
description: 'Quest: The Goblet of Fire - Implementation details and reference'
tags:
  - vii chronicle
  - 33 year 4
---
...
**Quest: The Goblet of Fire** is a The Goblet of Fire quest that takes place during Year 4. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: The Goblet of Fire quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: The Goblet of Fire quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: The Goblet of Fire quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: The Goblet of Fire | Official quest name |
| **Quest ID** | quest__the_goblet_of_fire | Unique identifier |
| **Quest Type** | The Goblet of Fire | Classification |
...
/**
 * Implementation of the Quest: The Goblet of Fire quest.
 * advances the main story
 */
public class QuestTheGobletofFireQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__the_goblet_of_fire";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestTheGobletofFireQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 4);
...
public static final Quest QUESTTHEGOBLETOFFIRE = register(
    new QuestTheGobletofFireQuest(),
