...
title: 'Chapter 502: Quest: Memory: The Horcruxes'
description: 'Quest: Memory: The Horcruxes - Implementation details and reference'
tags:
  - vii chronicle
  - 35 year 6
---
...
**Quest: Memory: The Horcruxes** is a Memory: The Horcruxes quest that takes place during Year 6. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: Memory: The Horcruxes quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: Memory: The Horcruxes quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: Memory: The Horcruxes quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: Memory: The Horcruxes | Official quest name |
| **Quest ID** | quest__memory__the_horcruxes | Unique identifier |
| **Quest Type** | Memory: The Horcruxes | Classification |
...
/**
 * Implementation of the Quest: Memory: The Horcruxes quest.
 * advances the main story
 */
public class QuestMemoryTheHorcruxesQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__memory__the_horcruxes";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestMemoryTheHorcruxesQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 6);
...
public static final Quest QUESTMEMORYTHEHORCRUXES = register(
    new QuestMemoryTheHorcruxesQuest(),
