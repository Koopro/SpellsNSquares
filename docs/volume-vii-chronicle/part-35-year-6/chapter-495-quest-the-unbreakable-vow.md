...
title: 'Chapter 495: Quest: The Unbreakable Vow'
description: 'Quest: The Unbreakable Vow - Implementation details and reference'
tags:
  - vii chronicle
  - 35 year 6
---
...
**Quest: The Unbreakable Vow** is a The Unbreakable Vow quest that takes place during Year 6. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: The Unbreakable Vow quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: The Unbreakable Vow quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: The Unbreakable Vow quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: The Unbreakable Vow | Official quest name |
| **Quest ID** | quest__the_unbreakable_vow | Unique identifier |
| **Quest Type** | The Unbreakable Vow | Classification |
...
/**
 * Implementation of the Quest: The Unbreakable Vow quest.
 * advances the main story
 */
public class QuestTheUnbreakableVowQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__the_unbreakable_vow";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestTheUnbreakableVowQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 6);
...
public static final Quest QUESTTHEUNBREAKABLEVOW = register(
    new QuestTheUnbreakableVowQuest(),
