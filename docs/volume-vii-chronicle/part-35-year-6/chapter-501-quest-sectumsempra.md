...
title: 'Chapter 501: Quest: Sectumsempra'
description: 'Quest: Sectumsempra - Implementation details and reference'
tags:
  - vii chronicle
  - 35 year 6
---
...
**Quest: Sectumsempra** is a Sectumsempra quest that takes place during Year 6. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: Sectumsempra quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: Sectumsempra quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: Sectumsempra quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: Sectumsempra | Official quest name |
| **Quest ID** | quest__sectumsempra | Unique identifier |
| **Quest Type** | Sectumsempra | Classification |
...
/**
 * Implementation of the Quest: Sectumsempra quest.
 * advances the main story
 */
public class QuestSectumsempraQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__sectumsempra";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestSectumsempraQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 6);
...
public static final Quest QUESTSECTUMSEMPRA = register(
    new QuestSectumsempraQuest(),
