...
title: 'Chapter 513: Quest: Destroying the Locket'
description: 'Quest: Destroying the Locket - Implementation details and reference'
tags:
  - vii chronicle
  - 36 year 7 part 1
---
...
**Quest: Destroying the Locket** is a Destroying the Locket quest that takes place during Year 7. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: Destroying the Locket quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: Destroying the Locket quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: Destroying the Locket quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: Destroying the Locket | Official quest name |
| **Quest ID** | quest__destroying_the_locket | Unique identifier |
| **Quest Type** | Destroying the Locket | Classification |
...
/**
 * Implementation of the Quest: Destroying the Locket quest.
 * advances the main story
 */
public class QuestDestroyingtheLocketQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__destroying_the_locket";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestDestroyingtheLocketQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 7);
...
public static final Quest QUESTDESTROYINGTHELOCKET = register(
    new QuestDestroyingtheLocketQuest(),
