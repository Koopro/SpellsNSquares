...
title: 'Chapter 507: Quest: The Wedding'
description: 'Quest: The Wedding - Implementation details and reference'
tags:
  - vii chronicle
  - 36 year 7 part 1
---
...
**Quest: The Wedding** is a The Wedding quest that takes place during Year 7. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: The Wedding quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: The Wedding quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: The Wedding quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: The Wedding | Official quest name |
| **Quest ID** | quest__the_wedding | Unique identifier |
| **Quest Type** | The Wedding | Classification |
...
/**
 * Implementation of the Quest: The Wedding quest.
 * advances the main story
 */
public class QuestTheWeddingQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__the_wedding";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestTheWeddingQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 7);
...
public static final Quest QUESTTHEWEDDING = register(
    new QuestTheWeddingQuest(),
