...
title: 'Chapter 509: Quest: Obtaining the Locket'
description: 'Quest: Obtaining the Locket - Implementation details and reference'
tags:
  - vii chronicle
  - 36 year 7 part 1
---
...
**Quest: Obtaining the Locket** is a Obtaining the Locket quest that takes place during Year 7. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: Obtaining the Locket quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: Obtaining the Locket quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: Obtaining the Locket quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: Obtaining the Locket | Official quest name |
| **Quest ID** | quest__obtaining_the_locket | Unique identifier |
| **Quest Type** | Obtaining the Locket | Classification |
...
/**
 * Implementation of the Quest: Obtaining the Locket quest.
 * advances the main story
 */
public class QuestObtainingtheLocketQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__obtaining_the_locket";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestObtainingtheLocketQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 7);
...
public static final Quest QUESTOBTAININGTHELOCKET = register(
    new QuestObtainingtheLocketQuest(),
