...
title: 'Chapter 457: Quest: Dementors on the Train'
description: 'Quest: Dementors on the Train - Implementation details and reference'
tags:
  - vii chronicle
  - 32 year 3
---
...
**Quest: Dementors on the Train** is a Dementors on the Train quest that takes place during Year 3. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: Dementors on the Train quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: Dementors on the Train quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: Dementors on the Train quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: Dementors on the Train | Official quest name |
| **Quest ID** | quest__dementors_on_the_train | Unique identifier |
| **Quest Type** | Dementors on the Train | Classification |
...
/**
 * Implementation of the Quest: Dementors on the Train quest.
 * advances the main story
 */
public class QuestDementorsontheTrainQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__dementors_on_the_train";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestDementorsontheTrainQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 3);
...
public static final Quest QUESTDEMENTORSONTHETRAIN = register(
    new QuestDementorsontheTrainQuest(),
