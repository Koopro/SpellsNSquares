...
title: 'Chapter 460: Quest: Boggart in the Wardrobe'
description: 'Quest: Boggart in the Wardrobe - Implementation details and reference'
tags:
  - vii chronicle
  - 32 year 3
---
...
**Quest: Boggart in the Wardrobe** is a Boggart in the Wardrobe quest that takes place during Year 3. This quest advances the main story and is essential for story progression.

This chapter provides complete documentation for implementing the Quest: Boggart in the Wardrobe quest, including objectives, dialogue trees, NPC interactions, rewards, branching paths, and integration with the story progression system.

## Implementation Details

### Quest Overview

The Quest: Boggart in the Wardrobe quest is part of the main story progression and plays a crucial role in the narrative.
...
A comprehensive step-by-step guide for completing the Quest: Boggart in the Wardrobe quest.
...
|----------|-------|-------------|
| **Quest Name** | Quest: Boggart in the Wardrobe | Official quest name |
| **Quest ID** | quest__boggart_in_the_wardrobe | Unique identifier |
| **Quest Type** | Boggart in the Wardrobe | Classification |
...
/**
 * Implementation of the Quest: Boggart in the Wardrobe quest.
 * advances the main story
 */
public class QuestBoggartintheWardrobeQuest extends BaseQuest {
    
    public static final String QUEST_ID = "quest__boggart_in_the_wardrobe";
    public static final QuestType TYPE = QuestType.MAIN_STORY;
    
    public QuestBoggartintheWardrobeQuest() {
        super(QUEST_ID, TYPE);
        this.setYear(Year 3);
...
public static final Quest QUESTBOGGARTINTHEWARDROBE = register(
    new QuestBoggartintheWardrobeQuest(),
