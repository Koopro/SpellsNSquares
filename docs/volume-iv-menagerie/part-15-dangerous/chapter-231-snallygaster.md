...
title: 'Chapter 231: Snallygaster'
description: Snallygaster - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Snallygaster** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. A dragon-like creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Snallygaster, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Snallygaster is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Snallygaster uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Snallygaster spawns in specific biomes and conditions that match its natural habitat.
...
The Snallygaster has specific statistics that determine its capabilities and behavior in the game world.
...
The Snallygaster uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Snallygaster spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: North America
...
The Snallygaster engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Snallygaster drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Snallygaster naturally inhabits North America.
...
/**
 * Entity implementation for the Snallygaster.
 * A magical creature that can be encountered in the wizarding world.
 */
public class SnallygasterEntity extends MagicalCreatureEntity {
    
    public static final EntityType<SnallygasterEntity> TYPE = EntityType.Builder
        .of(SnallygasterEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("snallygaster");
    
    public SnallygasterEntity(EntityType<? extends SnallygasterEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    SnallygasterEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    SnallygasterEntity::checkSpawnRules
);
```
