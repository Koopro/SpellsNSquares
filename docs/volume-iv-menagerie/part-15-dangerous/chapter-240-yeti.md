...
title: 'Chapter 240: Yeti'
description: Yeti - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Yeti** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. A large, ape-like creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Yeti, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Yeti is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Yeti uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Yeti spawns in specific biomes and conditions that match its natural habitat.
...
The Yeti has specific statistics that determine its capabilities and behavior in the game world.
...
The Yeti uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Yeti spawns under specific conditions that match its natural habitat and ecological niche.
...
The Yeti engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Yeti drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Yeti naturally inhabits Tibet.
...
/**
 * Entity implementation for the Yeti.
 * A magical creature that can be encountered in the wizarding world.
 */
public class YetiEntity extends MagicalCreatureEntity {
    
    public static final EntityType<YetiEntity> TYPE = EntityType.Builder
        .of(YetiEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("yeti");
    
    public YetiEntity(EntityType<? extends YetiEntity> type, Level level) {
        super(type, level);
