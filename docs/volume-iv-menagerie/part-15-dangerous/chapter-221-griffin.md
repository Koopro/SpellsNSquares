...
title: 'Chapter 221: Griffin'
description: Griffin - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Griffin** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. A creature with eagle head and lion body This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Griffin, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Griffin is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Griffin uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Griffin spawns in specific biomes and conditions that match its natural habitat.
...
The Griffin has specific statistics that determine its capabilities and behavior in the game world.
...
The Griffin uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Griffin spawns under specific conditions that match its natural habitat and ecological niche.
...
The Griffin engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Griffin drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Griffin naturally inhabits Greece.
...
/**
 * Entity implementation for the Griffin.
 * A magical creature that can be encountered in the wizarding world.
 */
public class GriffinEntity extends MagicalCreatureEntity {
    
    public static final EntityType<GriffinEntity> TYPE = EntityType.Builder
        .of(GriffinEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("griffin");
    
    public GriffinEntity(EntityType<? extends GriffinEntity> type, Level level) {
        super(type, level);
