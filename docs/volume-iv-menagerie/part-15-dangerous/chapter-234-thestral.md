...
title: 'Chapter 234: Thestral'
description: Thestral - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Thestral** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. A winged horse visible only to those who have seen death This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Thestral, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Thestral is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Thestral uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Thestral spawns in specific biomes and conditions that match its natural habitat.
...
The Thestral has specific statistics that determine its capabilities and behavior in the game world.
...
The Thestral uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Thestral spawns under specific conditions that match its natural habitat and ecological niche.
...
The Thestral engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Thestral drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Thestral naturally inhabits Worldwide.
...
/**
 * Entity implementation for the Thestral.
 * A magical creature that can be encountered in the wizarding world.
 */
public class ThestralEntity extends MagicalCreatureEntity {
    
    public static final EntityType<ThestralEntity> TYPE = EntityType.Builder
        .of(ThestralEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("thestral");
...
EntitySpawnPlacements.register(
    ...
    ThestralEntity::checkSpawnRules
);
```
