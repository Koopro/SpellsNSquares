...
title: 'Chapter 230: Runespoor'
description: Runespoor - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Runespoor** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. A three-headed snake This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Runespoor, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Runespoor is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Runespoor uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Runespoor spawns in specific biomes and conditions that match its natural habitat.
...
The Runespoor has specific statistics that determine its capabilities and behavior in the game world.
...
The Runespoor uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Runespoor spawns under specific conditions that match its natural habitat and ecological niche.
...
The Runespoor engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Runespoor drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Runespoor naturally inhabits Burkina Faso.
...
/**
 * Entity implementation for the Runespoor.
 * A magical creature that can be encountered in the wizarding world.
 */
public class RunespoorEntity extends MagicalCreatureEntity {
    
    public static final EntityType<RunespoorEntity> TYPE = EntityType.Builder
        .of(RunespoorEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("runespoor");
    
    public RunespoorEntity(EntityType<? extends RunespoorEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    RunespoorEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    RunespoorEntity::checkSpawnRules
);
```
