...
title: 'Chapter 233: Tebo'
description: Tebo - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Tebo** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. A warthog-like creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Tebo, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Tebo is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Tebo uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Tebo spawns in specific biomes and conditions that match its natural habitat.
...
The Tebo has specific statistics that determine its capabilities and behavior in the game world.
...
The Tebo uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Tebo spawns under specific conditions that match its natural habitat and ecological niche.
...
The Tebo engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Tebo drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Tebo naturally inhabits Congo, Zaire.
...
/**
 * Entity implementation for the Tebo.
 * A magical creature that can be encountered in the wizarding world.
 */
public class TeboEntity extends MagicalCreatureEntity {
    
    public static final EntityType<TeboEntity> TYPE = EntityType.Builder
        .of(TeboEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("tebo");
    
    public TeboEntity(EntityType<? extends TeboEntity> type, Level level) {
        super(type, level);
