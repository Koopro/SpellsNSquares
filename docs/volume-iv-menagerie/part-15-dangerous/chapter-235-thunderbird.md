...
title: 'Chapter 235: Thunderbird'
description: Thunderbird - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Thunderbird** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. A large bird that creates storms This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Thunderbird, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Thunderbird is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Thunderbird uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Thunderbird spawns in specific biomes and conditions that match its natural habitat.
...
The Thunderbird has specific statistics that determine its capabilities and behavior in the game world.
...
The Thunderbird uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Thunderbird spawns under specific conditions that match its natural habitat and ecological niche.
...
The Thunderbird engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Thunderbird drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Thunderbird naturally inhabits Arizona.
...
/**
 * Entity implementation for the Thunderbird.
 * A magical creature that can be encountered in the wizarding world.
 */
public class ThunderbirdEntity extends MagicalCreatureEntity {
    
    public static final EntityType<ThunderbirdEntity> TYPE = EntityType.Builder
        .of(ThunderbirdEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("thunderbird");
...
EntitySpawnPlacements.register(
    ThunderbirdEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    ThunderbirdEntity::checkSpawnRules
);
```
