...
title: 'Chapter 236: Troll (Mountain)'
description: Troll (Mountain) - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Troll (Mountain)** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. A large, dim-witted humanoid This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Troll (Mountain), including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Troll (Mountain) is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Troll (Mountain) uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Troll (Mountain) spawns in specific biomes and conditions that match its natural habitat.
...
The Troll (Mountain) has specific statistics that determine its capabilities and behavior in the game world.
...
The Troll (Mountain) uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Troll (Mountain) spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Mountains, forests, rivers
...
The Troll (Mountain) engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Troll (Mountain) drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Troll (Mountain) naturally inhabits Mountains, forests, rivers.
...
/**
 * Entity implementation for the Troll (Mountain).
 * A magical creature that can be encountered in the wizarding world.
 */
public class TrollMountainEntity extends MagicalCreatureEntity {
    
    public static final EntityType<TrollMountainEntity> TYPE = EntityType.Builder
        .of(TrollMountainEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("troll__mountain_");
    
    public TrollMountainEntity(EntityType<? extends TrollMountainEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    TrollMountainEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    TrollMountainEntity::checkSpawnRules
);
```
