...
title: 'Chapter 238: Troll (River)'
description: Troll (River) - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Troll (River)** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. A large, dim-witted humanoid This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Troll (River), including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Troll (River) is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Troll (River) uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Troll (River) spawns in specific biomes and conditions that match its natural habitat.
...
The Troll (River) has specific statistics that determine its capabilities and behavior in the game world.
...
The Troll (River) uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Troll (River) spawns under specific conditions that match its natural habitat and ecological niche.
...
The Troll (River) engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Troll (River) drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Troll (River) naturally inhabits Mountains, forests, rivers.
...
/**
 * Entity implementation for the Troll (River).
 * A magical creature that can be encountered in the wizarding world.
 */
public class TrollRiverEntity extends MagicalCreatureEntity {
    
    public static final EntityType<TrollRiverEntity> TYPE = EntityType.Builder
        .of(TrollRiverEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("troll__river_");
    
    public TrollRiverEntity(EntityType<? extends TrollRiverEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    TrollRiverEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    TrollRiverEntity::checkSpawnRules
);
```
