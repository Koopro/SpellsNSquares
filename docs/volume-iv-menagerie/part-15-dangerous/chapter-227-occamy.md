...
title: 'Chapter 227: Occamy'
description: Occamy - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Occamy** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. A serpent with wings and legs This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Occamy, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Occamy is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Occamy uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Occamy spawns in specific biomes and conditions that match its natural habitat.
...
The Occamy has specific statistics that determine its capabilities and behavior in the game world.
...
The Occamy uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Occamy spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Far East, India
...
The Occamy engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Occamy drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Occamy naturally inhabits Far East, India.
...
/**
 * Entity implementation for the Occamy.
 * A magical creature that can be encountered in the wizarding world.
 */
public class OccamyEntity extends MagicalCreatureEntity {
    
    public static final EntityType<OccamyEntity> TYPE = EntityType.Builder
        .of(OccamyEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("occamy");
