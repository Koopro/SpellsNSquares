...
title: 'Chapter 224: Kelpie'
description: Kelpie - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Kelpie** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. A shape-shifting water demon This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Kelpie, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Kelpie is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Kelpie uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Kelpie spawns in specific biomes and conditions that match its natural habitat.
...
The Kelpie has specific statistics that determine its capabilities and behavior in the game world.
...
The Kelpie uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Kelpie spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Scotland, Ireland
...
The Kelpie engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Kelpie drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Kelpie naturally inhabits Scotland, Ireland.
...
/**
 * Entity implementation for the Kelpie.
 * A magical creature that can be encountered in the wizarding world.
 */
public class KelpieEntity extends MagicalCreatureEntity {
    
    public static final EntityType<KelpieEntity> TYPE = EntityType.Builder
        .of(KelpieEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("kelpie");
