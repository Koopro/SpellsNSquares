...
title: 'Chapter 228: Phoenix'
description: Phoenix - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Phoenix** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. A magnificent bird that bursts into flames This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Phoenix, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Phoenix is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Phoenix uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Phoenix spawns in specific biomes and conditions that match its natural habitat.
...
The Phoenix has specific statistics that determine its capabilities and behavior in the game world.
...
The Phoenix uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Phoenix spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Egypt, India, China
...
The Phoenix engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Phoenix drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Phoenix naturally inhabits Egypt, India, China.
...
/**
 * Entity implementation for the Phoenix.
 * A magical creature that can be encountered in the wizarding world.
 */
public class PhoenixEntity extends MagicalCreatureEntity {
    
    public static final EntityType<PhoenixEntity> TYPE = EntityType.Builder
        .of(PhoenixEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("phoenix");
