...
title: 'Chapter 226: Merpeople (Selkie)'
description: Merpeople (Selkie) - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Merpeople (Selkie)** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. Humanoid water creatures This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Merpeople (Selkie), including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Merpeople (Selkie) is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.

**Classification Details:**
- **Category**: XXXX (Dangerous)
- **Danger Level**: High
- **Ministry Regulations**: Specialist handling required
- **Handling Requirements**: Advanced handling techniques

### AI Behavior System

The Merpeople (Selkie) uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Merpeople (Selkie) spawns in specific biomes and conditions that match its natural habitat.
...
The Merpeople (Selkie) has specific statistics that determine its capabilities and behavior in the game world.
...
The Merpeople (Selkie) uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Merpeople (Selkie) spawns under specific conditions that match its natural habitat and ecological niche.
...
The Merpeople (Selkie) engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Merpeople (Selkie) drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Merpeople (Selkie) naturally inhabits Lakes, oceans.
...
|----------|-------|-------------|
| **Health Points** | 40 | Base health pool |
| **Attack Damage** | 8 | Base melee damage |
| **Armor Points** | 4 | Damage reduction |
...
| **Classification** | XXXX (Dangerous) | Ministry classification |
...
| Property | Value | Description |
|----------|-------|-------------|
| **Aggression Level** | Aggressive | How easily provoked |
...
/**
 * Entity implementation for the Merpeople (Selkie).
 * A magical creature that can be encountered in the wizarding world.
 */
public class MerpeopleSelkieEntity extends MagicalCreatureEntity {
    
    public static final EntityType<MerpeopleSelkieEntity> TYPE = EntityType.Builder
        .of(MerpeopleSelkieEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("merpeople__selkie_");
    
    public MerpeopleSelkieEntity(EntityType<? extends MerpeopleSelkieEntity> type, Level level) {
        super(type, level);
    ...
    public CreatureClassification getClassification() {
        return CreatureClassification.XXXX__DANGEROUS_;
    }
}
```
...
EntitySpawnPlacements.register(
    MerpeopleSelkieEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    MerpeopleSelkieEntity::checkSpawnRules
);
```
