...
title: 'Chapter 220: Graphorn'
description: Graphorn - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Graphorn** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. A large, grey creature with two horns This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Graphorn, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Graphorn is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Graphorn uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Graphorn spawns in specific biomes and conditions that match its natural habitat.
...
The Graphorn has specific statistics that determine its capabilities and behavior in the game world.
...
The Graphorn uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Graphorn spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: European mountains
...
The Graphorn engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Graphorn drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Graphorn naturally inhabits European mountains.
...
/**
 * Entity implementation for the Graphorn.
 * A magical creature that can be encountered in the wizarding world.
 */
public class GraphornEntity extends MagicalCreatureEntity {
    
    public static final EntityType<GraphornEntity> TYPE = EntityType.Builder
        .of(GraphornEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("graphorn");
...
EntitySpawnPlacements.register(
    ...
    GraphornEntity::checkSpawnRules
);
```
