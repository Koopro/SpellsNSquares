...
title: 'Chapter 232: Sphinx'
description: Sphinx - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Sphinx** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. A creature with human head and lion body This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Sphinx, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Sphinx is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Sphinx uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Sphinx spawns in specific biomes and conditions that match its natural habitat.
...
The Sphinx has specific statistics that determine its capabilities and behavior in the game world.
...
The Sphinx uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Sphinx spawns under specific conditions that match its natural habitat and ecological niche.
...
The Sphinx engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Sphinx drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Sphinx naturally inhabits Egypt.
...
/**
 * Entity implementation for the Sphinx.
 * A magical creature that can be encountered in the wizarding world.
 */
public class SphinxEntity extends MagicalCreatureEntity {
    
    public static final EntityType<SphinxEntity> TYPE = EntityType.Builder
        .of(SphinxEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("sphinx");
