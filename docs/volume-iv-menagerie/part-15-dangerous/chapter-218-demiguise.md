...
title: 'Chapter 218: Demiguise'
description: Demiguise - Implementation details and reference
tags:
  - iv menagerie
  - 15 dangerous
---
...
The **Demiguise** is a XXXX (Dangerous) magical creature that inhabits the wizarding world. A peaceful, ape-like creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Demiguise, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Demiguise is classified as **XXXX (Dangerous)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Demiguise uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Demiguise spawns in specific biomes and conditions that match its natural habitat.
...
The Demiguise has specific statistics that determine its capabilities and behavior in the game world.
...
The Demiguise uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Demiguise spawns under specific conditions that match its natural habitat and ecological niche.
...
The Demiguise engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Demiguise drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Demiguise naturally inhabits Far East.
...
/**
 * Entity implementation for the Demiguise.
 * A magical creature that can be encountered in the wizarding world.
 */
public class DemiguiseEntity extends MagicalCreatureEntity {
    
    public static final EntityType<DemiguiseEntity> TYPE = EntityType.Builder
        .of(DemiguiseEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("demiguise");
...
EntitySpawnPlacements.register(
    DemiguiseEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    DemiguiseEntity::checkSpawnRules
);
```
