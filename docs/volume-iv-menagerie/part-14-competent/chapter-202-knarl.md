...
title: 'Chapter 202: Knarl'
description: Knarl - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Knarl** is a XXX (Competent) magical creature that inhabits the wizarding world. A hedgehog-like creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Knarl, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Knarl is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Knarl uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Knarl spawns in specific biomes and conditions that match its natural habitat.
...
The Knarl has specific statistics that determine its capabilities and behavior in the game world.
...
The Knarl uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Knarl spawns under specific conditions that match its natural habitat and ecological niche.
...
The Knarl engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Knarl drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Knarl naturally inhabits Northern Europe and America.
...
/**
 * Entity implementation for the Knarl.
 * A magical creature that can be encountered in the wizarding world.
 */
public class KnarlEntity extends MagicalCreatureEntity {
    
    public static final EntityType<KnarlEntity> TYPE = EntityType.Builder
        .of(KnarlEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("knarl");
    
    public KnarlEntity(EntityType<? extends KnarlEntity> type, Level level) {
        super(type, level);
