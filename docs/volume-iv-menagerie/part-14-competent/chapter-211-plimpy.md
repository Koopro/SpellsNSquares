...
title: 'Chapter 211: Plimpy'
description: Plimpy - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Plimpy** is a XXX (Competent) magical creature that inhabits the wizarding world. A spherical fish with legs This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Plimpy, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Plimpy is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Plimpy uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Plimpy spawns in specific biomes and conditions that match its natural habitat.
...
The Plimpy has specific statistics that determine its capabilities and behavior in the game world.
...
The Plimpy uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Plimpy spawns under specific conditions that match its natural habitat and ecological niche.
...
The Plimpy engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Plimpy drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Plimpy naturally inhabits Deep lakes.
...
/**
 * Entity implementation for the Plimpy.
 * A magical creature that can be encountered in the wizarding world.
 */
public class PlimpyEntity extends MagicalCreatureEntity {
    
    public static final EntityType<PlimpyEntity> TYPE = EntityType.Builder
        .of(PlimpyEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("plimpy");
    
    public PlimpyEntity(EntityType<? extends PlimpyEntity> type, Level level) {
        super(type, level);
