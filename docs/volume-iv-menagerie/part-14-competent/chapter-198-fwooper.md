...
title: 'Chapter 198: Fwooper'
description: Fwooper - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Fwooper** is a XXX (Competent) magical creature that inhabits the wizarding world. A brightly colored bird This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Fwooper, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Fwooper is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Fwooper uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Fwooper spawns in specific biomes and conditions that match its natural habitat.
...
The Fwooper has specific statistics that determine its capabilities and behavior in the game world.
...
The Fwooper uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Fwooper spawns under specific conditions that match its natural habitat and ecological niche.
...
The Fwooper engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Fwooper drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Fwooper naturally inhabits Africa.
...
/**
 * Entity implementation for the Fwooper.
 * A magical creature that can be encountered in the wizarding world.
 */
public class FwooperEntity extends MagicalCreatureEntity {
    
    public static final EntityType<FwooperEntity> TYPE = EntityType.Builder
        .of(FwooperEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("fwooper");
