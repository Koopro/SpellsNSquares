...
title: 'Chapter 205: Mackled Malaclaw'
description: Mackled Malaclaw - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Mackled Malaclaw** is a XXX (Competent) magical creature that inhabits the wizarding world. A lobster-like creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Mackled Malaclaw, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Mackled Malaclaw is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Mackled Malaclaw uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Mackled Malaclaw spawns in specific biomes and conditions that match its natural habitat.
...
The Mackled Malaclaw has specific statistics that determine its capabilities and behavior in the game world.
...
The Mackled Malaclaw uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Mackled Malaclaw spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Coasts of Europe
...
The Mackled Malaclaw engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Mackled Malaclaw drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Mackled Malaclaw naturally inhabits Coasts of Europe.
...
/**
 * Entity implementation for the Mackled Malaclaw.
 * A magical creature that can be encountered in the wizarding world.
 */
public class MackledMalaclawEntity extends MagicalCreatureEntity {
    
    public static final EntityType<MackledMalaclawEntity> TYPE = EntityType.Builder
        .of(MackledMalaclawEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("mackled_malaclaw");
    
    public MackledMalaclawEntity(EntityType<? extends MackledMalaclawEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    MackledMalaclawEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    MackledMalaclawEntity::checkSpawnRules
);
```
