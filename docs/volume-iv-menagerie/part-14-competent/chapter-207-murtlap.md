...
title: 'Chapter 207: Murtlap'
description: Murtlap - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Murtlap** is a XXX (Competent) magical creature that inhabits the wizarding world. A rat-like creature with sea anemone on back This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Murtlap, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Murtlap is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Murtlap uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Murtlap spawns in specific biomes and conditions that match its natural habitat.
...
The Murtlap has specific statistics that determine its capabilities and behavior in the game world.
...
The Murtlap uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Murtlap spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Coastal areas of Britain
...
The Murtlap engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Murtlap drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Murtlap naturally inhabits Coastal areas of Britain.
...
/**
 * Entity implementation for the Murtlap.
 * A magical creature that can be encountered in the wizarding world.
 */
public class MurtlapEntity extends MagicalCreatureEntity {
    
    public static final EntityType<MurtlapEntity> TYPE = EntityType.Builder
        .of(MurtlapEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("murtlap");
    
    public MurtlapEntity(EntityType<? extends MurtlapEntity> type, Level level) {
        super(type, level);
