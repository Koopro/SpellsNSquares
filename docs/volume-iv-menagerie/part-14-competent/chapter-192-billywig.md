...
title: 'Chapter 192: Billywig'
description: Billywig - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Billywig** is a XXX (Competent) magical creature that inhabits the wizarding world. A bright blue flying insect This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Billywig, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Billywig is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Billywig uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Billywig spawns in specific biomes and conditions that match its natural habitat.
...
The Billywig has specific statistics that determine its capabilities and behavior in the game world.
...
The Billywig uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Billywig spawns under specific conditions that match its natural habitat and ecological niche.
...
The Billywig engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Billywig drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Billywig naturally inhabits Australia.
...
/**
 * Entity implementation for the Billywig.
 * A magical creature that can be encountered in the wizarding world.
 */
public class BillywigEntity extends MagicalCreatureEntity {
    
    public static final EntityType<BillywigEntity> TYPE = EntityType.Builder
        .of(BillywigEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("billywig");
    
    public BillywigEntity(EntityType<? extends BillywigEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    ...
    BillywigEntity::checkSpawnRules
);
```
