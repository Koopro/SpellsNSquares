...
title: 'Chapter 206: Moke'
description: Moke - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Moke** is a XXX (Competent) magical creature that inhabits the wizarding world. A silver-green lizard This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Moke, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Moke is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Moke uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Moke spawns in specific biomes and conditions that match its natural habitat.
...
The Moke has specific statistics that determine its capabilities and behavior in the game world.
...
The Moke uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Moke spawns under specific conditions that match its natural habitat and ecological niche.
...
The Moke engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Moke drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Moke naturally inhabits Britain and Ireland.
...
/**
 * Entity implementation for the Moke.
 * A magical creature that can be encountered in the wizarding world.
 */
public class MokeEntity extends MagicalCreatureEntity {
    
    public static final EntityType<MokeEntity> TYPE = EntityType.Builder
        .of(MokeEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("moke");
    
    public MokeEntity(EntityType<? extends MokeEntity> type, Level level) {
        super(type, level);
