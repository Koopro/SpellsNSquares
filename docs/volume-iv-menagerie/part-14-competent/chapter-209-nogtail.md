...
title: 'Chapter 209: Nogtail'
description: Nogtail - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Nogtail** is a XXX (Competent) magical creature that inhabits the wizarding world. A demon-like creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Nogtail, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Nogtail is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Nogtail uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Nogtail spawns in specific biomes and conditions that match its natural habitat.
...
The Nogtail has specific statistics that determine its capabilities and behavior in the game world.
...
The Nogtail uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Nogtail spawns under specific conditions that match its natural habitat and ecological niche.
...
The Nogtail engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Nogtail drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Nogtail naturally inhabits Rural areas.
...
/**
 * Entity implementation for the Nogtail.
 * A magical creature that can be encountered in the wizarding world.
 */
public class NogtailEntity extends MagicalCreatureEntity {
    
    public static final EntityType<NogtailEntity> TYPE = EntityType.Builder
        .of(NogtailEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("nogtail");
    
    public NogtailEntity(EntityType<? extends NogtailEntity> type, Level level) {
        super(type, level);
