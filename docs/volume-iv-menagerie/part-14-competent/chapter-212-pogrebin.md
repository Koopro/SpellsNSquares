...
title: 'Chapter 212: Pogrebin'
description: Pogrebin - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Pogrebin** is a XXX (Competent) magical creature that inhabits the wizarding world. A small, grey Russian demon This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Pogrebin, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Pogrebin is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Pogrebin uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Pogrebin spawns in specific biomes and conditions that match its natural habitat.
...
The Pogrebin has specific statistics that determine its capabilities and behavior in the game world.
...
The Pogrebin uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Pogrebin spawns under specific conditions that match its natural habitat and ecological niche.
...
The Pogrebin engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Pogrebin drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Pogrebin naturally inhabits Russia.
...
/**
 * Entity implementation for the Pogrebin.
 * A magical creature that can be encountered in the wizarding world.
 */
public class PogrebinEntity extends MagicalCreatureEntity {
    
    public static final EntityType<PogrebinEntity> TYPE = EntityType.Builder
        .of(PogrebinEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("pogrebin");
    
    public PogrebinEntity(EntityType<? extends PogrebinEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    ...
    PogrebinEntity::checkSpawnRules
);
```
