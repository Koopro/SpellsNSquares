...
title: 'Chapter 197: Fire Crab'
description: Fire Crab - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Fire Crab** is a XXX (Competent) magical creature that inhabits the wizarding world. A large, turtle-like creature with jewels on shell This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Fire Crab, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Fire Crab is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Fire Crab uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Fire Crab spawns in specific biomes and conditions that match its natural habitat.
...
The Fire Crab has specific statistics that determine its capabilities and behavior in the game world.
...
The Fire Crab uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Fire Crab spawns under specific conditions that match its natural habitat and ecological niche.
...
The Fire Crab engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Fire Crab drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Fire Crab naturally inhabits Fiji.
...
/**
 * Entity implementation for the Fire Crab.
 * A magical creature that can be encountered in the wizarding world.
 */
public class FireCrabEntity extends MagicalCreatureEntity {
    
    public static final EntityType<FireCrabEntity> TYPE = EntityType.Builder
        .of(FireCrabEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("fire_crab");
...
EntitySpawnPlacements.register(
    ...
    FireCrabEntity::checkSpawnRules
);
```
