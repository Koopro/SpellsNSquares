...
title: 'Chapter 200: Hippocampus'
description: Hippocampus - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Hippocampus** is a XXX (Competent) magical creature that inhabits the wizarding world. A sea horse with horse-like head This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Hippocampus, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Hippocampus is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Hippocampus uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Hippocampus spawns in specific biomes and conditions that match its natural habitat.
...
The Hippocampus has specific statistics that determine its capabilities and behavior in the game world.
...
The Hippocampus uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Hippocampus spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Mediterranean
...
The Hippocampus engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Hippocampus drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Hippocampus naturally inhabits Mediterranean.
...
/**
 * Entity implementation for the Hippocampus.
 * A magical creature that can be encountered in the wizarding world.
 */
public class HippocampusEntity extends MagicalCreatureEntity {
    
    public static final EntityType<HippocampusEntity> TYPE = EntityType.Builder
        .of(HippocampusEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("hippocampus");
    
    public HippocampusEntity(EntityType<? extends HippocampusEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    HippocampusEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    HippocampusEntity::checkSpawnRules
);
```
