...
title: 'Chapter 196: Dugbog'
description: Dugbog - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Dugbog** is a XXX (Competent) magical creature that inhabits the wizarding world. A marsh-dwelling creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Dugbog, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Dugbog is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Dugbog uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Dugbog spawns in specific biomes and conditions that match its natural habitat.
...
The Dugbog has specific statistics that determine its capabilities and behavior in the game world.
...
The Dugbog uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Dugbog spawns under specific conditions that match its natural habitat and ecological niche.
...
The Dugbog engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Dugbog drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Dugbog naturally inhabits Marshes.
...
/**
 * Entity implementation for the Dugbog.
 * A magical creature that can be encountered in the wizarding world.
 */
public class DugbogEntity extends MagicalCreatureEntity {
    
    public static final EntityType<DugbogEntity> TYPE = EntityType.Builder
        .of(DugbogEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("dugbog");
    
    public DugbogEntity(EntityType<? extends DugbogEntity> type, Level level) {
        super(type, level);
