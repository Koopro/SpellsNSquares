...
title: 'Chapter 191: Ashwinder'
description: Ashwinder - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Ashwinder** is a XXX (Competent) magical creature that inhabits the wizarding world. A serpent created from magical fire This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Ashwinder, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Ashwinder is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Ashwinder uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Ashwinder spawns in specific biomes and conditions that match its natural habitat.
...
The Ashwinder has specific statistics that determine its capabilities and behavior in the game world.
...
The Ashwinder uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Ashwinder spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Created from fires
...
The Ashwinder engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Ashwinder drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Ashwinder naturally inhabits Created from fires.
...
/**
 * Entity implementation for the Ashwinder.
 * A magical creature that can be encountered in the wizarding world.
 */
public class AshwinderEntity extends MagicalCreatureEntity {
    
    public static final EntityType<AshwinderEntity> TYPE = EntityType.Builder
        .of(AshwinderEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("ashwinder");
...
EntitySpawnPlacements.register(
    AshwinderEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    AshwinderEntity::checkSpawnRules
);
```
