...
title: 'Chapter 193: Bundimun'
description: Bundimun - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Bundimun** is a XXX (Competent) magical creature that inhabits the wizarding world. A creature that infests houses This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Bundimun, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Bundimun is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Bundimun uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Bundimun spawns in specific biomes and conditions that match its natural habitat.
...
The Bundimun has specific statistics that determine its capabilities and behavior in the game world.
...
The Bundimun uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Bundimun spawns under specific conditions that match its natural habitat and ecological niche.
...
The Bundimun engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Bundimun drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Bundimun naturally inhabits Damp areas.
...
/**
 * Entity implementation for the Bundimun.
 * A magical creature that can be encountered in the wizarding world.
 */
public class BundimunEntity extends MagicalCreatureEntity {
    
    public static final EntityType<BundimunEntity> TYPE = EntityType.Builder
        .of(BundimunEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("bundimun");
    
    public BundimunEntity(EntityType<? extends BundimunEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    ...
    BundimunEntity::checkSpawnRules
);
```
