...
title: 'Chapter 194: Crup'
description: Crup - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Crup** is a XXX (Competent) magical creature that inhabits the wizarding world. A dog-like creature with forked tail This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Crup, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Crup is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Crup uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Crup spawns in specific biomes and conditions that match its natural habitat.
...
The Crup has specific statistics that determine its capabilities and behavior in the game world.
...
The Crup uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Crup spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Southeast England
...
The Crup engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Crup drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Crup naturally inhabits Southeast England.
...
/**
 * Entity implementation for the Crup.
 * A magical creature that can be encountered in the wizarding world.
 */
public class CrupEntity extends MagicalCreatureEntity {
    
    public static final EntityType<CrupEntity> TYPE = EntityType.Builder
        .of(CrupEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("crup");
    
    public CrupEntity(EntityType<? extends CrupEntity> type, Level level) {
        super(type, level);
