...
title: 'Chapter 201: Jarvey'
description: Jarvey - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Jarvey** is a XXX (Competent) magical creature that inhabits the wizarding world. A large ferret This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Jarvey, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Jarvey is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Jarvey uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Jarvey spawns in specific biomes and conditions that match its natural habitat.
...
The Jarvey has specific statistics that determine its capabilities and behavior in the game world.
...
The Jarvey uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Jarvey spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Britain, Ireland, North America
...
The Jarvey engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Jarvey drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Jarvey naturally inhabits Britain, Ireland, North America.
...
/**
 * Entity implementation for the Jarvey.
 * A magical creature that can be encountered in the wizarding world.
 */
public class JarveyEntity extends MagicalCreatureEntity {
    
    public static final EntityType<JarveyEntity> TYPE = EntityType.Builder
        .of(JarveyEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("jarvey");
