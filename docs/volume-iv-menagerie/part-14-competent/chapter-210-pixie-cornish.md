...
title: 'Chapter 210: Pixie (Cornish)'
description: Pixie (Cornish) - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Pixie (Cornish)** is a XXX (Competent) magical creature that inhabits the wizarding world. A small, electric-blue creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Pixie (Cornish), including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Pixie (Cornish) is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Pixie (Cornish) uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Pixie (Cornish) spawns in specific biomes and conditions that match its natural habitat.
...
The Pixie (Cornish) has specific statistics that determine its capabilities and behavior in the game world.
...
The Pixie (Cornish) uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Pixie (Cornish) spawns under specific conditions that match its natural habitat and ecological niche.
...
The Pixie (Cornish) engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Pixie (Cornish) drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Pixie (Cornish) naturally inhabits Cornwall.
...
/**
 * Entity implementation for the Pixie (Cornish).
 * A magical creature that can be encountered in the wizarding world.
 */
public class PixieCornishEntity extends MagicalCreatureEntity {
    
    public static final EntityType<PixieCornishEntity> TYPE = EntityType.Builder
        .of(PixieCornishEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("pixie__cornish_");
    
    public PixieCornishEntity(EntityType<? extends PixieCornishEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    PixieCornishEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    PixieCornishEntity::checkSpawnRules
);
```
