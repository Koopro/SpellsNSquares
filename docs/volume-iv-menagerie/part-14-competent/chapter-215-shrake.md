...
title: 'Chapter 215: Shrake'
description: Shrake - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Shrake** is a XXX (Competent) magical creature that inhabits the wizarding world. A fish covered in spines This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Shrake, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Shrake is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Shrake uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Shrake spawns in specific biomes and conditions that match its natural habitat.
...
The Shrake has specific statistics that determine its capabilities and behavior in the game world.
...
The Shrake uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Shrake spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Atlantic Ocean
...
The Shrake engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Shrake drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Shrake naturally inhabits Atlantic Ocean.
...
/**
 * Entity implementation for the Shrake.
 * A magical creature that can be encountered in the wizarding world.
 */
public class ShrakeEntity extends MagicalCreatureEntity {
    
    public static final EntityType<ShrakeEntity> TYPE = EntityType.Builder
        .of(ShrakeEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("shrake");
    
    public ShrakeEntity(EntityType<? extends ShrakeEntity> type, Level level) {
        super(type, level);
