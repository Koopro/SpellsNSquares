...
title: 'Chapter 214: Salamander'
description: Salamander - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Salamander** is a XXX (Competent) magical creature that inhabits the wizarding world. A small lizard that lives in fire This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Salamander, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Salamander is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Salamander uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Salamander spawns in specific biomes and conditions that match its natural habitat.
...
The Salamander has specific statistics that determine its capabilities and behavior in the game world.
...
The Salamander uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Salamander spawns under specific conditions that match its natural habitat and ecological niche.
...
The Salamander engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Salamander drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Salamander naturally inhabits Fire.
...
/**
 * Entity implementation for the Salamander.
 * A magical creature that can be encountered in the wizarding world.
 */
public class SalamanderEntity extends MagicalCreatureEntity {
    
    public static final EntityType<SalamanderEntity> TYPE = EntityType.Builder
        .of(SalamanderEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("salamander");
...
EntitySpawnPlacements.register(
    SalamanderEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    SalamanderEntity::checkSpawnRules
);
```
