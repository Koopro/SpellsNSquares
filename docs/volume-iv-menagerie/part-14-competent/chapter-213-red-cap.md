...
title: 'Chapter 213: Red Cap'
description: Red Cap - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Red Cap** is a XXX (Competent) magical creature that inhabits the wizarding world. A dwarf-like creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Red Cap, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Red Cap is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Red Cap uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Red Cap spawns in specific biomes and conditions that match its natural habitat.
...
The Red Cap has specific statistics that determine its capabilities and behavior in the game world.
...
The Red Cap uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Red Cap spawns under specific conditions that match its natural habitat and ecological niche.
...
The Red Cap engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Red Cap drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Red Cap naturally inhabits Ruins.
...
/**
 * Entity implementation for the Red Cap.
 * A magical creature that can be encountered in the wizarding world.
 */
public class RedCapEntity extends MagicalCreatureEntity {
    
    public static final EntityType<RedCapEntity> TYPE = EntityType.Builder
        .of(RedCapEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("red_cap");
