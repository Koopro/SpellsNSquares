...
title: 'Chapter 203: Kneazle'
description: Kneazle - Implementation details and reference
tags:
  - iv menagerie
  - 14 competent
---
...
The **Kneazle** is a XXX (Competent) magical creature that inhabits the wizarding world. A cat-like creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Kneazle, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Kneazle is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Kneazle uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Kneazle spawns in specific biomes and conditions that match its natural habitat.
...
The Kneazle has specific statistics that determine its capabilities and behavior in the game world.
...
The Kneazle uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Kneazle spawns under specific conditions that match its natural habitat and ecological niche.
...
The Kneazle engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Kneazle drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Kneazle naturally inhabits Britain.
...
/**
 * Entity implementation for the Kneazle.
 * A magical creature that can be encountered in the wizarding world.
 */
public class KneazleEntity extends MagicalCreatureEntity {
    
    public static final EntityType<KneazleEntity> TYPE = EntityType.Builder
        .of(KneazleEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("kneazle");
