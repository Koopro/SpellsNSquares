...
title: 'Chapter 183: Giant Purple Toad'
description: Giant Purple Toad - Implementation details and reference
tags:
  - iv menagerie
  - 13 harmless
---
...
The **Giant Purple Toad** is a XX (Harmless) magical creature that inhabits the wizarding world. A large purple toad This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Giant Purple Toad, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Giant Purple Toad is classified as **XX (Harmless)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Giant Purple Toad uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Giant Purple Toad spawns in specific biomes and conditions that match its natural habitat.
...
The Giant Purple Toad has specific statistics that determine its capabilities and behavior in the game world.
...
The Giant Purple Toad uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Giant Purple Toad spawns under specific conditions that match its natural habitat and ecological niche.
...
The Giant Purple Toad engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Giant Purple Toad drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Giant Purple Toad naturally inhabits Wetlands.
...
/**
 * Entity implementation for the Giant Purple Toad.
 * A magical creature that can be encountered in the wizarding world.
 */
public class GiantPurpleToadEntity extends MagicalCreatureEntity {
    
    public static final EntityType<GiantPurpleToadEntity> TYPE = EntityType.Builder
        .of(GiantPurpleToadEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("giant_purple_toad");
    
    public GiantPurpleToadEntity(EntityType<? extends GiantPurpleToadEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    GiantPurpleToadEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    GiantPurpleToadEntity::checkSpawnRules
);
```
