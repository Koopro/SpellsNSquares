...
title: 'Chapter 187: Jobberknoll'
description: Jobberknoll - Implementation details and reference
tags:
  - iv menagerie
  - 13 harmless
---
...
The **Jobberknoll** is a XX (Harmless) magical creature that inhabits the wizarding world. A small, blue-speckled bird This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Jobberknoll, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Jobberknoll is classified as **XX (Harmless)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Jobberknoll uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Jobberknoll spawns in specific biomes and conditions that match its natural habitat.
...
The Jobberknoll has specific statistics that determine its capabilities and behavior in the game world.
...
The Jobberknoll uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Jobberknoll spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Northern Europe and America
...
The Jobberknoll engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Jobberknoll drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Jobberknoll naturally inhabits Northern Europe and America.
...
/**
 * Entity implementation for the Jobberknoll.
 * A magical creature that can be encountered in the wizarding world.
 */
public class JobberknollEntity extends MagicalCreatureEntity {
    
    public static final EntityType<JobberknollEntity> TYPE = EntityType.Builder
        .of(JobberknollEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("jobberknoll");
...
EntitySpawnPlacements.register(
    JobberknollEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    JobberknollEntity::checkSpawnRules
);
```
