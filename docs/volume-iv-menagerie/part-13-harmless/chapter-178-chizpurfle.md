...
title: 'Chapter 178: Chizpurfle'
description: Chizpurfle - Implementation details and reference
tags:
  - iv menagerie
  - 13 harmless
---
...
The **Chizpurfle** is a XX (Harmless) magical creature that inhabits the wizarding world. A tiny, crab-like parasite This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Chizpurfle, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Chizpurfle is classified as **XX (Harmless)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Chizpurfle uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Chizpurfle spawns in specific biomes and conditions that match its natural habitat.
...
The Chizpurfle has specific statistics that determine its capabilities and behavior in the game world.
...
The Chizpurfle uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Chizpurfle spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Magical objects
...
The Chizpurfle engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Chizpurfle drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Chizpurfle naturally inhabits Magical objects.
...
/**
 * Entity implementation for the Chizpurfle.
 * A magical creature that can be encountered in the wizarding world.
 */
public class ChizpurfleEntity extends MagicalCreatureEntity {
    
    public static final EntityType<ChizpurfleEntity> TYPE = EntityType.Builder
        .of(ChizpurfleEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("chizpurfle");
    
    public ChizpurfleEntity(EntityType<? extends ChizpurfleEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    ChizpurfleEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    ChizpurfleEntity::checkSpawnRules
);
```
