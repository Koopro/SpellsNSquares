...
title: 'Chapter 179: Clabbert'
description: Clabbert - Implementation details and reference
tags:
  - iv menagerie
  - 13 harmless
---
...
The **Clabbert** is a XX (Harmless) magical creature that inhabits the wizarding world. A tree-dwelling creature with a large mouth This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Clabbert, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Clabbert is classified as **XX (Harmless)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Clabbert uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Clabbert spawns in specific biomes and conditions that match its natural habitat.
...
The Clabbert has specific statistics that determine its capabilities and behavior in the game world.
...
The Clabbert uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Clabbert spawns under specific conditions that match its natural habitat and ecological niche.
...
The Clabbert engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Clabbert drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Clabbert naturally inhabits Trees.
...
/**
 * Entity implementation for the Clabbert.
 * A magical creature that can be encountered in the wizarding world.
 */
public class ClabbertEntity extends MagicalCreatureEntity {
    
    public static final EntityType<ClabbertEntity> TYPE = EntityType.Builder
        .of(ClabbertEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("clabbert");
...
EntitySpawnPlacements.register(
    ...
    ClabbertEntity::checkSpawnRules
);
```
