...
title: 'Chapter 180: Diricawl'
description: Diricawl - Implementation details and reference
tags:
  - iv menagerie
  - 13 harmless
---
...
The **Diricawl** is a XX (Harmless) magical creature that inhabits the wizarding world. A plump, flightless bird This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Diricawl, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Diricawl is classified as **XX (Harmless)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Diricawl uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Diricawl spawns in specific biomes and conditions that match its natural habitat.
...
The Diricawl has specific statistics that determine its capabilities and behavior in the game world.
...
The Diricawl uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Diricawl spawns under specific conditions that match its natural habitat and ecological niche.
...
The Diricawl engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Diricawl drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Diricawl naturally inhabits Mauritius.
...
/**
 * Entity implementation for the Diricawl.
 * A magical creature that can be encountered in the wizarding world.
 */
public class DiricawlEntity extends MagicalCreatureEntity {
    
    public static final EntityType<DiricawlEntity> TYPE = EntityType.Builder
        .of(DiricawlEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("diricawl");
...
EntitySpawnPlacements.register(
    ...
    DiricawlEntity::checkSpawnRules
);
```
