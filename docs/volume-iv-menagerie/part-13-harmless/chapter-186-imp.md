...
title: 'Chapter 186: Imp'
description: Imp - Implementation details and reference
tags:
  - iv menagerie
  - 13 harmless
---
...
The **Imp** is a XX (Harmless) magical creature that inhabits the wizarding world. A small, mischievous creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Imp, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Imp is classified as **XX (Harmless)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Imp uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Imp spawns in specific biomes and conditions that match its natural habitat.
...
The Imp has specific statistics that determine its capabilities and behavior in the game world.
...
The Imp uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Imp spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Britain and Ireland
...
The Imp engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Imp drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Imp naturally inhabits Britain and Ireland.
...
/**
 * Entity implementation for the Imp.
 * A magical creature that can be encountered in the wizarding world.
 */
public class ImpEntity extends MagicalCreatureEntity {
    
    public static final EntityType<ImpEntity> TYPE = EntityType.Builder
        .of(ImpEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("imp");
