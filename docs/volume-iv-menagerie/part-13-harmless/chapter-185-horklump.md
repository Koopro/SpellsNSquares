...
title: 'Chapter 185: Horklump'
description: Horklump - Implementation details and reference
tags:
  - iv menagerie
  - 13 harmless
---
...
The **Horklump** is a X (Harmless) magical creature that inhabits the wizarding world. A pink, mushroom-like creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Horklump, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Horklump is classified as **X (Harmless)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Horklump uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Horklump spawns in specific biomes and conditions that match its natural habitat.
...
The Horklump has specific statistics that determine its capabilities and behavior in the game world.
...
The Horklump uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Horklump spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Northern Europe
...
The Horklump engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Horklump drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Horklump naturally inhabits Northern Europe.
...
/**
 * Entity implementation for the Horklump.
 * A magical creature that can be encountered in the wizarding world.
 */
public class HorklumpEntity extends MagicalCreatureEntity {
    
    public static final EntityType<HorklumpEntity> TYPE = EntityType.Builder
        .of(HorklumpEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("horklump");
...
EntitySpawnPlacements.register(
    ...
    HorklumpEntity::checkSpawnRules
);
```
