...
title: 'Chapter 184: Gnome'
description: Gnome - Implementation details and reference
tags:
  - iv menagerie
  - 13 harmless
---
...
The **Gnome** is a XX (Harmless) magical creature that inhabits the wizarding world. A small, humanoid garden pest This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Gnome, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Gnome is classified as **XX (Harmless)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Gnome uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Gnome spawns in specific biomes and conditions that match its natural habitat.
...
The Gnome has specific statistics that determine its capabilities and behavior in the game world.
...
The Gnome uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Gnome spawns under specific conditions that match its natural habitat and ecological niche.
...
The Gnome engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Gnome drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Gnome naturally inhabits Gardens.
...
/**
 * Entity implementation for the Gnome.
 * A magical creature that can be encountered in the wizarding world.
 */
public class GnomeEntity extends MagicalCreatureEntity {
    
    public static final EntityType<GnomeEntity> TYPE = EntityType.Builder
        .of(GnomeEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("gnome");
