...
title: 'Chapter 182: Ghoul'
description: Ghoul - Implementation details and reference
tags:
  - iv menagerie
  - 13 harmless
---
...
The **Ghoul** is a XX (Harmless) magical creature that inhabits the wizarding world. A dim-witted creature that lives in attics This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Ghoul, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Ghoul is classified as **XX (Harmless)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Ghoul uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Ghoul spawns in specific biomes and conditions that match its natural habitat.
...
The Ghoul has specific statistics that determine its capabilities and behavior in the game world.
...
The Ghoul uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Ghoul spawns under specific conditions that match its natural habitat and ecological niche.
...
The Ghoul engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Ghoul drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Ghoul naturally inhabits Attics, barns.
...
/**
 * Entity implementation for the Ghoul.
 * A magical creature that can be encountered in the wizarding world.
 */
public class GhoulEntity extends MagicalCreatureEntity {
    
    public static final EntityType<GhoulEntity> TYPE = EntityType.Builder
        .of(GhoulEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("ghoul");
