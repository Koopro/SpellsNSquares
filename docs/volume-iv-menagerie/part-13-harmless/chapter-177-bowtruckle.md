...
title: 'Chapter 177: Bowtruckle'
description: Bowtruckle - Implementation details and reference
tags:
  - iv menagerie
  - 13 harmless
---
...
The **Bowtruckle** is a XX (Harmless) magical creature that inhabits the wizarding world. A small, twig-like creature that guards wand-wood trees This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Bowtruckle, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Bowtruckle is classified as **XX (Harmless)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Bowtruckle uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Bowtruckle spawns in specific biomes and conditions that match its natural habitat.
...
The Bowtruckle has specific statistics that determine its capabilities and behavior in the game world.
...
The Bowtruckle uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Bowtruckle spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Wand-wood trees
...
The Bowtruckle engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Bowtruckle drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Bowtruckle naturally inhabits Wand-wood trees.
...
/**
 * Entity implementation for the Bowtruckle.
 * A magical creature that can be encountered in the wizarding world.
 */
public class BowtruckleEntity extends MagicalCreatureEntity {
    
    public static final EntityType<BowtruckleEntity> TYPE = EntityType.Builder
        .of(BowtruckleEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("bowtruckle");
...
EntitySpawnPlacements.register(
    BowtruckleEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    BowtruckleEntity::checkSpawnRules
);
```
