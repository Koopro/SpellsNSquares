...
title: 'Chapter 188: Mooncalf'
description: Mooncalf - Implementation details and reference
tags:
  - iv menagerie
  - 13 harmless
---
...
The **Mooncalf** is a XX (Harmless) magical creature that inhabits the wizarding world. A shy creature that only appears during full moons This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Mooncalf, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Mooncalf is classified as **XX (Harmless)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Mooncalf uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Mooncalf spawns in specific biomes and conditions that match its natural habitat.
...
The Mooncalf has specific statistics that determine its capabilities and behavior in the game world.
...
The Mooncalf uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Mooncalf spawns under specific conditions that match its natural habitat and ecological niche.
...
The Mooncalf engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Mooncalf drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Mooncalf naturally inhabits Meadows.
...
/**
 * Entity implementation for the Mooncalf.
 * A magical creature that can be encountered in the wizarding world.
 */
public class MooncalfEntity extends MagicalCreatureEntity {
    
    public static final EntityType<MooncalfEntity> TYPE = EntityType.Builder
        .of(MooncalfEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("mooncalf");
...
EntitySpawnPlacements.register(
    ...
    MooncalfEntity::checkSpawnRules
);
```
