...
title: 'Chapter 265: Poltergeist (Peeves)'
description: Poltergeist (Peeves) - Implementation details and reference
tags:
  - iv menagerie
  - 17 spirits humanoids
---

## Overview

The **Poltergeist (Peeves)** is a Spirits & Humanoids magical creature that inhabits the wizarding world. A mischievous spirit This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Poltergeist (Peeves), including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Poltergeist (Peeves) is classified as **Spirits & Humanoids** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.

**Classification Details:**
- **Category**: Spirits & Humanoids
...
The Poltergeist (Peeves) uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Poltergeist (Peeves) spawns in specific biomes and conditions that match its natural habitat.
...
The Poltergeist (Peeves) has specific statistics that determine its capabilities and behavior in the game world.
...
The Poltergeist (Peeves) uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Poltergeist (Peeves) spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Old buildings
...
The Poltergeist (Peeves) engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Poltergeist (Peeves) drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Poltergeist (Peeves) naturally inhabits Old buildings.
...
| **Classification** | Spirits & Humanoids | Ministry classification |
...
/**
 * Entity implementation for the Poltergeist (Peeves).
 * A magical creature that can be encountered in the wizarding world.
 */
public class PoltergeistPeevesEntity extends MagicalCreatureEntity {
    
    public static final EntityType<PoltergeistPeevesEntity> TYPE = EntityType.Builder
        .of(PoltergeistPeevesEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("poltergeist__peeves_");
    
    public PoltergeistPeevesEntity(EntityType<? extends PoltergeistPeevesEntity> type, Level level) {
        super(type, level);
    ...
    public CreatureClassification getClassification() {
        return CreatureClassification.SPIRITS___HUMANOIDS;
    }
}
```
...
EntitySpawnPlacements.register(
    PoltergeistPeevesEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    PoltergeistPeevesEntity::checkSpawnRules
);
```
