...
title: 'Chapter 264: Inferius'
description: Inferius - Implementation details and reference
tags:
  - iv menagerie
...
The **Inferius** is a Spirits & Humanoids magical creature that inhabits the wizarding world. A reanimated corpse This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Inferius, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Inferius is classified as **Spirits & Humanoids** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Inferius uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Inferius spawns in specific biomes and conditions that match its natural habitat.
...
The Inferius has specific statistics that determine its capabilities and behavior in the game world.
...
The Inferius uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Inferius spawns under specific conditions that match its natural habitat and ecological niche.
...
The Inferius engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Inferius drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Inferius naturally inhabits Various.
...
/**
 * Entity implementation for the Inferius.
 * A magical creature that can be encountered in the wizarding world.
 */
public class InferiusEntity extends MagicalCreatureEntity {
    
    public static final EntityType<InferiusEntity> TYPE = EntityType.Builder
        .of(InferiusEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("inferius");
    
    public InferiusEntity(EntityType<? extends InferiusEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    ...
    InferiusEntity::checkSpawnRules
);
```
