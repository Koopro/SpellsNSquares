...
title: 'Chapter 267: Veela'
description: Veela - Implementation details and reference
tags:
  - iv menagerie
...
The **Veela** is a Spirits & Humanoids magical creature that inhabits the wizarding world. A beautiful, human-like creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Veela, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Veela is classified as **Spirits & Humanoids** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Veela uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Veela spawns in specific biomes and conditions that match its natural habitat.
...
The Veela has specific statistics that determine its capabilities and behavior in the game world.
...
The Veela uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Veela spawns under specific conditions that match its natural habitat and ecological niche.
...
The Veela engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Veela drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Veela naturally inhabits Bulgaria.
...
/**
 * Entity implementation for the Veela.
 * A magical creature that can be encountered in the wizarding world.
 */
public class VeelaEntity extends MagicalCreatureEntity {
    
    public static final EntityType<VeelaEntity> TYPE = EntityType.Builder
        .of(VeelaEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("veela");
