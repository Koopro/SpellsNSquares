...
title: 'Chapter 260: Dementor'
description: Dementor - Implementation details and reference
tags:
  - iv menagerie
...
The **Dementor** is a Spirits & Humanoids magical creature that inhabits the wizarding world. A hooded creature that feeds on happiness This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Dementor, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Dementor is classified as **Spirits & Humanoids** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Dementor uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Dementor spawns in specific biomes and conditions that match its natural habitat.
...
The Dementor has specific statistics that determine its capabilities and behavior in the game world.
...
The Dementor uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Dementor spawns under specific conditions that match its natural habitat and ecological niche.
...
The Dementor engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Dementor drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Dementor naturally inhabits Azkaban.
...
/**
 * Entity implementation for the Dementor.
 * A magical creature that can be encountered in the wizarding world.
 */
public class DementorEntity extends MagicalCreatureEntity {
    
    public static final EntityType<DementorEntity> TYPE = EntityType.Builder
        .of(DementorEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("dementor");
...
EntitySpawnPlacements.register(
    ...
    DementorEntity::checkSpawnRules
);
```
