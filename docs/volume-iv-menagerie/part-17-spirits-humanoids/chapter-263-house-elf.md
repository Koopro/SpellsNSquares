...
title: 'Chapter 263: House-Elf'
description: House-Elf - Implementation details and reference
tags:
  - iv menagerie
...
The **House-Elf** is a Spirits & Humanoids magical creature that inhabits the wizarding world. A small, magical servant This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the House-Elf, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The House-Elf is classified as **Spirits & Humanoids** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The House-Elf uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The House-Elf spawns in specific biomes and conditions that match its natural habitat.
...
The House-Elf has specific statistics that determine its capabilities and behavior in the game world.
...
The House-Elf uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The House-Elf spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Wizarding households
...
The House-Elf engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the House-Elf drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The House-Elf naturally inhabits Wizarding households.
...
/**
 * Entity implementation for the House-Elf.
 * A magical creature that can be encountered in the wizarding world.
 */
public class HouseElfEntity extends MagicalCreatureEntity {
    
    public static final EntityType<HouseElfEntity> TYPE = EntityType.Builder
        .of(HouseElfEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("house_elf");
...
EntitySpawnPlacements.register(
    ...
    HouseElfEntity::checkSpawnRules
);
```
