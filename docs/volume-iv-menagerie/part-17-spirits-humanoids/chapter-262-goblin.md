...
title: 'Chapter 262: Goblin'
description: Goblin - Implementation details and reference
tags:
  - iv menagerie
...
The **Goblin** is a Spirits & Humanoids magical creature that inhabits the wizarding world. A small, intelligent humanoid This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Goblin, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Goblin is classified as **Spirits & Humanoids** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Goblin uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Goblin spawns in specific biomes and conditions that match its natural habitat.
...
The Goblin has specific statistics that determine its capabilities and behavior in the game world.
...
The Goblin uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Goblin spawns under specific conditions that match its natural habitat and ecological niche.
...
The Goblin engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Goblin drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Goblin naturally inhabits Underground.
...
/**
 * Entity implementation for the Goblin.
 * A magical creature that can be encountered in the wizarding world.
 */
public class GoblinEntity extends MagicalCreatureEntity {
    
    public static final EntityType<GoblinEntity> TYPE = EntityType.Builder
        .of(GoblinEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("goblin");
