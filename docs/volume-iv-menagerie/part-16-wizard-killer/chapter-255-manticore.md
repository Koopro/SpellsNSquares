...
title: 'Chapter 255: Manticore'
description: Manticore - Implementation details and reference
tags:
  - iv menagerie
  - 16 wizard killer
---
...
The **Manticore** is a XXXXX (Wizard Killer) magical creature that inhabits the wizarding world. A creature with human head, lion body, scorpion tail This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Manticore, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Manticore is classified as **XXXXX (Wizard Killer)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Manticore uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Manticore spawns in specific biomes and conditions that match its natural habitat.
...
The Manticore has specific statistics that determine its capabilities and behavior in the game world.
...
The Manticore uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Manticore spawns under specific conditions that match its natural habitat and ecological niche.
...
The Manticore engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Manticore drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Manticore naturally inhabits Greece.
...
/**
 * Entity implementation for the Manticore.
 * A magical creature that can be encountered in the wizarding world.
 */
public class ManticoreEntity extends MagicalCreatureEntity {
    
    public static final EntityType<ManticoreEntity> TYPE = EntityType.Builder
        .of(ManticoreEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("manticore");
...
EntitySpawnPlacements.register(
    ManticoreEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    ManticoreEntity::checkSpawnRules
);
```
