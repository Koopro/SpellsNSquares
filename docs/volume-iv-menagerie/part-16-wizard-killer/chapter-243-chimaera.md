...
title: 'Chapter 243: Chimaera'
description: Chimaera - Implementation details and reference
tags:
  - iv menagerie
  - 16 wizard killer
---
...
The **Chimaera** is a XXXXX (Wizard Killer) magical creature that inhabits the wizarding world. A creature with lion head, goat body, dragon tail This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Chimaera, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Chimaera is classified as **XXXXX (Wizard Killer)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Chimaera uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Chimaera spawns in specific biomes and conditions that match its natural habitat.
...
The Chimaera has specific statistics that determine its capabilities and behavior in the game world.
...
The Chimaera uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Chimaera spawns under specific conditions that match its natural habitat and ecological niche.
...
The Chimaera engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Chimaera drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Chimaera naturally inhabits Greece.
...
/**
 * Entity implementation for the Chimaera.
 * A magical creature that can be encountered in the wizarding world.
 */
public class ChimaeraEntity extends MagicalCreatureEntity {
    
    public static final EntityType<ChimaeraEntity> TYPE = EntityType.Builder
        .of(ChimaeraEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("chimaera");
...
EntitySpawnPlacements.register(
    ...
    ChimaeraEntity::checkSpawnRules
);
```
