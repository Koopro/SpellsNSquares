...
title: 'Chapter 253: Dragon: Ukrainian Ironbelly'
description: 'Dragon: Ukrainian Ironbelly - Implementation details and reference'
tags:
  - iv menagerie
  - 16 wizard killer
---
...
The **Dragon: Ukrainian Ironbelly** is a XXX (Competent) magical creature that inhabits the wizarding world. A magical creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Dragon: Ukrainian Ironbelly, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Dragon: Ukrainian Ironbelly is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Dragon: Ukrainian Ironbelly uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Dragon: Ukrainian Ironbelly spawns in specific biomes and conditions that match its natural habitat.
...
The Dragon: Ukrainian Ironbelly has specific statistics that determine its capabilities and behavior in the game world.
...
The Dragon: Ukrainian Ironbelly uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Dragon: Ukrainian Ironbelly spawns under specific conditions that match its natural habitat and ecological niche.
...
The Dragon: Ukrainian Ironbelly engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Dragon: Ukrainian Ironbelly drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Dragon: Ukrainian Ironbelly naturally inhabits Various.
...
/**
 * Entity implementation for the Dragon: Ukrainian Ironbelly.
 * A magical creature that can be encountered in the wizarding world.
 */
public class DragonUkrainianIronbellyEntity extends MagicalCreatureEntity {
    
    public static final EntityType<DragonUkrainianIronbellyEntity> TYPE = EntityType.Builder
        .of(DragonUkrainianIronbellyEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("dragon__ukrainian_ironbelly");
    
    public DragonUkrainianIronbellyEntity(EntityType<? extends DragonUkrainianIronbellyEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    DragonUkrainianIronbellyEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    DragonUkrainianIronbellyEntity::checkSpawnRules
);
```
