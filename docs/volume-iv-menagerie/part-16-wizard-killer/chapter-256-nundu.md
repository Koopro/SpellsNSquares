...
title: 'Chapter 256: Nundu'
description: Nundu - Implementation details and reference
tags:
  - iv menagerie
  - 16 wizard killer
---
...
The **Nundu** is a XXXXX (Wizard Killer) magical creature that inhabits the wizarding world. A large, leopard-like creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Nundu, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Nundu is classified as **XXXXX (Wizard Killer)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Nundu uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Nundu spawns in specific biomes and conditions that match its natural habitat.
...
The Nundu has specific statistics that determine its capabilities and behavior in the game world.
...
The Nundu uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Nundu spawns under specific conditions that match its natural habitat and ecological niche.
...
The Nundu engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Nundu drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Nundu naturally inhabits East Africa.
...
/**
 * Entity implementation for the Nundu.
 * A magical creature that can be encountered in the wizarding world.
 */
public class NunduEntity extends MagicalCreatureEntity {
    
    public static final EntityType<NunduEntity> TYPE = EntityType.Builder
        .of(NunduEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("nundu");
    
    public NunduEntity(EntityType<? extends NunduEntity> type, Level level) {
        super(type, level);
