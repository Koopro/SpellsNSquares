...
title: 'Chapter 251: Dragon: Romanian Longhorn'
description: 'Dragon: Romanian Longhorn - Implementation details and reference'
tags:
  - iv menagerie
  - 16 wizard killer
---
...
The **Dragon: Romanian Longhorn** is a XXX (Competent) magical creature that inhabits the wizarding world. A magical creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Dragon: Romanian Longhorn, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Dragon: Romanian Longhorn is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Dragon: Romanian Longhorn uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Dragon: Romanian Longhorn spawns in specific biomes and conditions that match its natural habitat.
...
The Dragon: Romanian Longhorn has specific statistics that determine its capabilities and behavior in the game world.
...
The Dragon: Romanian Longhorn uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Dragon: Romanian Longhorn spawns under specific conditions that match its natural habitat and ecological niche.
...
The Dragon: Romanian Longhorn engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Dragon: Romanian Longhorn drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Dragon: Romanian Longhorn naturally inhabits Various.
...
/**
 * Entity implementation for the Dragon: Romanian Longhorn.
 * A magical creature that can be encountered in the wizarding world.
 */
public class DragonRomanianLonghornEntity extends MagicalCreatureEntity {
    
    public static final EntityType<DragonRomanianLonghornEntity> TYPE = EntityType.Builder
        .of(DragonRomanianLonghornEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("dragon__romanian_longhorn");
    
    public DragonRomanianLonghornEntity(EntityType<? extends DragonRomanianLonghornEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    DragonRomanianLonghornEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    DragonRomanianLonghornEntity::checkSpawnRules
);
```
