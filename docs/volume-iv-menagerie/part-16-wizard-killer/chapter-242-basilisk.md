...
title: 'Chapter 242: Basilisk'
description: Basilisk - Implementation details and reference
tags:
  - iv menagerie
  - 16 wizard killer
---
...
The **Basilisk** is a XXXXX (Wizard Killer) magical creature that inhabits the wizarding world. A giant serpent This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Basilisk, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Basilisk is classified as **XXXXX (Wizard Killer)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Basilisk uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Basilisk spawns in specific biomes and conditions that match its natural habitat.
...
The Basilisk has specific statistics that determine its capabilities and behavior in the game world.
...
The Basilisk uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Basilisk spawns under specific conditions that match its natural habitat and ecological niche.
...
The Basilisk engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Basilisk drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Basilisk naturally inhabits Underground.
...
/**
 * Entity implementation for the Basilisk.
 * A magical creature that can be encountered in the wizarding world.
 */
public class BasiliskEntity extends MagicalCreatureEntity {
    
    public static final EntityType<BasiliskEntity> TYPE = EntityType.Builder
        .of(BasiliskEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("basilisk");
...
EntitySpawnPlacements.register(
    ...
    BasiliskEntity::checkSpawnRules
);
```
