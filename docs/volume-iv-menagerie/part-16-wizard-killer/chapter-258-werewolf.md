...
title: 'Chapter 258: Werewolf'
description: Werewolf - Implementation details and reference
tags:
  - iv menagerie
  - 16 wizard killer
---
...
The **Werewolf** is a XXXXX (Wizard Killer) magical creature that inhabits the wizarding world. A human that transforms into wolf during full moon This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Werewolf, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Werewolf is classified as **XXXXX (Wizard Killer)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Werewolf uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Werewolf spawns in specific biomes and conditions that match its natural habitat.
...
The Werewolf has specific statistics that determine its capabilities and behavior in the game world.
...
The Werewolf uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Werewolf spawns under specific conditions that match its natural habitat and ecological niche.
...
The Werewolf engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Werewolf drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Werewolf naturally inhabits Worldwide.
...
/**
 * Entity implementation for the Werewolf.
 * A magical creature that can be encountered in the wizarding world.
 */
public class WerewolfEntity extends MagicalCreatureEntity {
    
    public static final EntityType<WerewolfEntity> TYPE = EntityType.Builder
        .of(WerewolfEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("werewolf");
