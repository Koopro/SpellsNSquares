...
title: 'Chapter 246: Dragon: Common Welsh Green'
description: 'Dragon: Common Welsh Green - Implementation details and reference'
tags:
  - iv menagerie
  - 16 wizard killer
---
...
The **Dragon: Common Welsh Green** is a XXX (Competent) magical creature that inhabits the wizarding world. A magical creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Dragon: Common Welsh Green, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Dragon: Common Welsh Green is classified as **XXX (Competent)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.
...
The Dragon: Common Welsh Green uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Dragon: Common Welsh Green spawns in specific biomes and conditions that match its natural habitat.
...
The Dragon: Common Welsh Green has specific statistics that determine its capabilities and behavior in the game world.
...
The Dragon: Common Welsh Green uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Dragon: Common Welsh Green spawns under specific conditions that match its natural habitat and ecological niche.
...
The Dragon: Common Welsh Green engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Dragon: Common Welsh Green drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Dragon: Common Welsh Green naturally inhabits Various.
...
/**
 * Entity implementation for the Dragon: Common Welsh Green.
 * A magical creature that can be encountered in the wizarding world.
 */
public class DragonCommonWelshGreenEntity extends MagicalCreatureEntity {
    
    public static final EntityType<DragonCommonWelshGreenEntity> TYPE = EntityType.Builder
        .of(DragonCommonWelshGreenEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("dragon__common_welsh_green");
    
    public DragonCommonWelshGreenEntity(EntityType<? extends DragonCommonWelshGreenEntity> type, Level level) {
        super(type, level);
...
EntitySpawnPlacements.register(
    DragonCommonWelshGreenEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    DragonCommonWelshGreenEntity::checkSpawnRules
);
```
