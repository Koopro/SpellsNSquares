...
title: 'Chapter 259: Wampus Cat'
description: Wampus Cat - Implementation details and reference
tags:
  - iv menagerie
  - 16 wizard killer
---
...
The **Wampus Cat** is a XXXXX (Wizard Killer) magical creature that inhabits the wizarding world. A large, cat-like creature This creature plays an important role in the ecosystem and provides various interactions for players, including combat encounters, taming opportunities, and resource gathering.

This chapter documents the complete implementation of the Wampus Cat, including AI behaviors, spawning mechanics, combat systems, taming requirements, and all creature-specific properties that make it unique in the mod.

## Implementation Details

### Creature Classification

The Wampus Cat is classified as **XXXXX (Wizard Killer)** according to the Ministry of Magic's classification system. This classification determines how dangerous the creature is and what precautions players should take when encountering it.

**Classification Details:**
- **Category**: XXXXX (Wizard Killer)
- **Danger Level**: Extreme
- **Ministry Regulations**: Extreme caution, expert handling only
- **Handling Requirements**: Expert-level handling, protective gear

### AI Behavior System

The Wampus Cat uses an advanced AI system that governs its behavior patterns, reactions to players, and environmental interactions.
...
The Wampus Cat spawns in specific biomes and conditions that match its natural habitat.
...
The Wampus Cat has specific statistics that determine its capabilities and behavior in the game world.
...
The Wampus Cat uses sophisticated AI to govern its behavior, reactions, and interactions with the world.
...
The Wampus Cat spawns under specific conditions that match its natural habitat and ecological niche.
...
- **Preferred Biomes**: Appalachian Mountains
...
The Wampus Cat engages in combat when threatened or when its territory is invaded. It uses a combination of melee attacks and defensive behaviors to protect itself.
...
When defeated, the Wampus Cat drops various items that can be used for crafting, potion-making, or other purposes.
...
**Natural Habitat:**
The Wampus Cat naturally inhabits Appalachian Mountains.
...
|----------|-------|-------------|
| **Health Points** | 80 | Base health pool |
| **Attack Damage** | 16 | Base melee damage |
| **Armor Points** | 8 | Damage reduction |
...
| **Classification** | XXXXX (Wizard Killer) | Ministry classification |
...
| Property | Value | Description |
|----------|-------|-------------|
| **Aggression Level** | Hostile | How easily provoked |
...
/**
 * Entity implementation for the Wampus Cat.
 * A magical creature that can be encountered in the wizarding world.
 */
public class WampusCatEntity extends MagicalCreatureEntity {
    
    public static final EntityType<WampusCatEntity> TYPE = EntityType.Builder
        .of(WampusCatEntity::new, MobCategory.CREATURE)
        .sized(0.6f, 1.8f)
        .build("wampus_cat");
    
    public WampusCatEntity(EntityType<? extends WampusCatEntity> type, Level level) {
        super(type, level);
    ...
    public CreatureClassification getClassification() {
        return CreatureClassification.XXXXX__WIZARD_KILLER_;
    }
}
```
...
EntitySpawnPlacements.register(
    WampusCatEntity.TYPE,
    SpawnPlacements.Type.ON_GROUND,
    Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
    WampusCatEntity::checkSpawnRules
);
```
