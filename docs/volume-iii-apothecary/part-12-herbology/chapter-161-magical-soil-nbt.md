...
title: 'Chapter 161: Magical Soil NBT'
description: Magical Soil NBT - Implementation details and reference
tags:
  - iii apothecary
  - 12 herbology
---
...
The **Magical Soil NBT** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Magical Soil NBT, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Magical Soil NBT requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Magical Soil NBT applies the following effects:
...
The Magical Soil NBT requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Magical Soil NBT applies comprehensive effects that impact the player's capabilities and status.
...
The Magical Soil NBT is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Magical Soil NBT can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Magical Soil NBT can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Magical Soil NBT can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Magical Soil NBT may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Magical Soil NBT | Official name |
...
/**
 * Implementation of the Magical Soil NBT potion.
 * A potion that provides beneficial effects.
 */
public class MagicalSoilNBTPotion extends BasePotion {
    
    public static final String POTION_ID = "magical_soil_nbt";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public MagicalSoilNBTPotion() {
...
public static final Potion MAGICALSOILNBT = register(
    new MagicalSoilNBTPotion(),
