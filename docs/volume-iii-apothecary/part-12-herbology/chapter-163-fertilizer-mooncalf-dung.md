...
title: 'Chapter 163: Fertilizer: Mooncalf Dung'
description: 'Fertilizer: Mooncalf Dung - Implementation details and reference'
tags:
  - iii apothecary
  - 12 herbology
---
...
The **Fertilizer: Mooncalf Dung** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Fertilizer: Mooncalf Dung, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Fertilizer: Mooncalf Dung requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Fertilizer: Mooncalf Dung applies the following effects:
...
The Fertilizer: Mooncalf Dung requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Fertilizer: Mooncalf Dung applies comprehensive effects that impact the player's capabilities and status.
...
The Fertilizer: Mooncalf Dung is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Fertilizer: Mooncalf Dung can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Fertilizer: Mooncalf Dung can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Fertilizer: Mooncalf Dung can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Fertilizer: Mooncalf Dung may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Fertilizer: Mooncalf Dung | Official name |
...
/**
 * Implementation of the Fertilizer: Mooncalf Dung potion.
 * A potion that provides beneficial effects.
 */
public class FertilizerMooncalfDungPotion extends BasePotion {
    
    public static final String POTION_ID = "fertilizer__mooncalf_dung";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public FertilizerMooncalfDungPotion() {
...
public static final Potion FERTILIZERMOONCALFDUNG = register(
    new FertilizerMooncalfDungPotion(),
