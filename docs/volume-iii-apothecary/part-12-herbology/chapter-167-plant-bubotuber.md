...
title: 'Chapter 167: Plant: Bubotuber'
description: 'Plant: Bubotuber - Implementation details and reference'
tags:
  - iii apothecary
  - 12 herbology
---
...
The **Plant: Bubotuber** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Plant: Bubotuber, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Plant: Bubotuber requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Plant: Bubotuber applies the following effects:
...
The Plant: Bubotuber requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Plant: Bubotuber applies comprehensive effects that impact the player's capabilities and status.
...
The Plant: Bubotuber is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Plant: Bubotuber can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Plant: Bubotuber can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Plant: Bubotuber can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Plant: Bubotuber may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Plant: Bubotuber | Official name |
...
/**
 * Implementation of the Plant: Bubotuber potion.
 * A potion that provides beneficial effects.
 */
public class PlantBubotuberPotion extends BasePotion {
    
    public static final String POTION_ID = "plant__bubotuber";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public PlantBubotuberPotion() {
...
public static final Potion PLANTBUBOTUBER = register(
    new PlantBubotuberPotion(),
