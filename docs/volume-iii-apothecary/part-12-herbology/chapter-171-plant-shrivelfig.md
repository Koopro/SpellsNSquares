...
title: 'Chapter 171: Plant: Shrivelfig'
description: 'Plant: Shrivelfig - Implementation details and reference'
tags:
  - iii apothecary
  - 12 herbology
---
...
The **Plant: Shrivelfig** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Plant: Shrivelfig, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Plant: Shrivelfig requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Plant: Shrivelfig applies the following effects:
...
The Plant: Shrivelfig requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Plant: Shrivelfig applies comprehensive effects that impact the player's capabilities and status.
...
The Plant: Shrivelfig is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Plant: Shrivelfig can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Plant: Shrivelfig can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Plant: Shrivelfig can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Plant: Shrivelfig may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Plant: Shrivelfig | Official name |
...
/**
 * Implementation of the Plant: Shrivelfig potion.
 * A potion that provides beneficial effects.
 */
public class PlantShrivelfigPotion extends BasePotion {
    
    public static final String POTION_ID = "plant__shrivelfig";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public PlantShrivelfigPotion() {
...
public static final Potion PLANTSHRIVELFIG = register(
    new PlantShrivelfigPotion(),
