...
title: 'Chapter 164: Plant: Mandrake'
description: 'Plant: Mandrake - Implementation details and reference'
tags:
  - iii apothecary
  - 12 herbology
---
...
The **Plant: Mandrake** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Plant: Mandrake, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Plant: Mandrake requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Plant: Mandrake applies the following effects:
...
The Plant: Mandrake requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Plant: Mandrake applies comprehensive effects that impact the player's capabilities and status.
...
The Plant: Mandrake is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Plant: Mandrake can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Plant: Mandrake can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Plant: Mandrake can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Plant: Mandrake may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Plant: Mandrake | Official name |
...
/**
 * Implementation of the Plant: Mandrake potion.
 * A potion that provides beneficial effects.
 */
public class PlantMandrakePotion extends BasePotion {
    
    public static final String POTION_ID = "plant__mandrake";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public PlantMandrakePotion() {
...
public static final Potion PLANTMANDRAKE = register(
    new PlantMandrakePotion(),
