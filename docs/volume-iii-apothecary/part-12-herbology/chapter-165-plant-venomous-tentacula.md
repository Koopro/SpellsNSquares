...
title: 'Chapter 165: Plant: Venomous Tentacula'
description: 'Plant: Venomous Tentacula - Implementation details and reference'
tags:
  - iii apothecary
  - 12 herbology
---
...
The **Plant: Venomous Tentacula** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Plant: Venomous Tentacula, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Plant: Venomous Tentacula requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Plant: Venomous Tentacula applies the following effects:
...
The Plant: Venomous Tentacula requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Plant: Venomous Tentacula applies comprehensive effects that impact the player's capabilities and status.
...
The Plant: Venomous Tentacula is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Plant: Venomous Tentacula can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Plant: Venomous Tentacula can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Plant: Venomous Tentacula can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Plant: Venomous Tentacula may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Plant: Venomous Tentacula | Official name |
...
/**
 * Implementation of the Plant: Venomous Tentacula potion.
 * A potion that provides beneficial effects.
 */
public class PlantVenomousTentaculaPotion extends BasePotion {
    
    public static final String POTION_ID = "plant__venomous_tentacula";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public PlantVenomousTentaculaPotion() {
...
public static final Potion PLANTVENOMOUSTENTACULA = register(
    new PlantVenomousTentaculaPotion(),
