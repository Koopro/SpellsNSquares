...
title: 'Chapter 170: Plant: Dirigible Plum'
description: 'Plant: Dirigible Plum - Implementation details and reference'
tags:
  - iii apothecary
  - 12 herbology
---
...
The **Plant: Dirigible Plum** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Plant: Dirigible Plum, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Plant: Dirigible Plum requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Plant: Dirigible Plum applies the following effects:
...
The Plant: Dirigible Plum requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Plant: Dirigible Plum applies comprehensive effects that impact the player's capabilities and status.
...
The Plant: Dirigible Plum is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Plant: Dirigible Plum can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Plant: Dirigible Plum can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Plant: Dirigible Plum can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Plant: Dirigible Plum may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Plant: Dirigible Plum | Official name |
...
/**
 * Implementation of the Plant: Dirigible Plum potion.
 * A potion that provides beneficial effects.
 */
public class PlantDirigiblePlumPotion extends BasePotion {
    
    public static final String POTION_ID = "plant__dirigible_plum";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public PlantDirigiblePlumPotion() {
...
public static final Potion PLANTDIRIGIBLEPLUM = register(
    new PlantDirigiblePlumPotion(),
