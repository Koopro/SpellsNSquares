...
title: 'Chapter 174: Tree: Wiggentree'
description: 'Tree: Wiggentree - Implementation details and reference'
tags:
  - iii apothecary
  - 12 herbology
---
...
The **Tree: Wiggentree** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Tree: Wiggentree, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Tree: Wiggentree requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Tree: Wiggentree applies the following effects:
...
The Tree: Wiggentree requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Tree: Wiggentree applies comprehensive effects that impact the player's capabilities and status.
...
The Tree: Wiggentree is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Tree: Wiggentree can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Tree: Wiggentree can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Tree: Wiggentree can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Tree: Wiggentree may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Tree: Wiggentree | Official name |
...
/**
 * Implementation of the Tree: Wiggentree potion.
 * A potion that provides beneficial effects.
 */
public class TreeWiggentreePotion extends BasePotion {
    
    public static final String POTION_ID = "tree__wiggentree";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public TreeWiggentreePotion() {
...
public static final Potion TREEWIGGENTREE = register(
    new TreeWiggentreePotion(),
