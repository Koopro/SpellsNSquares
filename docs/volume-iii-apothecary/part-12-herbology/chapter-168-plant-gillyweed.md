...
title: 'Chapter 168: Plant: Gillyweed'
description: 'Plant: Gillyweed - Implementation details and reference'
tags:
  - iii apothecary
  - 12 herbology
---
...
The **Plant: Gillyweed** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Plant: Gillyweed, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Plant: Gillyweed requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Plant: Gillyweed applies the following effects:
...
The Plant: Gillyweed requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Plant: Gillyweed applies comprehensive effects that impact the player's capabilities and status.
...
The Plant: Gillyweed is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Plant: Gillyweed can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Plant: Gillyweed can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Plant: Gillyweed can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Plant: Gillyweed may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Plant: Gillyweed | Official name |
...
/**
 * Implementation of the Plant: Gillyweed potion.
 * A potion that provides beneficial effects.
 */
public class PlantGillyweedPotion extends BasePotion {
    
    public static final String POTION_ID = "plant__gillyweed";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public PlantGillyweedPotion() {
...
public static final Potion PLANTGILLYWEED = register(
    new PlantGillyweedPotion(),
