...
title: 'Chapter 175: Tree: Yew'
description: 'Tree: Yew - Implementation details and reference'
tags:
  - iii apothecary
  - 12 herbology
---
...
The **Tree: Yew** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Tree: Yew, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Tree: Yew requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Tree: Yew applies the following effects:
...
The Tree: Yew requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Tree: Yew applies comprehensive effects that impact the player's capabilities and status.
...
The Tree: Yew is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Tree: Yew can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Tree: Yew can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Tree: Yew can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Tree: Yew may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Tree: Yew | Official name |
...
/**
 * Implementation of the Tree: Yew potion.
 * A potion that provides beneficial effects.
 */
public class TreeYewPotion extends BasePotion {
    
    public static final String POTION_ID = "tree__yew";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public TreeYewPotion() {
...
public static final Potion TREEYEW = register(
    new TreeYewPotion(),
