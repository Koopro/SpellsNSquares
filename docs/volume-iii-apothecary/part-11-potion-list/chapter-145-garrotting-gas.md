...
title: 'Chapter 145: Garrotting Gas'
description: Garrotting Gas - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Garrotting Gas** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Garrotting Gas, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Garrotting Gas requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Garrotting Gas applies the following effects:
...
The Garrotting Gas requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Garrotting Gas applies comprehensive effects that impact the player's capabilities and status.
...
The Garrotting Gas is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Garrotting Gas can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Garrotting Gas can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Garrotting Gas can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Garrotting Gas may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Garrotting Gas | Official name |
...
/**
 * Implementation of the Garrotting Gas potion.
 * A potion that provides beneficial effects.
 */
public class GarrottingGasPotion extends BasePotion {
    
    public static final String POTION_ID = "garrotting_gas";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public GarrottingGasPotion() {
...
public static final Potion GARROTTINGGAS = register(
    new GarrottingGasPotion(),
