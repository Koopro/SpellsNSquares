...
title: 'Chapter 150: Polyjuice Potion'
description: Polyjuice Potion - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Polyjuice Potion** is a Transformation potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Polyjuice Potion, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Polyjuice Potion requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Polyjuice Potion applies the following effects:
...
The Polyjuice Potion requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Polyjuice Potion applies comprehensive effects that impact the player's capabilities and status.
...
The Polyjuice Potion is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Polyjuice Potion can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Polyjuice Potion can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Polyjuice Potion can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Polyjuice Potion may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Polyjuice Potion | Official name |
...
/**
 * Implementation of the Polyjuice Potion potion.
 * A potion that provides beneficial effects.
 */
public class PolyjuicePotionPotion extends BasePotion {
    
    public static final String POTION_ID = "polyjuice_potion";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public PolyjuicePotionPotion() {
...
public static final Potion POLYJUICEPOTION = register(
    new PolyjuicePotionPotion(),
