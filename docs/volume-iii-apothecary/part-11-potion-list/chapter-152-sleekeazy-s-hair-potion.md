...
title: 'Chapter 152: Sleekeazy''s Hair Potion'
description: 'Sleekeazy''s Hair Potion - Implementation details and reference'
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Sleekeazy''s Hair Potion** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Sleekeazy''s Hair Potion, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Sleekeazy''s Hair Potion requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Sleekeazy''s Hair Potion applies the following effects:
...
The Sleekeazy''s Hair Potion requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Sleekeazy''s Hair Potion applies comprehensive effects that impact the player's capabilities and status.
...
The Sleekeazy''s Hair Potion is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Sleekeazy''s Hair Potion can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Sleekeazy''s Hair Potion can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Sleekeazy''s Hair Potion can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Sleekeazy''s Hair Potion may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Sleekeazy''s Hair Potion | Official name |
...
/**
 * Implementation of the Sleekeazy''s Hair Potion potion.
 * A potion that provides beneficial effects.
 */
public class SleekeazysHairPotionPotion extends BasePotion {
    
    public static final String POTION_ID = "sleekeazy__s_hair_potion";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public SleekeazysHairPotionPotion() {
...
public static final Potion SLEEKEAZYSHAIRPOTION = register(
    new SleekeazysHairPotionPotion(),
