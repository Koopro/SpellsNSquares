...
title: 'Chapter 148: Mandrake Restorative Draught'
description: Mandrake Restorative Draught - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Mandrake Restorative Draught** is a Healing potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Mandrake Restorative Draught, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Mandrake Restorative Draught requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Mandrake Restorative Draught applies the following effects:
...
The Mandrake Restorative Draught requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Mandrake Restorative Draught applies comprehensive effects that impact the player's capabilities and status.
...
The Mandrake Restorative Draught is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Mandrake Restorative Draught can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Mandrake Restorative Draught can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Mandrake Restorative Draught can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Mandrake Restorative Draught may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Mandrake Restorative Draught | Official name |
| **Type** | Healing | Potion classification |
...
/**
 * Implementation of the Mandrake Restorative Draught potion.
 * A potion that provides beneficial effects.
 */
public class MandrakeRestorativeDraughtPotion extends BasePotion {
    
    public static final String POTION_ID = "mandrake_restorative_draught";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public MandrakeRestorativeDraughtPotion() {
...
public static final Potion MANDRAKERESTORATIVEDRAUGHT = register(
    new MandrakeRestorativeDraughtPotion(),
