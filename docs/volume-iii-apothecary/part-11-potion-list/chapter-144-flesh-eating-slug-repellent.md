...
title: 'Chapter 144: Flesh-Eating Slug Repellent'
description: Flesh-Eating Slug Repellent - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Flesh-Eating Slug Repellent** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Flesh-Eating Slug Repellent, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Flesh-Eating Slug Repellent requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Flesh-Eating Slug Repellent applies the following effects:
...
The Flesh-Eating Slug Repellent requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Flesh-Eating Slug Repellent applies comprehensive effects that impact the player's capabilities and status.
...
The Flesh-Eating Slug Repellent is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Flesh-Eating Slug Repellent can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Flesh-Eating Slug Repellent can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Flesh-Eating Slug Repellent can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Flesh-Eating Slug Repellent may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Flesh-Eating Slug Repellent | Official name |
...
/**
 * Implementation of the Flesh-Eating Slug Repellent potion.
 * A potion that provides beneficial effects.
 */
public class FleshEatingSlugRepellentPotion extends BasePotion {
    
    public static final String POTION_ID = "flesh_eating_slug_repellent";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public FleshEatingSlugRepellentPotion() {
...
public static final Potion FLESHEATINGSLUGREPELLENT = register(
    new FleshEatingSlugRepellentPotion(),
