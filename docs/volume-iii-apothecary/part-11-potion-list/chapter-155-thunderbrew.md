...
title: 'Chapter 155: Thunderbrew'
description: Thunderbrew - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Thunderbrew** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Thunderbrew, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Thunderbrew requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Thunderbrew applies the following effects:
...
The Thunderbrew requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Thunderbrew applies comprehensive effects that impact the player's capabilities and status.
...
The Thunderbrew is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Thunderbrew can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Thunderbrew can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Thunderbrew can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Thunderbrew may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Thunderbrew | Official name |
...
/**
 * Implementation of the Thunderbrew potion.
 * A potion that provides beneficial effects.
 */
public class ThunderbrewPotion extends BasePotion {
    
    public static final String POTION_ID = "thunderbrew";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public ThunderbrewPotion() {
...
public static final Potion THUNDERBREW = register(
    new ThunderbrewPotion(),
