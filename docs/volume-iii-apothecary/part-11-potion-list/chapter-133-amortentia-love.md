...
title: 'Chapter 133: Amortentia (Love)'
description: Amortentia (Love) - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Amortentia** is a Love potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Amortentia, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Amortentia requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Amortentia applies the following effects:
...
The Amortentia requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Amortentia applies comprehensive effects that impact the player's capabilities and status.
...
The Amortentia is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Amortentia can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Amortentia can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Amortentia can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Amortentia may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Amortentia | Official name |
| **Type** | Love | Potion classification |
...
/**
 * Implementation of the Amortentia potion.
 * A potion that provides beneficial effects.
 */
public class AmortentiaPotion extends BasePotion {
    
    public static final String POTION_ID = "amortentia";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public AmortentiaPotion() {
...
public static final Potion AMORTENTIA = register(
    new AmortentiaPotion(),
