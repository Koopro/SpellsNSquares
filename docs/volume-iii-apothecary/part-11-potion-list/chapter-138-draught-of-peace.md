...
title: 'Chapter 138: Draught of Peace'
description: Draught of Peace - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Draught of Peace** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Draught of Peace, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Draught of Peace requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Draught of Peace applies the following effects:
...
The Draught of Peace requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Draught of Peace applies comprehensive effects that impact the player's capabilities and status.
...
The Draught of Peace is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Draught of Peace can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Draught of Peace can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Draught of Peace can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Draught of Peace may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Draught of Peace | Official name |
...
/**
 * Implementation of the Draught of Peace potion.
 * A potion that provides beneficial effects.
 */
public class DraughtofPeacePotion extends BasePotion {
    
    public static final String POTION_ID = "draught_of_peace";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public DraughtofPeacePotion() {
...
public static final Potion DRAUGHTOFPEACE = register(
    new DraughtofPeacePotion(),
