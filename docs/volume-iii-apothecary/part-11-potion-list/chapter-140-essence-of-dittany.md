...
title: 'Chapter 140: Essence of Dittany'
description: Essence of Dittany - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Essence of Dittany** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Essence of Dittany, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Essence of Dittany requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Essence of Dittany applies the following effects:
...
The Essence of Dittany requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Essence of Dittany applies comprehensive effects that impact the player's capabilities and status.
...
The Essence of Dittany is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Essence of Dittany can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Essence of Dittany can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Essence of Dittany can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Essence of Dittany may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Essence of Dittany | Official name |
...
/**
 * Implementation of the Essence of Dittany potion.
 * A potion that provides beneficial effects.
 */
public class EssenceofDittanyPotion extends BasePotion {
    
    public static final String POTION_ID = "essence_of_dittany";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public EssenceofDittanyPotion() {
...
public static final Potion ESSENCEOFDITTANY = register(
    new EssenceofDittanyPotion(),
