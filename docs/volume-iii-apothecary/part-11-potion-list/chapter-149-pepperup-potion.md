...
title: 'Chapter 149: Pepperup Potion'
description: Pepperup Potion - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Pepperup Potion** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Pepperup Potion, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Pepperup Potion requires specific ingredients and brewing procedures to create successfully.
...
**Skill Requirement**: 1 level in Potions

### Potion Effects

When consumed, the Pepperup Potion applies the following effects:
...
The Pepperup Potion requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Pepperup Potion applies comprehensive effects that impact the player's capabilities and status.
...
The Pepperup Potion is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Pepperup Potion can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Pepperup Potion can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Pepperup Potion can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Pepperup Potion may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Pepperup Potion | Official name |
...
| **Difficulty** | Beginner | Brewing difficulty |
| **Skill Level** | 1 | Required potions skill |
...
/**
 * Implementation of the Pepperup Potion potion.
 * A potion that provides beneficial effects.
 */
public class PepperupPotionPotion extends BasePotion {
    
    public static final String POTION_ID = "pepperup_potion";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public PepperupPotionPotion() {
...
public static final Potion PEPPERUPPOTION = register(
    new PepperupPotionPotion(),
