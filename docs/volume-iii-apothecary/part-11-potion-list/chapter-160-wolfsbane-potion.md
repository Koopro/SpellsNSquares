...
title: 'Chapter 160: Wolfsbane Potion'
description: Wolfsbane Potion - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Wolfsbane Potion** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Wolfsbane Potion, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Wolfsbane Potion requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Wolfsbane Potion applies the following effects:
...
The Wolfsbane Potion requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Wolfsbane Potion applies comprehensive effects that impact the player's capabilities and status.
...
The Wolfsbane Potion is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Wolfsbane Potion can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Wolfsbane Potion can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Wolfsbane Potion can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Wolfsbane Potion may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Wolfsbane Potion | Official name |
...
/**
 * Implementation of the Wolfsbane Potion potion.
 * A potion that provides beneficial effects.
 */
public class WolfsbanePotionPotion extends BasePotion {
    
    public static final String POTION_ID = "wolfsbane_potion";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public WolfsbanePotionPotion() {
...
public static final Potion WOLFSBANEPOTION = register(
    new WolfsbanePotionPotion(),
