...
title: 'Chapter 137: Draught of Living Death'
description: Draught of Living Death - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Draught of Living Death** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Draught of Living Death, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Draught of Living Death requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Draught of Living Death applies the following effects:
...
The Draught of Living Death requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Draught of Living Death applies comprehensive effects that impact the player's capabilities and status.
...
The Draught of Living Death is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Draught of Living Death can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Draught of Living Death can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Draught of Living Death can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Draught of Living Death may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Draught of Living Death | Official name |
...
/**
 * Implementation of the Draught of Living Death potion.
 * A potion that provides beneficial effects.
 */
public class DraughtofLivingDeathPotion extends BasePotion {
    
    public static final String POTION_ID = "draught_of_living_death";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public DraughtofLivingDeathPotion() {
...
public static final Potion DRAUGHTOFLIVINGDEATH = register(
    new DraughtofLivingDeathPotion(),
