...
title: 'Chapter 153: Sleeping Draught'
description: Sleeping Draught - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Sleeping Draught** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Sleeping Draught, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Sleeping Draught requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Sleeping Draught applies the following effects:
...
The Sleeping Draught requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Sleeping Draught applies comprehensive effects that impact the player's capabilities and status.
...
The Sleeping Draught is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Sleeping Draught can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Sleeping Draught can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Sleeping Draught can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Sleeping Draught may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Sleeping Draught | Official name |
...
/**
 * Implementation of the Sleeping Draught potion.
 * A potion that provides beneficial effects.
 */
public class SleepingDraughtPotion extends BasePotion {
    
    public static final String POTION_ID = "sleeping_draught";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public SleepingDraughtPotion() {
...
public static final Potion SLEEPINGDRAUGHT = register(
    new SleepingDraughtPotion(),
