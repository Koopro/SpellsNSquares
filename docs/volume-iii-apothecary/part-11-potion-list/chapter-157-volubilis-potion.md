...
title: 'Chapter 157: Volubilis Potion'
description: Volubilis Potion - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Volubilis Potion** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Volubilis Potion, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Volubilis Potion requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Volubilis Potion applies the following effects:
...
The Volubilis Potion requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Volubilis Potion applies comprehensive effects that impact the player's capabilities and status.
...
The Volubilis Potion is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Volubilis Potion can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Volubilis Potion can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Volubilis Potion can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Volubilis Potion may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Volubilis Potion | Official name |
...
/**
 * Implementation of the Volubilis Potion potion.
 * A potion that provides beneficial effects.
 */
public class VolubilisPotionPotion extends BasePotion {
    
    public static final String POTION_ID = "volubilis_potion";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public VolubilisPotionPotion() {
...
public static final Potion VOLUBILISPOTION = register(
    new VolubilisPotionPotion(),
