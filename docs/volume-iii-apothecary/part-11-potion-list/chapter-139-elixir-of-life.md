...
title: 'Chapter 139: Elixir of Life'
description: Elixir of Life - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Elixir of Life** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Elixir of Life, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Elixir of Life requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Elixir of Life applies the following effects:
...
The Elixir of Life requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Elixir of Life applies comprehensive effects that impact the player's capabilities and status.
...
The Elixir of Life is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Elixir of Life can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Elixir of Life can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Elixir of Life can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Elixir of Life may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Elixir of Life | Official name |
...
/**
 * Implementation of the Elixir of Life potion.
 * A potion that provides beneficial effects.
 */
public class ElixirofLifePotion extends BasePotion {
    
    public static final String POTION_ID = "elixir_of_life";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public ElixirofLifePotion() {
...
public static final Potion ELIXIROFLIFE = register(
    new ElixirofLifePotion(),
