...
title: 'Chapter 158: Wiggenweld Potion (Heal)'
description: Wiggenweld Potion (Heal) - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Wiggenweld Potion** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Wiggenweld Potion, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Wiggenweld Potion requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Wiggenweld Potion applies the following effects:
...
The Wiggenweld Potion requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Wiggenweld Potion applies comprehensive effects that impact the player's capabilities and status.
...
The Wiggenweld Potion is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Wiggenweld Potion can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Wiggenweld Potion can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Wiggenweld Potion can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Wiggenweld Potion may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Wiggenweld Potion | Official name |
...
/**
 * Implementation of the Wiggenweld Potion potion.
 * A potion that provides beneficial effects.
 */
public class WiggenweldPotionPotion extends BasePotion {
    
    public static final String POTION_ID = "wiggenweld_potion";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public WiggenweldPotionPotion() {
...
public static final Potion WIGGENWELDPOTION = register(
    new WiggenweldPotionPotion(),
