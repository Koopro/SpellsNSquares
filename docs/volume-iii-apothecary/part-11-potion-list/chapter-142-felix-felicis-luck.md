...
title: 'Chapter 142: Felix Felicis (Luck)'
description: Felix Felicis (Luck) - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Felix Felicis** is a Luck potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Felix Felicis, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Felix Felicis requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Felix Felicis applies the following effects:
...
The Felix Felicis requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Felix Felicis applies comprehensive effects that impact the player's capabilities and status.
...
The Felix Felicis is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Felix Felicis can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Felix Felicis can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Felix Felicis can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Felix Felicis may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Felix Felicis | Official name |
| **Type** | Luck | Potion classification |
...
/**
 * Implementation of the Felix Felicis potion.
 * A potion that provides beneficial effects.
 */
public class FelixFelicisPotion extends BasePotion {
    
    public static final String POTION_ID = "felix_felicis";
...
public static final Potion FELIXFELICIS = register(
    new FelixFelicisPotion(),
