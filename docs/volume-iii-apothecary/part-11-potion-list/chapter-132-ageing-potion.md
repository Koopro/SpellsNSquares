...
title: 'Chapter 132: Ageing Potion'
description: Ageing Potion - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Ageing Potion** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Ageing Potion, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Ageing Potion requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Ageing Potion applies the following effects:
...
The Ageing Potion requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Ageing Potion applies comprehensive effects that impact the player's capabilities and status.
...
The Ageing Potion is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Ageing Potion can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Ageing Potion can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Ageing Potion can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Ageing Potion may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Ageing Potion | Official name |
...
/**
 * Implementation of the Ageing Potion potion.
 * A potion that provides beneficial effects.
 */
public class AgeingPotionPotion extends BasePotion {
    
    public static final String POTION_ID = "ageing_potion";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public AgeingPotionPotion() {
...
public static final Potion AGEINGPOTION = register(
    new AgeingPotionPotion(),
