...
title: 'Chapter 135: Blood Replenishing Potion'
description: Blood Replenishing Potion - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Blood Replenishing Potion** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Blood Replenishing Potion, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Blood Replenishing Potion requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Blood Replenishing Potion applies the following effects:
...
The Blood Replenishing Potion requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Blood Replenishing Potion applies comprehensive effects that impact the player's capabilities and status.
...
The Blood Replenishing Potion is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Blood Replenishing Potion can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Blood Replenishing Potion can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Blood Replenishing Potion can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Blood Replenishing Potion may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Blood Replenishing Potion | Official name |
...
/**
 * Implementation of the Blood Replenishing Potion potion.
 * A potion that provides beneficial effects.
 */
public class BloodReplenishingPotionPotion extends BasePotion {
    
    public static final String POTION_ID = "blood_replenishing_potion";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public BloodReplenishingPotionPotion() {
...
public static final Potion BLOODREPLENISHINGPOTION = register(
    new BloodReplenishingPotionPotion(),
