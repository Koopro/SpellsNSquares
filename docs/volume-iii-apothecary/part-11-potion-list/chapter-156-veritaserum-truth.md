...
title: 'Chapter 156: Veritaserum (Truth)'
description: Veritaserum (Truth) - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Veritaserum** is a Truth potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Veritaserum, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Veritaserum requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Veritaserum applies the following effects:
...
The Veritaserum requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Veritaserum applies comprehensive effects that impact the player's capabilities and status.
...
The Veritaserum is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Veritaserum can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Veritaserum can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Veritaserum can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Veritaserum may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Veritaserum | Official name |
| **Type** | Truth | Potion classification |
...
/**
 * Implementation of the Veritaserum potion.
 * A potion that provides beneficial effects.
 */
public class VeritaserumPotion extends BasePotion {
    
    public static final String POTION_ID = "veritaserum";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public VeritaserumPotion() {
...
public static final Potion VERITASERUM = register(
    new VeritaserumPotion(),
