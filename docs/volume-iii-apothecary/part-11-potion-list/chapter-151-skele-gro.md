...
title: 'Chapter 151: Skele-Gro'
description: Skele-Gro - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Skele-Gro** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Skele-Gro, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Skele-Gro requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Skele-Gro applies the following effects:
...
The Skele-Gro requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Skele-Gro applies comprehensive effects that impact the player's capabilities and status.
...
The Skele-Gro is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Skele-Gro can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Skele-Gro can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Skele-Gro can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Skele-Gro may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Skele-Gro | Official name |
...
/**
 * Implementation of the Skele-Gro potion.
 * A potion that provides beneficial effects.
 */
public class SkeleGroPotion extends BasePotion {
    
    public static final String POTION_ID = "skele_gro";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public SkeleGroPotion() {
...
public static final Potion SKELEGRO = register(
    new SkeleGroPotion(),
