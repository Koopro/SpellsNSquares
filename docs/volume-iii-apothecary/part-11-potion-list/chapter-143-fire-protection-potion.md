...
title: 'Chapter 143: Fire Protection Potion'
description: Fire Protection Potion - Implementation details and reference
tags:
  - iii apothecary
  - 11 potion list
---
...
The **Fire Protection Potion** is a Utility potion that provides beneficial effects. This potion is essential for various magical purposes and requires careful brewing following specific procedures and ingredient combinations.

This chapter provides complete documentation for implementing the Fire Protection Potion, including its recipe, brewing steps, effects, duration, and all technical specifications needed for integration into the potion brewing system.

## Implementation Details

### Potion Recipe

The Fire Protection Potion requires specific ingredients and brewing procedures to create successfully.
...
When consumed, the Fire Protection Potion applies the following effects:
...
The Fire Protection Potion requires careful attention to detail during the brewing process. Each step must be executed precisely to achieve the desired result.
...
When consumed, the Fire Protection Potion applies comprehensive effects that impact the player's capabilities and status.
...
The Fire Protection Potion is consumed by drinking from a potion bottle. Effects apply immediately upon consumption.
...
**Combat Usage:**
**Combat Application**: The Fire Protection Potion can be used strategically in combat situations.

**Exploration Usage:**
**Exploration Application**: The Fire Protection Potion can aid in exploration and navigation.

**Social Usage:**
**Social Application**: The Fire Protection Potion can be used in social situations.

**Crafting Usage:**
**Crafting Application**: The Fire Protection Potion may be used as an ingredient in advanced crafting recipes.
...
|----------|-------|-------------|
| **Potion Name** | Fire Protection Potion | Official name |
...
/**
 * Implementation of the Fire Protection Potion potion.
 * A potion that provides beneficial effects.
 */
public class FireProtectionPotionPotion extends BasePotion {
    
    public static final String POTION_ID = "fire_protection_potion";
    public static final int BASE_DURATION = 300;
    public static final int BASE_AMPLIFIER = 0;
    
    public FireProtectionPotionPotion() {
...
public static final Potion FIREPROTECTIONPOTION = register(
    new FireProtectionPotionPotion(),
