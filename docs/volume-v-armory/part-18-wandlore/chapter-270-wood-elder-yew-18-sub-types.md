...
title: 'Chapter 270: Wood: Elder - Yew (18 Sub-types)'
description: 'Wood: Elder - Yew (18 Sub-types) - Implementation details and reference'
tags:
  - v armory
  - 18 wandlore
---
...
The **Wood: Elder - Yew** is a Wand that serves important functions in the wizarding world. This item channels magical energy and is Legendary in the wizarding world.

This chapter provides comprehensive documentation for implementing the Wood: Elder - Yew, including its properties, crafting requirements, special abilities, usage mechanics, and all technical specifications needed for integration into the item system.

## Implementation Details

### Item Properties

The Wood: Elder - Yew has specific properties that define its behavior and capabilities.
...
The Wood: Elder - Yew can be obtained through:
...
The Wood: Elder - Yew is used through specific mechanics appropriate to its type.

### Special Abilities

The Wood: Elder - Yew may have special abilities that activate under certain conditions.

### Detailed Item Properties

The Wood: Elder - Yew has comprehensive properties that define its behavior, capabilities, and interactions.
...
**Economic Properties:**
- **Base Value**: Priceless gold
- **Vendor Buy Price**: Not available gold
- **Vendor Sell Price**: Not available gold
- **Rarity**: Legendary
...
The Wood: Elder - Yew can be obtained through various methods depending on its rarity and purpose.
...
**Exploration Usage:**
**Exploration Application**: The Wood: Elder - Yew can aid in exploration.

**Crafting Usage:**
**Crafting Application**: The Wood: Elder - Yew may be used as a crafting ingredient.

**Social Usage:**
**Social Application**: The Wood: Elder - Yew can be used in social situations.
...
The Wood: Elder - Yew can be enchanted with specific enchantments that enhance its properties.
...
/**
 * Implementation of the Wood: Elder - Yew Wand.
 * serves important functions in the wizarding world
 */
public class WoodElderYewItem extends WandItem {
...
public static final Item WOODELDERYEW = register(
    "wood__elder___yew",
    new WoodElderYewItem()
);
```
