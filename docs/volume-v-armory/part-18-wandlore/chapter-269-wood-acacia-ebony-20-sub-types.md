...
title: 'Chapter 269: Wood: Acacia - Ebony (20 Sub-types)'
description: 'Wood: Acacia - Ebony (20 Sub-types) - Implementation details and reference'
tags:
  - v armory
  - 18 wandlore
---
...
The **Wood: Acacia - Ebony** is a Wand that serves important functions in the wizarding world. This item channels magical energy and is Common in the wizarding world.

This chapter provides comprehensive documentation for implementing the Wood: Acacia - Ebony, including its properties, crafting requirements, special abilities, usage mechanics, and all technical specifications needed for integration into the item system.

## Implementation Details

### Item Properties

The Wood: Acacia - Ebony has specific properties that define its behavior and capabilities.
...
The Wood: Acacia - Ebony can be obtained through:
...
The Wood: Acacia - Ebony is used through specific mechanics appropriate to its type.

### Special Abilities

The Wood: Acacia - Ebony may have special abilities that activate under certain conditions.

### Detailed Item Properties

The Wood: Acacia - Ebony has comprehensive properties that define its behavior, capabilities, and interactions.
...
The Wood: Acacia - Ebony can be obtained through various methods depending on its rarity and purpose.
...
**Exploration Usage:**
**Exploration Application**: The Wood: Acacia - Ebony can aid in exploration.

**Crafting Usage:**
**Crafting Application**: The Wood: Acacia - Ebony may be used as a crafting ingredient.

**Social Usage:**
**Social Application**: The Wood: Acacia - Ebony can be used in social situations.
...
The Wood: Acacia - Ebony can be enchanted with specific enchantments that enhance its properties.
...
|----------|-------|-------------|
| **Item Name** | Wood: Acacia - Ebony | Official name |
...
/**
 * Implementation of the Wood: Acacia - Ebony Wand.
 * serves important functions in the wizarding world
 */
public class WoodAcaciaEbonyItem extends WandItem {
...
public static final Item WOODACACIAEBONY = register(
    "wood__acacia___ebony",
    new WoodAcaciaEbonyItem()
);
```
