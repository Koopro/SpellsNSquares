...
title: 'Chapter 280: Core: White River Monster Spine'
description: 'Core: White River Monster Spine - Implementation details and reference'
tags:
  - v armory
  - 18 wandlore
---
...
The **Core: White River Monster Spine** is a Wand that serves important functions in the wizarding world. This item channels magical energy and is Common in the wizarding world.

This chapter provides comprehensive documentation for implementing the Core: White River Monster Spine, including its properties, crafting requirements, special abilities, usage mechanics, and all technical specifications needed for integration into the item system.

## Implementation Details

### Item Properties

The Core: White River Monster Spine has specific properties that define its behavior and capabilities.
...
The Core: White River Monster Spine can be obtained through:

- Crafted at Wand Lathe
- Purchased from Ollivanders
...
The Core: White River Monster Spine is used through specific mechanics appropriate to its type.

### Special Abilities

The Core: White River Monster Spine may have special abilities that activate under certain conditions.

### Detailed Item Properties

The Core: White River Monster Spine has comprehensive properties that define its behavior, capabilities, and interactions.
...
- **Combat Properties**: Spell casting, combat enhancement
- **Utility Properties**: Various utility functions based on item type

### Detailed Crafting and Obtainment

The Core: White River Monster Spine can be obtained through various methods depending on its rarity and purpose.
...
- **Crafting Station**: Wand Lathe
- **Skill Requirement**: 5 level
...
**Combat Usage:**
**Combat Application**: Use wand to cast combat spells and engage in magical duels.

**Exploration Usage:**
**Exploration Application**: The Core: White River Monster Spine can aid in exploration.

**Crafting Usage:**
**Crafting Application**: The Core: White River Monster Spine may be used as a crafting ingredient.

**Social Usage:**
**Social Application**: The Core: White River Monster Spine can be used in social situations.
...
**Ability Details:**
- **Ability Count**: Multiple (spell-dependent) abilities
...
The Core: White River Monster Spine can be enchanted with specific enchantments that enhance its properties.
...
|----------|-------|-------------|
| **Item Name** | Core: White River Monster Spine | Official name |
| **Item Type** | Wand | Classification |
| **Rarity** | Common | Item rarity level |
| **Durability** | 1000 | Maximum uses |
...
/**
 * Implementation of the Core: White River Monster Spine Wand.
 * serves important functions in the wizarding world
 */
public class CoreWhiteRiverMonsterSpineItem extends WandItem {
    ...
    public CoreWhiteRiverMonsterSpineItem() {
        super(PROPERTIES);
    }
    ...
    @Override
    public void castSpell(ItemStack wand, Player player, Spell spell) {
        // Wand-specific spell casting logic
    }
}
```
...
public static final Item COREWHITERIVERMONSTERSPINE = register(
    "core__white_river_monster_spine",
    new CoreWhiteRiverMonsterSpineItem()
);
```
