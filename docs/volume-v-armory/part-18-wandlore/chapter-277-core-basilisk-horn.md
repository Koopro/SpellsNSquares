...
title: 'Chapter 277: Core: Basilisk Horn'
description: 'Core: Basilisk Horn - Implementation details and reference'
tags:
  - v armory
  - 18 wandlore
---
...
The **Core: Basilisk Horn** is a Wand that serves important functions in the wizarding world. This item channels magical energy and is Common in the wizarding world.

This chapter provides comprehensive documentation for implementing the Core: Basilisk Horn, including its properties, crafting requirements, special abilities, usage mechanics, and all technical specifications needed for integration into the item system.

## Implementation Details

### Item Properties

The Core: Basilisk Horn has specific properties that define its behavior and capabilities.
...
The Core: Basilisk Horn can be obtained through:
...
The Core: Basilisk Horn is used through specific mechanics appropriate to its type.

### Special Abilities

The Core: Basilisk Horn may have special abilities that activate under certain conditions.

### Detailed Item Properties

The Core: Basilisk Horn has comprehensive properties that define its behavior, capabilities, and interactions.
...
The Core: Basilisk Horn can be obtained through various methods depending on its rarity and purpose.
...
**Exploration Usage:**
**Exploration Application**: The Core: Basilisk Horn can aid in exploration.

**Crafting Usage:**
**Crafting Application**: The Core: Basilisk Horn may be used as a crafting ingredient.

**Social Usage:**
**Social Application**: The Core: Basilisk Horn can be used in social situations.
...
The Core: Basilisk Horn can be enchanted with specific enchantments that enhance its properties.
...
|----------|-------|-------------|
| **Item Name** | Core: Basilisk Horn | Official name |
...
/**
 * Implementation of the Core: Basilisk Horn Wand.
 * serves important functions in the wizarding world
 */
public class CoreBasiliskHornItem extends WandItem {
...
public static final Item COREBASILISKHORN = register(
    "core__basilisk_horn",
    new CoreBasiliskHornItem()
);
```
