...
title: 'Chapter 286: Cleansweep Series'
description: Cleansweep Series - Implementation details and reference
tags:
  - v armory
  - 19 brooms
---
...
The **Cleansweep Series** is a Broom that serves important functions in the wizarding world. This item enables flight and is Common in the wizarding world.

This chapter provides comprehensive documentation for implementing the Cleansweep Series, including its properties, crafting requirements, special abilities, usage mechanics, and all technical specifications needed for integration into the item system.

## Implementation Details

### Item Properties

The Cleansweep Series has specific properties that define its behavior and capabilities.
...
The Cleansweep Series can be obtained through:
...
The Cleansweep Series is used through specific mechanics appropriate to its type.

### Special Abilities

The Cleansweep Series may have special abilities that activate under certain conditions.

### Detailed Item Properties

The Cleansweep Series has comprehensive properties that define its behavior, capabilities, and interactions.
...
The Cleansweep Series can be obtained through various methods depending on its rarity and purpose.
...
**Combat Usage:**
**Combat Application**: The Cleansweep Series can be used in combat situations.

**Exploration Usage:**
**Exploration Application**: Use broom to fly and explore areas quickly.

**Crafting Usage:**
**Crafting Application**: The Cleansweep Series may be used as a crafting ingredient.

**Social Usage:**
**Social Application**: The Cleansweep Series can be used in social situations.
...
The Cleansweep Series can be enchanted with specific enchantments that enhance its properties.
...
|----------|-------|-------------|
| **Item Name** | Cleansweep Series | Official name |
...
/**
 * Implementation of the Cleansweep Series Broom.
 * serves important functions in the wizarding world
 */
public class CleansweepSeriesItem extends BroomItem {
...
public static final Item CLEANSWEEPSERIES = register(
    "cleansweep_series",
    new CleansweepSeriesItem()
);
```
