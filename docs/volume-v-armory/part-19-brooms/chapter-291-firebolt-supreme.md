...
title: 'Chapter 291: Firebolt Supreme'
description: Firebolt Supreme - Implementation details and reference
tags:
  - v armory
  - 19 brooms
---
...
The **Firebolt Supreme** is a Broom that serves important functions in the wizarding world. This item enables flight and is Rare in the wizarding world.

This chapter provides comprehensive documentation for implementing the Firebolt Supreme, including its properties, crafting requirements, special abilities, usage mechanics, and all technical specifications needed for integration into the item system.

## Implementation Details

### Item Properties

The Firebolt Supreme has specific properties that define its behavior and capabilities.
...
The Firebolt Supreme can be obtained through:
...
The Firebolt Supreme is used through specific mechanics appropriate to its type.

### Special Abilities

The Firebolt Supreme may have special abilities that activate under certain conditions.

### Detailed Item Properties

The Firebolt Supreme has comprehensive properties that define its behavior, capabilities, and interactions.
...
**Economic Properties:**
- **Base Value**: 1000+ Galleons gold
- **Vendor Buy Price**: 1000+ Galleons gold
- **Vendor Sell Price**: 1000+ Galleons Galleons gold
- **Rarity**: Rare
...
The Firebolt Supreme can be obtained through various methods depending on its rarity and purpose.
...
**Combat Usage:**
**Combat Application**: The Firebolt Supreme can be used in combat situations.

**Exploration Usage:**
**Exploration Application**: Use broom to fly and explore areas quickly.

**Crafting Usage:**
**Crafting Application**: The Firebolt Supreme may be used as a crafting ingredient.

**Social Usage:**
**Social Application**: The Firebolt Supreme can be used in social situations.
...
The Firebolt Supreme can be enchanted with specific enchantments that enhance its properties.
...
/**
 * Implementation of the Firebolt Supreme Broom.
 * serves important functions in the wizarding world
 */
public class FireboltSupremeItem extends BroomItem {
...
public static final Item FIREBOLTSUPREME = register(
    "firebolt_supreme",
    new FireboltSupremeItem()
);
```
