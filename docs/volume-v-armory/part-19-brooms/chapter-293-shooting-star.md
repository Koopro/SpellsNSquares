...
title: 'Chapter 293: Shooting Star'
description: Shooting Star - Implementation details and reference
tags:
  - v armory
  - 19 brooms
---
...
The **Shooting Star** is a Broom that serves important functions in the wizarding world. This item enables flight and is Common in the wizarding world.

This chapter provides comprehensive documentation for implementing the Shooting Star, including its properties, crafting requirements, special abilities, usage mechanics, and all technical specifications needed for integration into the item system.

## Implementation Details

### Item Properties

The Shooting Star has specific properties that define its behavior and capabilities.
...
The Shooting Star can be obtained through:
...
The Shooting Star is used through specific mechanics appropriate to its type.

### Special Abilities

The Shooting Star may have special abilities that activate under certain conditions.

### Detailed Item Properties

The Shooting Star has comprehensive properties that define its behavior, capabilities, and interactions.
...
The Shooting Star can be obtained through various methods depending on its rarity and purpose.
...
**Combat Usage:**
**Combat Application**: The Shooting Star can be used in combat situations.

**Exploration Usage:**
**Exploration Application**: Use broom to fly and explore areas quickly.

**Crafting Usage:**
**Crafting Application**: The Shooting Star may be used as a crafting ingredient.

**Social Usage:**
**Social Application**: The Shooting Star can be used in social situations.
...
The Shooting Star can be enchanted with specific enchantments that enhance its properties.
...
|----------|-------|-------------|
| **Item Name** | Shooting Star | Official name |
...
/**
 * Implementation of the Shooting Star Broom.
 * serves important functions in the wizarding world
 */
public class ShootingStarItem extends BroomItem {
...
public static final Item SHOOTINGSTAR = register(
    "shooting_star",
    new ShootingStarItem()
);
```
