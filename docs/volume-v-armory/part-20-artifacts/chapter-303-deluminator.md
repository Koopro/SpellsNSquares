...
title: 'Chapter 303: Deluminator'
description: Deluminator - Implementation details and reference
tags:
  - v armory
  - 20 artifacts
---
...
The **Deluminator** is a Artifact that serves important functions in the wizarding world. This item provides powerful abilities and is Common in the wizarding world.

This chapter provides comprehensive documentation for implementing the Deluminator, including its properties, crafting requirements, special abilities, usage mechanics, and all technical specifications needed for integration into the item system.

## Implementation Details

### Item Properties

The Deluminator has specific properties that define its behavior and capabilities.
...
The Deluminator can be obtained through:
...
The Deluminator is used through specific mechanics appropriate to its type.

### Special Abilities

The Deluminator may have special abilities that activate under certain conditions.

### Detailed Item Properties

The Deluminator has comprehensive properties that define its behavior, capabilities, and interactions.
...
The Deluminator can be obtained through various methods depending on its rarity and purpose.
...
**Combat Usage:**
**Combat Application**: The Deluminator can be used in combat situations.

**Exploration Usage:**
**Exploration Application**: The Deluminator can aid in exploration.

**Crafting Usage:**
**Crafting Application**: The Deluminator may be used as a crafting ingredient.

**Social Usage:**
**Social Application**: The Deluminator can be used in social situations.
...
The Deluminator can be enchanted with specific enchantments that enhance its properties.
...
|----------|-------|-------------|
| **Item Name** | Deluminator | Official name |
...
/**
 * Implementation of the Deluminator Artifact.
...
public static final Item DELUMINATOR = register(
    "deluminator",
    new DeluminatorItem()
);
```
