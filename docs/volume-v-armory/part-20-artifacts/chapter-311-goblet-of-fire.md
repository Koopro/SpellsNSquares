...
title: 'Chapter 311: Goblet of Fire'
description: Goblet of Fire - Implementation details and reference
tags:
  - v armory
  - 20 artifacts
---
...
The **Goblet of Fire** is a Artifact that serves important functions in the wizarding world. This item provides powerful abilities and is Common in the wizarding world.

This chapter provides comprehensive documentation for implementing the Goblet of Fire, including its properties, crafting requirements, special abilities, usage mechanics, and all technical specifications needed for integration into the item system.

## Implementation Details

### Item Properties

The Goblet of Fire has specific properties that define its behavior and capabilities.
...
The Goblet of Fire can be obtained through:
...
The Goblet of Fire is used through specific mechanics appropriate to its type.

### Special Abilities

The Goblet of Fire may have special abilities that activate under certain conditions.

### Detailed Item Properties

The Goblet of Fire has comprehensive properties that define its behavior, capabilities, and interactions.
...
The Goblet of Fire can be obtained through various methods depending on its rarity and purpose.
...
**Combat Usage:**
**Combat Application**: The Goblet of Fire can be used in combat situations.

**Exploration Usage:**
**Exploration Application**: The Goblet of Fire can aid in exploration.

**Crafting Usage:**
**Crafting Application**: The Goblet of Fire may be used as a crafting ingredient.

**Social Usage:**
**Social Application**: The Goblet of Fire can be used in social situations.
...
The Goblet of Fire can be enchanted with specific enchantments that enhance its properties.
...
|----------|-------|-------------|
| **Item Name** | Goblet of Fire | Official name |
...
/**
 * Implementation of the Goblet of Fire Artifact.
 * serves important functions in the wizarding world
 */
public class GobletofFireItem extends Item {
...
public static final Item GOBLETOFFIRE = register(
    "goblet_of_fire",
    new GobletofFireItem()
);
```
