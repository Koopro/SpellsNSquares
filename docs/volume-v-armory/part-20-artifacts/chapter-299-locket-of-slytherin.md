...
title: 'Chapter 299: Locket of Slytherin'
description: Locket of Slytherin - Implementation details and reference
tags:
  - v armory
  - 20 artifacts
---
...
The **Locket of Slytherin** is a Artifact that serves important functions in the wizarding world. This item provides powerful abilities and is Common in the wizarding world.

This chapter provides comprehensive documentation for implementing the Locket of Slytherin, including its properties, crafting requirements, special abilities, usage mechanics, and all technical specifications needed for integration into the item system.

## Implementation Details

### Item Properties

The Locket of Slytherin has specific properties that define its behavior and capabilities.
...
The Locket of Slytherin can be obtained through:
...
The Locket of Slytherin is used through specific mechanics appropriate to its type.

### Special Abilities

The Locket of Slytherin may have special abilities that activate under certain conditions.

### Detailed Item Properties

The Locket of Slytherin has comprehensive properties that define its behavior, capabilities, and interactions.
...
The Locket of Slytherin can be obtained through various methods depending on its rarity and purpose.
...
**Combat Usage:**
**Combat Application**: The Locket of Slytherin can be used in combat situations.

**Exploration Usage:**
**Exploration Application**: The Locket of Slytherin can aid in exploration.

**Crafting Usage:**
**Crafting Application**: The Locket of Slytherin may be used as a crafting ingredient.

**Social Usage:**
**Social Application**: The Locket of Slytherin can be used in social situations.
...
The Locket of Slytherin can be enchanted with specific enchantments that enhance its properties.
...
|----------|-------|-------------|
| **Item Name** | Locket of Slytherin | Official name |
...
/**
 * Implementation of the Locket of Slytherin Artifact.
 * serves important functions in the wizarding world
 */
public class LocketofSlytherinItem extends Item {
...
public static final Item LOCKETOFSLYTHERIN = register(
    "locket_of_slytherin",
    new LocketofSlytherinItem()
);
```
