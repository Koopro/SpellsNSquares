...
title: 'Chapter 308: Portkey'
description: Portkey - Implementation details and reference
tags:
  - v armory
  - 20 artifacts
---
...
The **Portkey** is a Artifact that serves important functions in the wizarding world. This item provides powerful abilities and is Common in the wizarding world.

This chapter provides comprehensive documentation for implementing the Portkey, including its properties, crafting requirements, special abilities, usage mechanics, and all technical specifications needed for integration into the item system.

## Implementation Details

### Item Properties

The Portkey has specific properties that define its behavior and capabilities.
...
The Portkey can be obtained through:
...
The Portkey is used through specific mechanics appropriate to its type.

### Special Abilities

The Portkey may have special abilities that activate under certain conditions.

### Detailed Item Properties

The Portkey has comprehensive properties that define its behavior, capabilities, and interactions.
...
The Portkey can be obtained through various methods depending on its rarity and purpose.
...
**Combat Usage:**
**Combat Application**: The Portkey can be used in combat situations.

**Exploration Usage:**
**Exploration Application**: The Portkey can aid in exploration.

**Crafting Usage:**
**Crafting Application**: The Portkey may be used as a crafting ingredient.

**Social Usage:**
**Social Application**: The Portkey can be used in social situations.
...
The Portkey can be enchanted with specific enchantments that enhance its properties.
...
|----------|-------|-------------|
| **Item Name** | Portkey | Official name |
...
/**
 * Implementation of the Portkey Artifact.
...
public static final Item PORTKEY = register(
    "portkey",
    new PortkeyItem()
);
```
