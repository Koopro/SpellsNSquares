...
title: 'Chapter 297: Sword of Gryffindor'
description: Sword of Gryffindor - Implementation details and reference
tags:
  - v armory
  - 20 artifacts
---
...
The **Sword of Gryffindor** is a Artifact that serves important functions in the wizarding world. This item provides powerful abilities and is Common in the wizarding world.

This chapter provides comprehensive documentation for implementing the Sword of Gryffindor, including its properties, crafting requirements, special abilities, usage mechanics, and all technical specifications needed for integration into the item system.

## Implementation Details

### Item Properties

The Sword of Gryffindor has specific properties that define its behavior and capabilities.
...
The Sword of Gryffindor can be obtained through:
...
The Sword of Gryffindor is used through specific mechanics appropriate to its type.

### Special Abilities

The Sword of Gryffindor may have special abilities that activate under certain conditions.

### Detailed Item Properties

The Sword of Gryffindor has comprehensive properties that define its behavior, capabilities, and interactions.
...
The Sword of Gryffindor can be obtained through various methods depending on its rarity and purpose.
...
**Combat Usage:**
**Combat Application**: The Sword of Gryffindor can be used in combat situations.

**Exploration Usage:**
**Exploration Application**: The Sword of Gryffindor can aid in exploration.

**Crafting Usage:**
**Crafting Application**: The Sword of Gryffindor may be used as a crafting ingredient.

**Social Usage:**
**Social Application**: The Sword of Gryffindor can be used in social situations.
...
The Sword of Gryffindor can be enchanted with specific enchantments that enhance its properties.
...
|----------|-------|-------------|
| **Item Name** | Sword of Gryffindor | Official name |
...
/**
 * Implementation of the Sword of Gryffindor Artifact.
 * serves important functions in the wizarding world
 */
public class SwordofGryffindorItem extends Item {
...
public static final Item SWORDOFGRYFFINDOR = register(
    "sword_of_gryffindor",
    new SwordofGryffindorItem()
);
```
