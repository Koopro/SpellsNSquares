...
title: 'Chapter 126: Ancient Magic: Slam'
description: 'Ancient Magic: Slam - Implementation details and reference'
tags:
  - ii grimoire
  - 9 ancient magic
---
...
The **Ancient Magic: Slam** spell is a fundamental component of the wizarding combat and utility system. This spell allows players to perform magical effects. Understanding its mechanics, requirements, and implementation is essential for creating an authentic magical experience.

This chapter provides comprehensive technical documentation for implementing Ancient Magic: Slam, including spell casting mechanics, wand movements, incantation requirements, mana consumption, cooldown systems, and integration with the broader spell framework.

## Implementation Details

### Spell Casting Mechanics

The Ancient Magic: Slam spell is cast through a combination of wand movement, incantation, and magical energy channeling. The implementation requires careful coordination between the client-side input system and server-side validation.
...
The Ancient Magic: Slam spell requires a specific wand movement pattern: "Point wand at target". This pattern must be executed correctly for the spell to activate. The pattern is tracked using gesture recognition algorithms that analyze the player's wand trajectory in 3D space.

**Incantation:**
The verbal component "Ancient Magic: Slam" must be spoken (or activated via keybind) during the casting window. The incantation timing is synchronized with the wand movement for optimal spell power.

### Spell Effects

The Ancient Magic: Slam spell produces specific magical effects when successfully cast.
...
The Ancient Magic: Slam spell generates distinctive visual effects that enhance player feedback and immersion:
...
- **Incantation Voice Line**: "Ancient Magic: Slam" spoken by player character
...
|----------|-------|-------------|
| **Spell Name** | Ancient Magic: Slam | Official name of the spell |
| **Incantation** | "Ancient Magic: Slam" | Verbal component required |
...
/**
 * Implementation of the Ancient Magic: Slam spell.
 * This spell allows wizards to perform magical effects.
 */
public class AncientMagicSlamSpell extends BaseSpell {
    
    public static final String SPELL_ID = "ancient_magic__slam";
    public static final String INCANTATION = "Ancient Magic: Slam";
    public static final int BASE_MANA_COST = 20;
    public static final int BASE_COOLDOWN = 5;
    public static final double BASE_RANGE = 20;
    
    public AncientMagicSlamSpell() {
...
applySpellEffect(caster, target, targetPos);
        ...
        level.playSound(null, caster.getPosition(), 
            SoundRegistry.ANCIENTMAGICSLAM_CAST.get(), 
    ...
    ParticleType.ANCIENT_MAGIC__SLAM);
    }
...
public static final Spell ANCIENTMAGICSLAM = register(
    new AncientMagicSlamSpell(),
