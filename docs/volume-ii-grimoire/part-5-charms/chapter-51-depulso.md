---
sidebar_position: 51
title: 'Chapter 51: Depulso (Knockback Physics)'
description: Depulso (Knockback Physics) - Implementation details and reference
tags:
  - ii grimoire
  - 5 charms
---
...
The **Depulso** spell is a fundamental component of the wizarding combat and utility system. This spell allows players to perform magical effects. Understanding its mechanics, requirements, and implementation is essential for creating an authentic magical experience.

This chapter provides comprehensive technical documentation for implementing Depulso, including spell casting mechanics, wand movements, incantation requirements, mana consumption, cooldown systems, and integration with the broader spell framework.

## Implementation Details

### Spell Casting Mechanics

The Depulso spell is cast through a combination of wand movement, incantation, and magical energy channeling. The implementation requires careful coordination between the client-side input system and server-side validation.
...
The Depulso spell requires a specific wand movement pattern: "Point wand at target". This pattern must be executed correctly for the spell to activate. The pattern is tracked using gesture recognition algorithms that analyze the player's wand trajectory in 3D space.

**Incantation:**
The verbal component "Depulso" must be spoken (or activated via keybind) during the casting window. The incantation timing is synchronized with the wand movement for optimal spell power.

### Spell Effects

The Depulso spell produces specific magical effects when successfully cast.
...
The Depulso spell generates distinctive visual effects that enhance player feedback and immersion:
...
- **Incantation Voice Line**: "Depulso" spoken by player character
...
|----------|-------|-------------|
| **Spell Name** | Depulso | Official name of the spell |
| **Incantation** | "Depulso" | Verbal component required |
...
/**
 * Implementation of the Depulso spell.
 * This spell allows wizards to perform magical effects.
 */
public class DepulsoSpell extends BaseSpell {
    
    public static final String SPELL_ID = "depulso";
    public static final String INCANTATION = "Depulso";
...
applySpellEffect(caster, target, targetPos);
        ...
        level.playSound(null, caster.getPosition(), 
            SoundRegistry.DEPULSO_CAST.get(), 
...
public static final Spell DEPULSO = register(
    new DepulsoSpell(),
