---
sidebar_position: 71
title: 'Chapter 71: Reducio (Shrink Entity)'
description: Reducio (Shrink Entity) - Implementation details and reference
tags:
  - ii grimoire
  - 5 charms
---
...
The **Reducio** spell is a fundamental component of the wizarding combat and utility system. This spell allows players to perform magical effects. Understanding its mechanics, requirements, and implementation is essential for creating an authentic magical experience.

This chapter provides comprehensive technical documentation for implementing Reducio, including spell casting mechanics, wand movements, incantation requirements, mana consumption, cooldown systems, and integration with the broader spell framework.

## Implementation Details

### Spell Casting Mechanics

The Reducio spell is cast through a combination of wand movement, incantation, and magical energy channeling. The implementation requires careful coordination between the client-side input system and server-side validation.
...
The Reducio spell requires a specific wand movement pattern: "Point wand at target". This pattern must be executed correctly for the spell to activate. The pattern is tracked using gesture recognition algorithms that analyze the player's wand trajectory in 3D space.

**Incantation:**
The verbal component "Reducio" must be spoken (or activated via keybind) during the casting window. The incantation timing is synchronized with the wand movement for optimal spell power.

### Spell Effects

The Reducio spell produces specific magical effects when successfully cast.
...
The Reducio spell generates distinctive visual effects that enhance player feedback and immersion:
...
- **Incantation Voice Line**: "Reducio" spoken by player character
...
|----------|-------|-------------|
| **Spell Name** | Reducio | Official name of the spell |
| **Incantation** | "Reducio" | Verbal component required |
...
/**
 * Implementation of the Reducio spell.
 * This spell allows wizards to perform magical effects.
 */
public class ReducioSpell extends BaseSpell {
    
    public static final String SPELL_ID = "reducio";
    public static final String INCANTATION = "Reducio";
...
applySpellEffect(caster, target, targetPos);
        ...
        level.playSound(null, caster.getPosition(), 
            SoundRegistry.REDUCIO_CAST.get(), 
...
public static final Spell REDUCIO = register(
    new ReducioSpell(),
