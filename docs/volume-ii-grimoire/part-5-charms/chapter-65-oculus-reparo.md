---
sidebar_position: 65
title: 'Chapter 65: Oculus Reparo (Vision Fix)'
description: Oculus Reparo (Vision Fix) - Implementation details and reference
tags:
  - ii grimoire
  - 5 charms
---
...
The **Oculus Reparo** spell is a fundamental component of the wizarding combat and utility system. This spell allows players to repairs broken objects. Understanding its mechanics, requirements, and implementation is essential for creating an authentic magical experience.

This chapter provides comprehensive technical documentation for implementing Oculus Reparo, including spell casting mechanics, wand movements, incantation requirements, mana consumption, cooldown systems, and integration with the broader spell framework.

## Implementation Details

### Spell Casting Mechanics

The Oculus Reparo spell is cast through a combination of wand movement, incantation, and magical energy channeling. The implementation requires careful coordination between the client-side input system and server-side validation.
...
The Oculus Reparo spell requires a specific wand movement pattern: "Tap object". This pattern must be executed correctly for the spell to activate. The pattern is tracked using gesture recognition algorithms that analyze the player's wand trajectory in 3D space.

**Incantation:**
The verbal component "Reparo" must be spoken (or activated via keybind) during the casting window. The incantation timing is synchronized with the wand movement for optimal spell power.

### Spell Effects

The Oculus Reparo spell produces specific magical effects when successfully cast.

**Canonical Effect:** Repairs broken objects

**Spell Type:** Mending Charm

**Etymology:** Latin "reparo" meaning "I repair"
...
The Oculus Reparo spell generates distinctive visual effects that enhance player feedback and immersion:
...
- **Incantation Voice Line**: "Reparo" spoken by player character
...
|----------|-------|-------------|
| **Spell Name** | Oculus Reparo | Official name of the spell |
| **Incantation** | "Reparo" | Verbal component required |
...
/**
 * Implementation of the Oculus Reparo spell.
 * This spell allows wizards to repairs broken objects.
 */
public class OculusReparoSpell extends BaseSpell {
    
    public static final String SPELL_ID = "oculus_reparo";
    public static final String INCANTATION = "Reparo";
    public static final int BASE_MANA_COST = 20;
    public static final int BASE_COOLDOWN = 5;
    public static final double BASE_RANGE = 20;
    
    public OculusReparoSpell() {
...
applySpellEffect(caster, target, targetPos);
        ...
        level.playSound(null, caster.getPosition(), 
            SoundRegistry.OCULUSREPARO_CAST.get(), 
...
public static final Spell OCULUSREPARO = register(
    new OculusReparoSpell(),
