---
sidebar_position: 63
title: 'Chapter 63: Lumos Solem (Sunlight Dmg)'
description: Lumos Solem (Sunlight Dmg) - Implementation details and reference
tags:
  - ii grimoire
  - 5 charms
---
...
The **Lumos Solem** spell is a fundamental component of the wizarding combat and utility system. This spell allows players to perform magical effects. Understanding its mechanics, requirements, and implementation is essential for creating an authentic magical experience.

This chapter provides comprehensive technical documentation for implementing Lumos Solem, including spell casting mechanics, wand movements, incantation requirements, mana consumption, cooldown systems, and integration with the broader spell framework.

## Implementation Details

### Spell Casting Mechanics

The Lumos Solem spell is cast through a combination of wand movement, incantation, and magical energy channeling. The implementation requires careful coordination between the client-side input system and server-side validation.
...
The Lumos Solem spell requires a specific wand movement pattern: "Point wand at target". This pattern must be executed correctly for the spell to activate. The pattern is tracked using gesture recognition algorithms that analyze the player's wand trajectory in 3D space.

**Incantation:**
The verbal component "Lumos Solem" must be spoken (or activated via keybind) during the casting window. The incantation timing is synchronized with the wand movement for optimal spell power.

### Spell Effects

The Lumos Solem spell produces specific magical effects when successfully cast.
...
The Lumos Solem spell generates distinctive visual effects that enhance player feedback and immersion:
...
- **Incantation Voice Line**: "Lumos Solem" spoken by player character
...
|----------|-------|-------------|
| **Spell Name** | Lumos Solem | Official name of the spell |
| **Incantation** | "Lumos Solem" | Verbal component required |
...
/**
 * Implementation of the Lumos Solem spell.
 * This spell allows wizards to perform magical effects.
 */
public class LumosSolemSpell extends BaseSpell {
    
    public static final String SPELL_ID = "lumos_solem";
    public static final String INCANTATION = "Lumos Solem";
    public static final int BASE_MANA_COST = 5;
    public static final int BASE_COOLDOWN = 1;
    public static final double BASE_RANGE = 10;
    
    public LumosSolemSpell() {
...
applySpellEffect(caster, target, targetPos);
        ...
        level.playSound(null, caster.getPosition(), 
            SoundRegistry.LUMOSSOLEM_CAST.get(), 
...
public static final Spell LUMOSSOLEM = register(
    new LumosSolemSpell(),
