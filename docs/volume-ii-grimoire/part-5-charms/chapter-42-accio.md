---
sidebar_position: 42
title: 'Chapter 42: Accio (Physics Pull)'
description: Accio (Physics Pull) - Implementation details and reference
tags:
  - ii grimoire
  - 5 charms
---
...
The **Accio** spell is a fundamental component of the wizarding combat and utility system. This spell allows players to summon objects from a distance. Understanding its mechanics, requirements, and implementation is essential for creating an authentic magical experience.

This chapter provides comprehensive technical documentation for implementing Accio, including spell casting mechanics, wand movements, incantation requirements, mana consumption, cooldown systems, and integration with the broader spell framework.
...
Spell class exists but not registered in ModSpells.java

## Implementation Details

### Spell Casting Mechanics

The Accio spell is cast through a combination of wand movement, incantation, and magical energy channeling. The implementation requires careful coordination between the client-side input system and server-side validation.
...
The Accio spell requires a specific wand movement pattern: "Point wand at target". This pattern must be executed correctly for the spell to activate. The pattern is tracked using gesture recognition algorithms that analyze the player's wand trajectory in 3D space.

**Incantation:**
The verbal component "Accio" must be spoken (or activated via keybind) during the casting window. The incantation timing is synchronized with the wand movement for optimal spell power.

### Spell Effects

The Accio spell produces specific magical effects when successfully cast.
...
The Accio spell generates distinctive visual effects that enhance player feedback and immersion:
...
- **Incantation Voice Line**: "Accio" spoken by player character
...
|----------|-------|-------------|
| **Spell Name** | Accio | Official name of the spell |
| **Incantation** | "Accio" | Verbal component required |
...
/**
 * Implementation of the Accio spell.
 * This spell allows wizards to summon objects from a distance.
 */
public class AccioSpell extends BaseSpell {
    
    public static final String SPELL_ID = "accio";
    public static final String INCANTATION = "Accio";
...
public static final Spell ACCIO = register(
    new AccioSpell(),
