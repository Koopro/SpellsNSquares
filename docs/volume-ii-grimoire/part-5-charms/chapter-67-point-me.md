---
sidebar_position: 67
title: 'Chapter 67: Point Me (Compass UI)'
description: Point Me (Compass UI) - Implementation details and reference
tags:
  - ii grimoire
  - 5 charms
---
...
The **Point Me** spell is a fundamental component of the wizarding combat and utility system. This spell allows players to perform magical effects. Understanding its mechanics, requirements, and implementation is essential for creating an authentic magical experience.

This chapter provides comprehensive technical documentation for implementing Point Me, including spell casting mechanics, wand movements, incantation requirements, mana consumption, cooldown systems, and integration with the broader spell framework.

## Implementation Details

### Spell Casting Mechanics

The Point Me spell is cast through a combination of wand movement, incantation, and magical energy channeling. The implementation requires careful coordination between the client-side input system and server-side validation.
...
The Point Me spell requires a specific wand movement pattern: "Point wand at target". This pattern must be executed correctly for the spell to activate. The pattern is tracked using gesture recognition algorithms that analyze the player's wand trajectory in 3D space.

**Incantation:**
The verbal component "Point Me" must be spoken (or activated via keybind) during the casting window. The incantation timing is synchronized with the wand movement for optimal spell power.

### Spell Effects

The Point Me spell produces specific magical effects when successfully cast.
...
The Point Me spell generates distinctive visual effects that enhance player feedback and immersion:
...
- **Incantation Voice Line**: "Point Me" spoken by player character
...
|----------|-------|-------------|
| **Spell Name** | Point Me | Official name of the spell |
| **Incantation** | "Point Me" | Verbal component required |
...
/**
 * Implementation of the Point Me spell.
 * This spell allows wizards to perform magical effects.
 */
public class PointMeSpell extends BaseSpell {
    
    public static final String SPELL_ID = "point_me";
    public static final String INCANTATION = "Point Me";
...
applySpellEffect(caster, target, targetPos);
        ...
        level.playSound(null, caster.getPosition(), 
            SoundRegistry.POINTME_CAST.get(), 
...
public static final Spell POINTME = register(
    new PointMeSpell(),
