---
sidebar_position: 60
title: 'Chapter 60: Incendio Duo'
description: Incendio Duo - Implementation details and reference
tags:
  - ii grimoire
  - 5 charms
---
...
The **Incendio Duo** spell is a fundamental component of the wizarding combat and utility system. This spell allows players to creates fire. Understanding its mechanics, requirements, and implementation is essential for creating an authentic magical experience.

This chapter provides comprehensive technical documentation for implementing Incendio Duo, including spell casting mechanics, wand movements, incantation requirements, mana consumption, cooldown systems, and integration with the broader spell framework.

## Implementation Details

### Spell Casting Mechanics

The Incendio Duo spell is cast through a combination of wand movement, incantation, and magical energy channeling. The implementation requires careful coordination between the client-side input system and server-side validation.
...
The Incendio Duo spell requires a specific wand movement pattern: "Jab wand forward". This pattern must be executed correctly for the spell to activate. The pattern is tracked using gesture recognition algorithms that analyze the player's wand trajectory in 3D space.

**Incantation:**
The verbal component "Incendio" must be spoken (or activated via keybind) during the casting window. The incantation timing is synchronized with the wand movement for optimal spell power.

### Spell Effects

The Incendio Duo spell produces specific magical effects when successfully cast.

**Canonical Effect:** Creates fire

**Spell Type:** Fire-Making Spell

**Etymology:** Latin "incendium" meaning "fire"
...
The Incendio Duo spell generates distinctive visual effects that enhance player feedback and immersion:

- **Casting Particles**: Orange/Red glowing particles emanate from the wand tip during casting
- **Impact Particles**: Orange/Red particle burst on successful impact
- **Trail Effects**: Magical trail follows the spell effect to target

### Sound Design

Audio feedback is crucial for spell casting:
- **Incantation Voice Line**: "Incendio" spoken by player character
...
|----------|-------|-------------|
| **Spell Name** | Incendio Duo | Official name of the spell |
| **Incantation** | "Incendio" | Verbal component required |
| **Mana Cost** | 30 | Base mana consumption per cast |
...
|-------|-----------|----------|-------------|------------------|
| **Novice** | 30 | 5 | 100% | Initial learning |
| **Apprentice** | 27.0 | 4.5 | 125% | 50 successful casts |
| **Adept** | 24.0 | 4.0 | 150% | 200 successful casts |
| **Expert** | 21.0 | 3.5 | 175% | 500 successful casts |
| **Master** | 18.0 | 3.0 | 200% | 1000 successful casts |
...
/**
 * Implementation of the Incendio Duo spell.
 * This spell allows wizards to creates fire.
 */
public class IncendioDuoSpell extends BaseSpell {
    
    public static final String SPELL_ID = "incendio_duo";
    public static final String INCANTATION = "Incendio";
    public static final int BASE_MANA_COST = 30;
    public static final int BASE_COOLDOWN = 5;
    public static final double BASE_RANGE = 20;
    
    public IncendioDuoSpell() {
...
applySpellEffect(caster, target, targetPos);
        ...
        level.playSound(null, caster.getPosition(), 
            SoundRegistry.INCENDIODUO_CAST.get(), 
...
public static final Spell INCENDIODUO = register(
    new IncendioDuoSpell(),
