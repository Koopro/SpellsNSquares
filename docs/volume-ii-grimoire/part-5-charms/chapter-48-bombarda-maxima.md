---
sidebar_position: 48
title: 'Chapter 48: Bombarda Maxima'
description: Bombarda Maxima - Implementation details and reference
tags:
  - ii grimoire
  - 5 charms
---
...
The **Bombarda Maxima** spell is a fundamental component of the wizarding combat and utility system. This spell allows players to causes explosion. Understanding its mechanics, requirements, and implementation is essential for creating an authentic magical experience.

This chapter provides comprehensive technical documentation for implementing Bombarda Maxima, including spell casting mechanics, wand movements, incantation requirements, mana consumption, cooldown systems, and integration with the broader spell framework.

## Implementation Details

### Spell Casting Mechanics

The Bombarda Maxima spell is cast through a combination of wand movement, incantation, and magical energy channeling. The implementation requires careful coordination between the client-side input system and server-side validation.
...
The Bombarda Maxima spell requires a specific wand movement pattern: "Jab wand forward". This pattern must be executed correctly for the spell to activate. The pattern is tracked using gesture recognition algorithms that analyze the player's wand trajectory in 3D space.

**Incantation:**
The verbal component "Bombarda" must be spoken (or activated via keybind) during the casting window. The incantation timing is synchronized with the wand movement for optimal spell power.

### Spell Effects

The Bombarda Maxima spell produces specific magical effects when successfully cast.

**Canonical Effect:** Causes explosion

**Spell Type:** Exploding Charm

**Etymology:** Latin "bombus" meaning "explosion"
...
The Bombarda Maxima spell generates distinctive visual effects that enhance player feedback and immersion:

- **Casting Particles**: Orange glowing particles emanate from the wand tip during casting
- **Impact Particles**: Orange particle burst on successful impact
- **Trail Effects**: Magical trail follows the spell effect to target

### Sound Design

Audio feedback is crucial for spell casting:
- **Incantation Voice Line**: "Bombarda" spoken by player character
...
|----------|-------|-------------|
| **Spell Name** | Bombarda Maxima | Official name of the spell |
| **Incantation** | "Bombarda" | Verbal component required |
...
/**
 * Implementation of the Bombarda Maxima spell.
 * This spell allows wizards to causes explosion.
 */
public class BombardaMaximaSpell extends BaseSpell {
    
    public static final String SPELL_ID = "bombarda_maxima";
    public static final String INCANTATION = "Bombarda";
    public static final int BASE_MANA_COST = 20;
    public static final int BASE_COOLDOWN = 5;
    public static final double BASE_RANGE = 20;
    
    public BombardaMaximaSpell() {
...
applySpellEffect(caster, target, targetPos);
        ...
        level.playSound(null, caster.getPosition(), 
            SoundRegistry.BOMBARDAMAXIMA_CAST.get(), 
...
public static final Spell BOMBARDAMAXIMA = register(
    new BombardaMaximaSpell(),
