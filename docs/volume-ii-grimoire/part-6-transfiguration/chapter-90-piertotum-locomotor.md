---
sidebar_position: 90
title: 'Chapter 90: Piertotum Locomotor (Statue AI)'
description: Piertotum Locomotor (Statue AI) - Implementation details and reference
tags:
  - ii grimoire
  - 6 transfiguration
---
...
The **Piertotum Locomotor** spell is a fundamental component of the wizarding combat and utility system. This spell allows players to perform magical effects. Understanding its mechanics, requirements, and implementation is essential for creating an authentic magical experience.

This chapter provides comprehensive technical documentation for implementing Piertotum Locomotor, including spell casting mechanics, wand movements, incantation requirements, mana consumption, cooldown systems, and integration with the broader spell framework.

## Implementation Details

### Spell Casting Mechanics

The Piertotum Locomotor spell is cast through a combination of wand movement, incantation, and magical energy channeling. The implementation requires careful coordination between the client-side input system and server-side validation.
...
The Piertotum Locomotor spell requires a specific wand movement pattern: "Point wand at target". This pattern must be executed correctly for the spell to activate. The pattern is tracked using gesture recognition algorithms that analyze the player's wand trajectory in 3D space.

**Incantation:**
The verbal component "Piertotum Locomotor" must be spoken (or activated via keybind) during the casting window. The incantation timing is synchronized with the wand movement for optimal spell power.

### Spell Effects

The Piertotum Locomotor spell produces specific magical effects when successfully cast.
...
The Piertotum Locomotor spell generates distinctive visual effects that enhance player feedback and immersion:
...
- **Incantation Voice Line**: "Piertotum Locomotor" spoken by player character
...
|----------|-------|-------------|
| **Spell Name** | Piertotum Locomotor | Official name of the spell |
| **Incantation** | "Piertotum Locomotor" | Verbal component required |
...
| **Category** | Transfiguration | Spell classification |
...
| **Skill Prerequisite** | Transfiguration | Required skill level |
...
/**
 * Implementation of the Piertotum Locomotor spell.
 * This spell allows wizards to perform magical effects.
 */
public class PiertotumLocomotorSpell extends BaseSpell {
    
    public static final String SPELL_ID = "piertotum_locomotor";
    public static final String INCANTATION = "Piertotum Locomotor";
    public static final int BASE_MANA_COST = 20;
    public static final int BASE_COOLDOWN = 5;
    public static final double BASE_RANGE = 20;
    
    public PiertotumLocomotorSpell() {
...
applySpellEffect(caster, target, targetPos);
        ...
        level.playSound(null, caster.getPosition(), 
            SoundRegistry.PIERTOTUMLOCOMOTOR_CAST.get(), 
    ...
    ParticleType.PIERTOTUM_LOCOMOTOR);
    }
    
    @Override
    public SpellCategory getCategory() {
        return SpellCategory.TRANSFIGURATION;
    }
...
public static final Spell PIERTOTUMLOCOMOTOR = register(
    new PiertotumLocomotorSpell(),
...
### Skill System
- Contributes to Transfiguration skill progression
