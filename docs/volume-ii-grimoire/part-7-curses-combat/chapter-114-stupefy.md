...
title: 'Chapter 114: Stupefy (Stun/Knockout)'
description: Stupefy (Stun/Knockout) - Implementation details and reference
tags:
  - ii grimoire
  - 7 curses combat
---
...
The **Stupefy** spell is a fundamental component of the wizarding combat and utility system. This spell allows players to stun enemies. Understanding its mechanics, requirements, and implementation is essential for creating an authentic magical experience.

This chapter provides comprehensive technical documentation for implementing Stupefy, including spell casting mechanics, wand movements, incantation requirements, mana consumption, cooldown systems, and integration with the broader spell framework.
...
The Stupefy spell is cast through a combination of wand movement, incantation, and magical energy channeling. The implementation requires careful coordination between the client-side input system and server-side validation.
...
The Stupefy spell requires a specific wand movement pattern: "Point wand at target". This pattern must be executed correctly for the spell to activate. The pattern is tracked using gesture recognition algorithms that analyze the player's wand trajectory in 3D space.

**Incantation:**
The verbal component "Stupefy" must be spoken (or activated via keybind) during the casting window. The incantation timing is synchronized with the wand movement for optimal spell power.

### Spell Effects

The Stupefy spell produces specific magical effects when successfully cast.
...
The Stupefy spell generates distinctive visual effects that enhance player feedback and immersion:
...
- **Incantation Voice Line**: "Stupefy" spoken by player character
...
|----------|-------|-------------|
| **Spell Name** | Stupefy | Official name of the spell |
| **Incantation** | "Stupefy" | Verbal component required |
...
/**
 * Implementation of the Stupefy spell.
 * This spell allows wizards to stun enemies.
 */
public class StupefySpell extends BaseSpell {
    
    public static final String SPELL_ID = "stupefy";
    public static final String INCANTATION = "Stupefy";
...
applySpellEffect(caster, target, targetPos);
        ...
        level.playSound(null, caster.getPosition(), 
            SoundRegistry.STUPEFY_CAST.get(), 
...
public static final Spell STUPEFY = register(
    new StupefySpell(),
