---
sidebar_position: 99
title: 'Chapter 99: Expelliarmus (Item Drop Logic)'
description: Expelliarmus (Item Drop Logic) - Implementation details and reference
tags:
  - ii grimoire
  - 7 curses combat
---
...
The **Expelliarmus** spell is a fundamental component of the wizarding combat and utility system. This spell allows players to disarm opponents. Understanding its mechanics, requirements, and implementation is essential for creating an authentic magical experience.

This chapter provides comprehensive technical documentation for implementing Expelliarmus, including spell casting mechanics, wand movements, incantation requirements, mana consumption, cooldown systems, and integration with the broader spell framework.
...
The Expelliarmus spell is cast through a combination of wand movement, incantation, and magical energy channeling. The implementation requires careful coordination between the client-side input system and server-side validation.
...
The Expelliarmus spell requires a specific wand movement pattern: "Point wand at target". This pattern must be executed correctly for the spell to activate. The pattern is tracked using gesture recognition algorithms that analyze the player's wand trajectory in 3D space.

**Incantation:**
The verbal component "Expelliarmus" must be spoken (or activated via keybind) during the casting window. The incantation timing is synchronized with the wand movement for optimal spell power.

### Spell Effects

The Expelliarmus spell produces specific magical effects when successfully cast.
...
The Expelliarmus spell generates distinctive visual effects that enhance player feedback and immersion:
...
- **Incantation Voice Line**: "Expelliarmus" spoken by player character
...
|----------|-------|-------------|
| **Spell Name** | Expelliarmus | Official name of the spell |
| **Incantation** | "Expelliarmus" | Verbal component required |
| **Mana Cost** | 20 | Base mana consumption per cast |
| **Cooldown** | 5 | Time between casts (seconds) |
| **Range** | 24 | Maximum effective range (blocks) |
| **Casting Time** | 0.5-1.5 | Time to complete cast (seconds) |
| **Difficulty** | Advanced | Learning difficulty level |
| **Category** | Charm | Spell classification |
| **Target Type** | Living Entity | Valid target types |

### Learning Requirements

| Requirement | Value | Description |
|-------------|-------|-------------|
| **Minimum Level** | 5 | Character level required |
...
/**
 * Implementation of the Expelliarmus spell.
 * This spell allows wizards to disarm opponents.
 */
public class ExpelliarmusSpell extends BaseSpell {
    
    public static final String SPELL_ID = "expelliarmus";
    public static final String INCANTATION = "Expelliarmus";
    public static final int BASE_MANA_COST = 20;
    public static final int BASE_COOLDOWN = 5;
    public static final double BASE_RANGE = 24;
...
applySpellEffect(caster, target, targetPos);
        ...
        level.playSound(null, caster.getPosition(), 
            SoundRegistry.EXPELLIARMUS_CAST.get(), 
...
public static final Spell EXPELLIARMUS = register(
