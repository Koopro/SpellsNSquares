...
title: 'Chapter 109: Petrificus Totalus (Stun)'
description: Petrificus Totalus (Stun) - Implementation details and reference
tags:
  - ii grimoire
  - 7 curses combat
---
...
The **Petrificus Totalus** spell is a fundamental component of the wizarding combat and utility system. This spell allows players to perform magical effects. Understanding its mechanics, requirements, and implementation is essential for creating an authentic magical experience.

This chapter provides comprehensive technical documentation for implementing Petrificus Totalus, including spell casting mechanics, wand movements, incantation requirements, mana consumption, cooldown systems, and integration with the broader spell framework.

## Implementation Details

### Spell Casting Mechanics

The Petrificus Totalus spell is cast through a combination of wand movement, incantation, and magical energy channeling. The implementation requires careful coordination between the client-side input system and server-side validation.
...
The Petrificus Totalus spell requires a specific wand movement pattern: "Point wand at target". This pattern must be executed correctly for the spell to activate. The pattern is tracked using gesture recognition algorithms that analyze the player's wand trajectory in 3D space.

**Incantation:**
The verbal component "Petrificus Totalus" must be spoken (or activated via keybind) during the casting window. The incantation timing is synchronized with the wand movement for optimal spell power.

### Spell Effects

The Petrificus Totalus spell produces specific magical effects when successfully cast.
...
The Petrificus Totalus spell generates distinctive visual effects that enhance player feedback and immersion:
...
- **Incantation Voice Line**: "Petrificus Totalus" spoken by player character
...
|----------|-------|-------------|
| **Spell Name** | Petrificus Totalus | Official name of the spell |
| **Incantation** | "Petrificus Totalus" | Verbal component required |
...
/**
 * Implementation of the Petrificus Totalus spell.
 * This spell allows wizards to perform magical effects.
 */
public class PetrificusTotalusSpell extends BaseSpell {
    
    public static final String SPELL_ID = "petrificus_totalus";
    public static final String INCANTATION = "Petrificus Totalus";
...
applySpellEffect(caster, target, targetPos);
        ...
        level.playSound(null, caster.getPosition(), 
            SoundRegistry.PETRIFICUSTOTALUS_CAST.get(), 
    ...
    ParticleType.PETRIFICUS_TOTALUS);
    }
...
public static final Spell PETRIFICUSTOTALUS = register(
    new PetrificusTotalusSpell(),
