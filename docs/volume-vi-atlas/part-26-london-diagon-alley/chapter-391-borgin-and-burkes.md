...
title: 'Chapter 391: Borgin and Burkes'
description: Borgin and Burkes - Implementation details and reference
tags:
  - vi atlas
...
**Borgin and Burkes** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Borgin and Burkes, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Borgin and Burkes is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Borgin and Burkes:
...
Borgin and Burkes features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Borgin and Burkes contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Borgin and Burkes | Official name |
...
/**
 * Structure implementation for Borgin and Burkes.
 * provides important functionality and atmosphere
 */
public class BorginandBurkesStructure extends WizardingLocationStructure {
    
    public static final StructureType<BorginandBurkesStructure> TYPE = StructureType.register(
        "borgin_and_burkes",
        BorginandBurkesStructure::new
    );
    
    public BorginandBurkesStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<BorginandBurkesStructure> BORGINANDBURKES = 
    StructureRegistry.register(
        "borgin_and_burkes",
        BorginandBurkesStructure.TYPE,
