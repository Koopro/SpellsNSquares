...
title: 'Chapter 380: Diagon Alley Street'
description: Diagon Alley Street - Implementation details and reference
tags:
  - vi atlas
...
**Diagon Alley Street** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Diagon Alley Street, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Diagon Alley Street is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Diagon Alley Street:
...
Diagon Alley Street features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Diagon Alley Street contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Diagon Alley Street | Official name |
...
/**
 * Structure implementation for Diagon Alley Street.
 * provides important functionality and atmosphere
 */
public class DiagonAlleyStreetStructure extends WizardingLocationStructure {
    
    public static final StructureType<DiagonAlleyStreetStructure> TYPE = StructureType.register(
        "diagon_alley_street",
        DiagonAlleyStreetStructure::new
    );
    
    public DiagonAlleyStreetStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<DiagonAlleyStreetStructure> DIAGONALLEYSTREET = 
    StructureRegistry.register(
        "diagon_alley_street",
        DiagonAlleyStreetStructure.TYPE,
