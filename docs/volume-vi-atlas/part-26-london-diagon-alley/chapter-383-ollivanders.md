...
title: 'Chapter 383: Ollivanders'
description: Ollivanders - Implementation details and reference
tags:
  - vi atlas
...
**Ollivanders** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Ollivanders, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Ollivanders is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Ollivanders:
...
Ollivanders features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Ollivanders contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Ollivanders | Official name |
...
/**
 * Structure implementation for Ollivanders.
 * provides important functionality and atmosphere
 */
public class OllivandersStructure extends WizardingLocationStructure {
    
    public static final StructureType<OllivandersStructure> TYPE = StructureType.register(
        "ollivanders",
        OllivandersStructure::new
    );
    
    public OllivandersStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<OllivandersStructure> OLLIVANDERS = 
    StructureRegistry.register(
        "ollivanders",
        OllivandersStructure.TYPE,
