...
title: 'Chapter 386: Madam Malkin''s'
description: 'Madam Malkin''s - Implementation details and reference'
tags:
  - vi atlas
...
**Madam Malkin''s** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Madam Malkin''s, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Madam Malkin''s is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Madam Malkin''s:
...
Madam Malkin''s features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Madam Malkin''s contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Madam Malkin''s | Official name |
...
/**
 * Structure implementation for Madam Malkin''s.
 * provides important functionality and atmosphere
 */
public class MadamMalkinsStructure extends WizardingLocationStructure {
    
    public static final StructureType<MadamMalkinsStructure> TYPE = StructureType.register(
        "madam_malkin__s",
        MadamMalkinsStructure::new
    );
    
    public MadamMalkinsStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<MadamMalkinsStructure> MADAMMALKINS = 
    StructureRegistry.register(
        "madam_malkin__s",
        MadamMalkinsStructure.TYPE,
