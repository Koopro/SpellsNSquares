...
title: 'Chapter 356: Gryffindor Common Room'
description: Gryffindor Common Room - Implementation details and reference
tags:
  - vi atlas
  - 23 hogwarts ascent
---
...
**Gryffindor Common Room** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Gryffindor Common Room, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Gryffindor Common Room is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Gryffindor Common Room:
...
Gryffindor Common Room features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Gryffindor Common Room contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Gryffindor Common Room | Official name |
| **Location Type** | Common Room | Classification |
| **Region** | Hogwarts | Geographic region |
| **Access Level** | House Members Only | Required access |
...
/**
 * Structure implementation for Gryffindor Common Room.
 * provides important functionality and atmosphere
 */
public class GryffindorCommonRoomStructure extends WizardingLocationStructure {
    
    public static final StructureType<GryffindorCommonRoomStructure> TYPE = StructureType.register(
        "gryffindor_common_room",
        GryffindorCommonRoomStructure::new
    );
    
    public GryffindorCommonRoomStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<GryffindorCommonRoomStructure> GRYFFINDORCOMMONROOM = 
    StructureRegistry.register(
        "gryffindor_common_room",
        GryffindorCommonRoomStructure.TYPE,
