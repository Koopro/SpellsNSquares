...
title: 'Chapter 336: Moaning Myrtle''s Bathroom'
description: 'Moaning Myrtle''s Bathroom - Implementation details and reference'
tags:
  - vi atlas
  - 23 hogwarts ascent
---
...
**Moaning Myrtle''s Bathroom** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Moaning Myrtle''s Bathroom, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Moaning Myrtle''s Bathroom is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Moaning Myrtle''s Bathroom:
...
Moaning Myrtle''s Bathroom features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Moaning Myrtle''s Bathroom contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Moaning Myrtle''s Bathroom | Official name |
...
/**
 * Structure implementation for Moaning Myrtle''s Bathroom.
 * provides important functionality and atmosphere
 */
public class MoaningMyrtlesBathroomStructure extends WizardingLocationStructure {
    
    public static final StructureType<MoaningMyrtlesBathroomStructure> TYPE = StructureType.register(
        "moaning_myrtle__s_bathroom",
        MoaningMyrtlesBathroomStructure::new
    );
    
    public MoaningMyrtlesBathroomStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<MoaningMyrtlesBathroomStructure> MOANINGMYRTLESBATHROOM = 
    StructureRegistry.register(
        "moaning_myrtle__s_bathroom",
        MoaningMyrtlesBathroomStructure.TYPE,
