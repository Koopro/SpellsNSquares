...
title: 'Chapter 357: Fat Lady Portrait'
description: Fat Lady Portrait - Implementation details and reference
tags:
  - vi atlas
  - 23 hogwarts ascent
---
...
**Fat Lady Portrait** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Fat Lady Portrait, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Fat Lady Portrait is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Fat Lady Portrait:
...
Fat Lady Portrait features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Fat Lady Portrait contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Fat Lady Portrait | Official name |
...
/**
 * Structure implementation for Fat Lady Portrait.
 * provides important functionality and atmosphere
 */
public class FatLadyPortraitStructure extends WizardingLocationStructure {
    
    public static final StructureType<FatLadyPortraitStructure> TYPE = StructureType.register(
        "fat_lady_portrait",
        FatLadyPortraitStructure::new
    );
    
    public FatLadyPortraitStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<FatLadyPortraitStructure> FATLADYPORTRAIT = 
    StructureRegistry.register(
        "fat_lady_portrait",
        FatLadyPortraitStructure.TYPE,
