...
title: 'Chapter 340: Charms Classroom'
description: Charms Classroom - Implementation details and reference
tags:
  - vi atlas
  - 23 hogwarts ascent
---
...
**Charms Classroom** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Charms Classroom, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Charms Classroom is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Charms Classroom:
...
Charms Classroom features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Charms Classroom contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Charms Classroom | Official name |
...
/**
 * Structure implementation for Charms Classroom.
 * provides important functionality and atmosphere
 */
public class CharmsClassroomStructure extends WizardingLocationStructure {
    
    public static final StructureType<CharmsClassroomStructure> TYPE = StructureType.register(
        "charms_classroom",
        CharmsClassroomStructure::new
    );
    
    public CharmsClassroomStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<CharmsClassroomStructure> CHARMSCLASSROOM = 
    StructureRegistry.register(
        "charms_classroom",
        CharmsClassroomStructure.TYPE,
