...
title: 'Chapter 358: Boys'' Dormitories'
description: 'Boys'' Dormitories - Implementation details and reference'
tags:
  - vi atlas
  - 23 hogwarts ascent
---
...
**Boys'' Dormitories** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Boys'' Dormitories, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Boys'' Dormitories is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Boys'' Dormitories:
...
Boys'' Dormitories features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Boys'' Dormitories contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Boys'' Dormitories | Official name |
...
/**
 * Structure implementation for Boys'' Dormitories.
 * provides important functionality and atmosphere
 */
public class BoysDormitoriesStructure extends WizardingLocationStructure {
    
    public static final StructureType<BoysDormitoriesStructure> TYPE = StructureType.register(
        "boys___dormitories",
        BoysDormitoriesStructure::new
    );
    
    public BoysDormitoriesStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<BoysDormitoriesStructure> BOYSDORMITORIES = 
    StructureRegistry.register(
        "boys___dormitories",
        BoysDormitoriesStructure.TYPE,
