...
title: 'Chapter 359: Girls'' Dormitories'
description: 'Girls'' Dormitories - Implementation details and reference'
tags:
  - vi atlas
  - 23 hogwarts ascent
---
...
**Girls'' Dormitories** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Girls'' Dormitories, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Girls'' Dormitories is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Girls'' Dormitories:
...
Girls'' Dormitories features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Girls'' Dormitories contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Girls'' Dormitories | Official name |
...
/**
 * Structure implementation for Girls'' Dormitories.
 * provides important functionality and atmosphere
 */
public class GirlsDormitoriesStructure extends WizardingLocationStructure {
    
    public static final StructureType<GirlsDormitoriesStructure> TYPE = StructureType.register(
        "girls___dormitories",
        GirlsDormitoriesStructure::new
    );
    
    public GirlsDormitoriesStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<GirlsDormitoriesStructure> GIRLSDORMITORIES = 
    StructureRegistry.register(
        "girls___dormitories",
        GirlsDormitoriesStructure.TYPE,
