...
title: 'Chapter 375: Greenhouses 1-3'
description: Greenhouses 1-3 - Implementation details and reference
tags:
  - vi atlas
  - 25 grounds
---
...
**Greenhouses 1-3** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Greenhouses 1-3, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Greenhouses 1-3 is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Greenhouses 1-3:
...
Greenhouses 1-3 features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Greenhouses 1-3 contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Greenhouses 1-3 | Official name |
...
/**
 * Structure implementation for Greenhouses 1-3.
 * provides important functionality and atmosphere
 */
public class Greenhouses13Structure extends WizardingLocationStructure {
    
    public static final StructureType<Greenhouses13Structure> TYPE = StructureType.register(
        "greenhouses_1_3",
        Greenhouses13Structure::new
    );
    
    public Greenhouses13Structure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<Greenhouses13Structure> GREENHOUSES13 = 
    StructureRegistry.register(
        "greenhouses_1_3",
        Greenhouses13Structure.TYPE,
