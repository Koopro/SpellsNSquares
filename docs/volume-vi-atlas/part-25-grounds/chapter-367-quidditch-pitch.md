...
title: 'Chapter 367: Quidditch Pitch'
description: Quidditch Pitch - Implementation details and reference
tags:
  - vi atlas
  - 25 grounds
---
...
**Quidditch Pitch** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Quidditch Pitch, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Quidditch Pitch is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Quidditch Pitch:
...
Quidditch Pitch features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Quidditch Pitch contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Quidditch Pitch | Official name |
...
/**
 * Structure implementation for Quidditch Pitch.
 * provides important functionality and atmosphere
 */
public class QuidditchPitchStructure extends WizardingLocationStructure {
    
    public static final StructureType<QuidditchPitchStructure> TYPE = StructureType.register(
        "quidditch_pitch",
        QuidditchPitchStructure::new
    );
    
    public QuidditchPitchStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<QuidditchPitchStructure> QUIDDITCHPITCH = 
    StructureRegistry.register(
        "quidditch_pitch",
        QuidditchPitchStructure.TYPE,
