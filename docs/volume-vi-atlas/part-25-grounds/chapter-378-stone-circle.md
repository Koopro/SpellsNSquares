...
title: 'Chapter 378: Stone Circle'
description: Stone Circle - Implementation details and reference
tags:
  - vi atlas
  - 25 grounds
---
...
**Stone Circle** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Stone Circle, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Stone Circle is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Stone Circle:
...
Stone Circle features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Stone Circle contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Stone Circle | Official name |
...
/**
 * Structure implementation for Stone Circle.
 * provides important functionality and atmosphere
 */
public class StoneCircleStructure extends WizardingLocationStructure {
    
    public static final StructureType<StoneCircleStructure> TYPE = StructureType.register(
        "stone_circle",
        StoneCircleStructure::new
    );
    
    public StoneCircleStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<StoneCircleStructure> STONECIRCLE = 
    StructureRegistry.register(
        "stone_circle",
        StoneCircleStructure.TYPE,
