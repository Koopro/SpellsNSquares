...
title: 'Chapter 423: St Mungo''s Hospital'
description: 'St Mungo''s Hospital - Implementation details and reference'
tags:
  - vi atlas
  - 29 global locations
---
...
**St Mungo''s Hospital** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing St Mungo''s Hospital, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

St Mungo''s Hospital is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in St Mungo''s Hospital:
...
St Mungo''s Hospital features a carefully designed layout with specific rooms, areas, and architectural elements.
...
St Mungo''s Hospital contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | St Mungo''s Hospital | Official name |
...
/**
 * Structure implementation for St Mungo''s Hospital.
 * provides important functionality and atmosphere
 */
public class StMungosHospitalStructure extends WizardingLocationStructure {
    
    public static final StructureType<StMungosHospitalStructure> TYPE = StructureType.register(
        "st_mungo__s_hospital",
        StMungosHospitalStructure::new
    );
    
    public StMungosHospitalStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<StMungosHospitalStructure> STMUNGOSHOSPITAL = 
    StructureRegistry.register(
        "st_mungo__s_hospital",
        StMungosHospitalStructure.TYPE,
