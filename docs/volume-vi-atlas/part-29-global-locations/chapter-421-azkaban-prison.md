...
title: 'Chapter 421: Azkaban Prison'
description: Azkaban Prison - Implementation details and reference
tags:
  - vi atlas
  - 29 global locations
---
...
**Azkaban Prison** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Azkaban Prison, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Azkaban Prison is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Azkaban Prison:
...
Azkaban Prison features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Azkaban Prison contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Azkaban Prison | Official name |
...
/**
 * Structure implementation for Azkaban Prison.
 * provides important functionality and atmosphere
 */
public class AzkabanPrisonStructure extends WizardingLocationStructure {
    
    public static final StructureType<AzkabanPrisonStructure> TYPE = StructureType.register(
        "azkaban_prison",
        AzkabanPrisonStructure::new
    );
    
    public AzkabanPrisonStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<AzkabanPrisonStructure> AZKABANPRISON = 
    StructureRegistry.register(
        "azkaban_prison",
        AzkabanPrisonStructure.TYPE,
