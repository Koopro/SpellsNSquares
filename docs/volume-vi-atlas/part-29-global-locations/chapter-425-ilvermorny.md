...
title: 'Chapter 425: Ilvermorny'
description: Ilvermorny - Implementation details and reference
tags:
  - vi atlas
  - 29 global locations
---
...
**Ilvermorny** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Ilvermorny, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Ilvermorny is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Ilvermorny:
...
Ilvermorny features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Ilvermorny contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Ilvermorny | Official name |
...
/**
 * Structure implementation for Ilvermorny.
 * provides important functionality and atmosphere
 */
public class IlvermornyStructure extends WizardingLocationStructure {
    
    public static final StructureType<IlvermornyStructure> TYPE = StructureType.register(
        "ilvermorny",
        IlvermornyStructure::new
    );
    
    public IlvermornyStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<IlvermornyStructure> ILVERMORNY = 
    StructureRegistry.register(
        "ilvermorny",
        IlvermornyStructure.TYPE,
