...
title: 'Chapter 420: Spinner''s End'
description: 'Spinner''s End - Implementation details and reference'
tags:
  - vi atlas
  - 29 global locations
---
...
**Spinner''s End** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Spinner''s End, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Spinner''s End is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Spinner''s End:
...
Spinner''s End features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Spinner''s End contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Spinner''s End | Official name |
...
/**
 * Structure implementation for Spinner''s End.
 * provides important functionality and atmosphere
 */
public class SpinnersEndStructure extends WizardingLocationStructure {
    
    public static final StructureType<SpinnersEndStructure> TYPE = StructureType.register(
        "spinner__s_end",
        SpinnersEndStructure::new
    );
    
    public SpinnersEndStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<SpinnersEndStructure> SPINNERSEND = 
    StructureRegistry.register(
        "spinner__s_end",
        SpinnersEndStructure.TYPE,
