...
title: 'Chapter 424: MACUSA HQ'
description: MACUSA HQ - Implementation details and reference
tags:
  - vi atlas
  - 29 global locations
---
...
**MACUSA HQ** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing MACUSA HQ, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

MACUSA HQ is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in MACUSA HQ:
...
MACUSA HQ features a carefully designed layout with specific rooms, areas, and architectural elements.
...
MACUSA HQ contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | MACUSA HQ | Official name |
...
/**
 * Structure implementation for MACUSA HQ.
 * provides important functionality and atmosphere
 */
public class MACUSAHQStructure extends WizardingLocationStructure {
    
    public static final StructureType<MACUSAHQStructure> TYPE = StructureType.register(
        "macusa_hq",
        MACUSAHQStructure::new
    );
    
    public MACUSAHQStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<MACUSAHQStructure> MACUSAHQ = 
    StructureRegistry.register(
        "macusa_hq",
        MACUSAHQStructure.TYPE,
