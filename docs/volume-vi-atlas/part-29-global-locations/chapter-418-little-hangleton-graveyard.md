...
title: 'Chapter 418: Little Hangleton Graveyard'
description: Little Hangleton Graveyard - Implementation details and reference
tags:
  - vi atlas
  - 29 global locations
---
...
**Little Hangleton Graveyard** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Little Hangleton Graveyard, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Little Hangleton Graveyard is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Little Hangleton Graveyard:
...
Little Hangleton Graveyard features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Little Hangleton Graveyard contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Little Hangleton Graveyard | Official name |
| **Location Type** | Location | Classification |
| **Region** | Wizarding World | Geographic region |
...
/**
 * Structure implementation for Little Hangleton Graveyard.
 * provides important functionality and atmosphere
 */
public class LittleHangletonGraveyardStructure extends WizardingLocationStructure {
    
    public static final StructureType<LittleHangletonGraveyardStructure> TYPE = StructureType.register(
        "little_hangleton_graveyard",
        LittleHangletonGraveyardStructure::new
    );
    
    public LittleHangletonGraveyardStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<LittleHangletonGraveyardStructure> LITTLEHANGLETONGRAVEYARD = 
    StructureRegistry.register(
        "little_hangleton_graveyard",
        LittleHangletonGraveyardStructure.TYPE,
