...
title: 'Chapter 405: Courtrooms'
description: Courtrooms - Implementation details and reference
tags:
  - vi atlas
  - 27 ministry
---
...
**Courtrooms** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Courtrooms, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Courtrooms is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Courtrooms:
...
Courtrooms features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Courtrooms contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Courtrooms | Official name |
...
/**
 * Structure implementation for Courtrooms.
 * provides important functionality and atmosphere
 */
public class CourtroomsStructure extends WizardingLocationStructure {
    
    public static final StructureType<CourtroomsStructure> TYPE = StructureType.register(
        "courtrooms",
        CourtroomsStructure::new
    );
    
    public CourtroomsStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<CourtroomsStructure> COURTROOMS = 
    StructureRegistry.register(
        "courtrooms",
        CourtroomsStructure.TYPE,
