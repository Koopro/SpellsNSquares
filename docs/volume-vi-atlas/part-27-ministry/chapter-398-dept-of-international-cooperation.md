...
title: 'Chapter 398: Dept of International Cooperation'
description: Dept of International Cooperation - Implementation details and reference
tags:
  - vi atlas
  - 27 ministry
---
...
**Dept of International Cooperation** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Dept of International Cooperation, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Dept of International Cooperation is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Dept of International Cooperation:
...
Dept of International Cooperation features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Dept of International Cooperation contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Dept of International Cooperation | Official name |
| **Location Type** | Location | Classification |
| **Region** | Ministry of Magic | Geographic region |
...
| **Biome Requirement** | Any | Required biome |
...
/**
 * Structure implementation for Dept of International Cooperation.
 * provides important functionality and atmosphere
 */
public class DeptofInternationalCooperationStructure extends WizardingLocationStructure {
    
    public static final StructureType<DeptofInternationalCooperationStructure> TYPE = StructureType.register(
        "dept_of_international_cooperation",
        DeptofInternationalCooperationStructure::new
    );
    
    public DeptofInternationalCooperationStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<DeptofInternationalCooperationStructure> DEPTOFINTERNATIONALCOOPERATION = 
    StructureRegistry.register(
        "dept_of_international_cooperation",
        DeptofInternationalCooperationStructure.TYPE,
