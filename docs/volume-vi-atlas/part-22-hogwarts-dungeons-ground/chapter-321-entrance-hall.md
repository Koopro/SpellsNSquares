...
title: 'Chapter 321: Entrance Hall'
description: Entrance Hall - Implementation details and reference
tags:
  - vi atlas
...
**Entrance Hall** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Entrance Hall, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Entrance Hall is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Entrance Hall:
...
Entrance Hall features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Entrance Hall contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Entrance Hall | Official name |
...
/**
 * Structure implementation for Entrance Hall.
 * provides important functionality and atmosphere
 */
public class EntranceHallStructure extends WizardingLocationStructure {
    
    public static final StructureType<EntranceHallStructure> TYPE = StructureType.register(
        "entrance_hall",
        EntranceHallStructure::new
    );
    
    public EntranceHallStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<EntranceHallStructure> ENTRANCEHALL = 
    StructureRegistry.register(
        "entrance_hall",
        EntranceHallStructure.TYPE,
