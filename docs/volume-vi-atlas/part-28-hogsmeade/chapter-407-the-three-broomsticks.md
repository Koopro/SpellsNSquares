...
title: 'Chapter 407: The Three Broomsticks'
description: The Three Broomsticks - Implementation details and reference
tags:
  - vi atlas
  - 28 hogsmeade
---
...
**The Three Broomsticks** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing The Three Broomsticks, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

The Three Broomsticks is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in The Three Broomsticks:
...
The Three Broomsticks features a carefully designed layout with specific rooms, areas, and architectural elements.
...
The Three Broomsticks contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | The Three Broomsticks | Official name |
| **Location Type** | Location | Classification |
| **Region** | Hogsmeade | Geographic region |
...
/**
 * Structure implementation for The Three Broomsticks.
 * provides important functionality and atmosphere
 */
public class TheThreeBroomsticksStructure extends WizardingLocationStructure {
    
    public static final StructureType<TheThreeBroomsticksStructure> TYPE = StructureType.register(
        "the_three_broomsticks",
        TheThreeBroomsticksStructure::new
    );
    
    public TheThreeBroomsticksStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<TheThreeBroomsticksStructure> THETHREEBROOMSTICKS = 
    StructureRegistry.register(
        "the_three_broomsticks",
        TheThreeBroomsticksStructure.TYPE,
