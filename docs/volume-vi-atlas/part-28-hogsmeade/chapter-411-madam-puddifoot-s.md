...
title: 'Chapter 411: Madam Puddifoot''s'
description: 'Madam Puddifoot''s - Implementation details and reference'
tags:
  - vi atlas
  - 28 hogsmeade
---
...
**Madam Puddifoot''s** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Madam Puddifoot''s, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Madam Puddifoot''s is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Madam Puddifoot''s:
...
Madam Puddifoot''s features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Madam Puddifoot''s contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Madam Puddifoot''s | Official name |
...
/**
 * Structure implementation for Madam Puddifoot''s.
 * provides important functionality and atmosphere
 */
public class MadamPuddifootsStructure extends WizardingLocationStructure {
    
    public static final StructureType<MadamPuddifootsStructure> TYPE = StructureType.register(
        "madam_puddifoot__s",
        MadamPuddifootsStructure::new
    );
    
    public MadamPuddifootsStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<MadamPuddifootsStructure> MADAMPUDDIFOOTS = 
    StructureRegistry.register(
        "madam_puddifoot__s",
        MadamPuddifootsStructure.TYPE,
