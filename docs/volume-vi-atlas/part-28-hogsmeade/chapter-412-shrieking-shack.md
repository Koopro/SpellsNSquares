...
title: 'Chapter 412: Shrieking Shack'
description: Shrieking Shack - Implementation details and reference
tags:
  - vi atlas
  - 28 hogsmeade
---
...
**Shrieking Shack** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Shrieking Shack, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Shrieking Shack is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Shrieking Shack:
...
Shrieking Shack features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Shrieking Shack contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Shrieking Shack | Official name |
...
/**
 * Structure implementation for Shrieking Shack.
 * provides important functionality and atmosphere
 */
public class ShriekingShackStructure extends WizardingLocationStructure {
    
    public static final StructureType<ShriekingShackStructure> TYPE = StructureType.register(
        "shrieking_shack",
        ShriekingShackStructure::new
    );
    
    public ShriekingShackStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<ShriekingShackStructure> SHRIEKINGSHACK = 
    StructureRegistry.register(
        "shrieking_shack",
        ShriekingShackStructure.TYPE,
