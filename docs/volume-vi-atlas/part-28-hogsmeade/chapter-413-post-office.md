...
title: 'Chapter 413: Post Office'
description: Post Office - Implementation details and reference
tags:
  - vi atlas
  - 28 hogsmeade
---
...
**Post Office** is a significant location within the wizarding world that provides important functionality and atmosphere. This location serves as a hub for player activities and is essential for various gameplay mechanics.

This chapter provides comprehensive documentation for implementing Post Office, including its layout, dimensions, interactive elements, NPCs, quests, and all features that make this location unique in the mod.

## Implementation Details

### Location Layout

Post Office is designed with specific dimensions and layout to create an immersive experience.
...
The following NPCs can be found in Post Office:
...
Post Office features a carefully designed layout with specific rooms, areas, and architectural elements.
...
Post Office contains extensive loot opportunities and hidden secrets for players to discover.
...
|----------|-------|-------------|
| **Location Name** | Post Office | Official name |
...
/**
 * Structure implementation for Post Office.
 * provides important functionality and atmosphere
 */
public class PostOfficeStructure extends WizardingLocationStructure {
    
    public static final StructureType<PostOfficeStructure> TYPE = StructureType.register(
        "post_office",
        PostOfficeStructure::new
    );
    
    public PostOfficeStructure(Structure.StructureSettings settings) {
        super(settings);
    }
...
public static final StructureType<PostOfficeStructure> POSTOFFICE = 
    StructureRegistry.register(
        "post_office",
        PostOfficeStructure.TYPE,
