---
sidebar_position: 21
title: 'Chapter 21: Sanity & Fear Mechanics'
description: 'Sanity & Fear Mechanics - Implementation details and reference'
tags:
  - i wizard
  - 3 stats conditions
---
...
The **Sanity & Fear Mechanics** is a core system that manages core functionality. This system provides essential services and is essential for gameplay mechanics.

This chapter provides comprehensive technical documentation for implementing the Sanity & Fear Mechanics system, including its architecture, data flow, configuration options, API, integration points, and all implementation details needed for development.

## Implementation Details

### System Architecture

The Sanity & Fear Mechanics system is designed with a modular architecture that supports scalability and maintainability.
...
The Sanity & Fear Mechanics system supports extensive configuration options:
...
|----------|-------|-------------|
| **System Name** | Sanity & Fear Mechanics | Official system name |
...
/**
 * Manager for the Sanity & Fear Mechanics system.
 * manages core functionality
 */
public class SanityFearMechanicsManager {
    
    private static SanityFearMechanicsManager instance;
    private final SanityFearMechanicsConfig config;
    private final SanityFearMechanicsData data;
    
    private SanityFearMechanicsManager() {
        this.config = new SanityFearMechanicsConfig();
        this.data = new SanityFearMechanicsData();
        // Initialize system components
    }
    
    public static SanityFearMechanicsManager getInstance() {
        if (instance == null) {
            instance = new SanityFearMechanicsManager();
        }
        return instance;
    }
    ...
    public SanityFearMechanicsConfig getConfig() {
        return config;
    }
    
    public SanityFearMechanicsData getData() {
        return data;
    }
}
```
...
/**
 * Configuration for the Sanity & Fear Mechanics system.
 */
public class SanityFearMechanicsConfig {
    private boolean enabled = true;
    private int updateRate = 1;
    
    public SanityFearMechanicsConfig() {
...
public static final SystemManager SANITYFEARMECHANICS = register(
    "sanity___fear_mechanics",
    SanityFearMechanicsManager.getInstance()
);
```
