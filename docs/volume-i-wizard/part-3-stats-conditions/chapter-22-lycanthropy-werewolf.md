---
sidebar_position: 22
title: 'Chapter 22: Condition: Lycanthropy (Werewolf)'
description: 'Condition: Lycanthropy (Werewolf) - Implementation details and reference'
tags:
  - i wizard
  - 3 stats conditions
---
...
The **Condition: Lycanthropy** is a core system that manages core functionality. This system provides essential services and is essential for gameplay mechanics.

This chapter provides comprehensive technical documentation for implementing the Condition: Lycanthropy system, including its architecture, data flow, configuration options, API, integration points, and all implementation details needed for development.

## Implementation Details

### System Architecture

The Condition: Lycanthropy system is designed with a modular architecture that supports scalability and maintainability.
...
The Condition: Lycanthropy system supports extensive configuration options:
...
|----------|-------|-------------|
| **System Name** | Condition: Lycanthropy | Official system name |
...
/**
 * Manager for the Condition: Lycanthropy system.
 * manages core functionality
 */
public class ConditionLycanthropyManager {
    
    private static ConditionLycanthropyManager instance;
    private final ConditionLycanthropyConfig config;
    private final ConditionLycanthropyData data;
    
    private ConditionLycanthropyManager() {
        this.config = new ConditionLycanthropyConfig();
        this.data = new ConditionLycanthropyData();
        // Initialize system components
    }
    
    public static ConditionLycanthropyManager getInstance() {
        if (instance == null) {
            instance = new ConditionLycanthropyManager();
        }
        return instance;
    }
    ...
    public ConditionLycanthropyConfig getConfig() {
        return config;
    }
    
    public ConditionLycanthropyData getData() {
        return data;
    }
}
```
...
/**
 * Configuration for the Condition: Lycanthropy system.
 */
public class ConditionLycanthropyConfig {
    private boolean enabled = true;
    private int updateRate = 1;
    
    public ConditionLycanthropyConfig() {
...
public static final SystemManager CONDITIONLYCANTHROPY = register(
    "condition__lycanthropy",
    ConditionLycanthropyManager.getInstance()
);
```
