...
public class TwoWayMirrorItem extends Item {
    ...
    public InteractionResult use(Level level, Player player, InteractionHand hand) {
        ...
        if (data.isPaired()) {
            ...
            serverPlayer.sendSystemMessage(Component.literal("Right-click another mirror to pair"));
        }
    ...
    public static void pairMirrors(ItemStack mirror1, ItemStack mirror2, Player player) {
        ...
        if (player instanceof ServerPlayer serverPlayer) {
            serverPlayer.sendSystemMessage(Component.literal("Mirrors paired successfully!"));
        }
    }
    
    private void sendMessage(ServerPlayer sender, ItemStack mirror, MirrorData.MirrorDataComponent data) {
        sender.sendSystemMessage(Component.literal("Message sent via mirror"));
    }
