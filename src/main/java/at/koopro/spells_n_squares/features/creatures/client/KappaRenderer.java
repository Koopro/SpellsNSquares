...
import at.koopro.spells_n_squares.features.creatures.aquatic.KappaEntity;
...
/**
 * Renderer for Kappa entity - monkey-like water creature.
 */
public class KappaRenderer extends EntityRenderer<KappaEntity, EntityRenderState> {
    
    public KappaRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    public void extractRenderState(KappaEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Monkey-like body (green-blue)
                RendererUtils.renderCube(buffer, ps, half * 0.5f, 0xFF4A8B8B);
