...
import at.koopro.spells_n_squares.features.creatures.hostile.AcromantulaEntity;
...
/**
 * Renderer for Acromantula entity - large dark spider.
 */
public class AcromantulaRenderer extends EntityRenderer<AcromantulaEntity, EntityRenderState> {
    
    public AcromantulaRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    public void extractRenderState(AcromantulaEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Dark spider body
                RendererUtils.renderCube(buffer, ps, half * 0.9f, 0xFF2D1B1B);
