...
import at.koopro.spells_n_squares.features.creatures.hostile.RedCapEntity;
...
/**
 * Renderer for Red Cap entity - dwarf-like creature.
 */
public class RedCapRenderer extends EntityRenderer<RedCapEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(RedCapEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Dwarf-like body with red cap
                RendererUtils.renderCube(buffer, ps, half * 0.5f, 0xFF8B4513);
                
                // Red cap
                ps.pushPose();
                ps.translate(0, half * 0.4f, 0);
                RendererUtils.renderCube(buffer, ps, half * 0.4f, 0xFFFF0000);
                ps.popPose();
