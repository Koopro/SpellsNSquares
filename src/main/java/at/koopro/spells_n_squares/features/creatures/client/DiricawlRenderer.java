...
import at.koopro.spells_n_squares.features.creatures.neutral.DiricawlEntity;
...
/**
 * Renderer for Diricawl entity - plump flightless bird (dodo).
 */
public class DiricawlRenderer extends EntityRenderer<DiricawlEntity, EntityRenderState> {
    
    public DiricawlRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    public void extractRenderState(DiricawlEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Plump bird body (gray-brown)
                RendererUtils.renderCube(buffer, ps, half * 0.7f, 0xFF8B7355);
