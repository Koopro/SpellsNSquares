...
import at.koopro.spells_n_squares.features.creatures.neutral.UnicornEntity;
...
/**
 * Renderer for Unicorn entity - pure white horse with horn.
 */
public class UnicornRenderer extends EntityRenderer<UnicornEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(UnicornEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Pure white horse body
                RendererUtils.renderCube(buffer, ps, half * 0.7f, 0xFFFFFFFF);
                
                // Horn
                ps.pushPose();
                ps.translate(0, half * 0.5f, 0);
                RendererUtils.renderCube(buffer, ps, half * 0.1f, half * 0.3f, half * 0.1f, 0, 0xFFFFD700);
                ps.popPose();
