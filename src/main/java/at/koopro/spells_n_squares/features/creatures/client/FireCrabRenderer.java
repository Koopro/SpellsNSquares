...
import at.koopro.spells_n_squares.features.creatures.neutral.FireCrabEntity;
...
/**
 * Renderer for Fire Crab entity - turtle-like creature.
 */
public class FireCrabRenderer extends EntityRenderer<FireCrabEntity, EntityRenderState> {
    
    public FireCrabRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    public void extractRenderState(FireCrabEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Turtle-like body (red/orange)
                RendererUtils.renderCube(buffer, ps, half * 0.8f, 0xFFFF6600);
