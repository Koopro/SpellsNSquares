...
import at.koopro.spells_n_squares.features.creatures.neutral.TrollEntity;
...
/**
 * Renderer for Troll entity - large, dim-witted creature.
 */
public class TrollRenderer extends EntityRenderer<TrollEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(TrollEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Large troll body (gray)
                RendererUtils.renderCube(buffer, ps, half * 0.9f, 0xFF808080);
