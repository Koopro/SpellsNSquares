...
import at.koopro.spells_n_squares.features.creatures.neutral.GhoulEntity;
...
/**
 * Renderer for Ghoul entity - slimy, buck-toothed creature.
 */
public class GhoulRenderer extends EntityRenderer<GhoulEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(GhoulEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Slimy body (green-gray)
                RendererUtils.renderCube(buffer, ps, half * 0.6f, 0xFF6B8E6B);
