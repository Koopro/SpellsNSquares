...
/**
 * Renderer for Owl entity.
 */
public class OwlRenderer extends EntityRenderer<OwlEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(OwlEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Small bird-like body (brownish tint for owl)
                RendererUtils.renderCube(buffer, ps, half * 0.8f, 0xFF8B7355);
