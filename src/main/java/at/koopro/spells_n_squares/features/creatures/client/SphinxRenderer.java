...
import at.koopro.spells_n_squares.features.creatures.neutral.SphinxEntity;
...
/**
 * Renderer for Sphinx entity - human head, lion body.
 */
public class SphinxRenderer extends EntityRenderer<SphinxEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(SphinxEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Lion body
                RendererUtils.renderCube(buffer, ps, half * 0.8f, 0xFFFFA500);
