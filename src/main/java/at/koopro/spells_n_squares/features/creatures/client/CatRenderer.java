...
import at.koopro.spells_n_squares.features.creatures.CatEntity;
...
/**
 * Renderer for Cat entity.
 */
public class CatRenderer extends EntityRenderer<CatEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(CatEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Small cat-like body (orange/brownish tint)
                RendererUtils.renderCube(buffer, ps, half * 0.7f, 0xFFD4A574);
