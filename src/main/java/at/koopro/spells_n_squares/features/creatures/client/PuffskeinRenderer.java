...
import at.koopro.spells_n_squares.features.creatures.companion.PuffskeinEntity;
...
/**
 * Renderer for Puffskein entity - a fluffy round creature.
 */
public class PuffskeinRenderer extends EntityRenderer<PuffskeinEntity, EntityRenderState> {
    
    public PuffskeinRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    public void extractRenderState(PuffskeinEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Fluffy round body (yellow/cream colored)
                RendererUtils.renderCube(buffer, ps, half * 0.9f, 0xFFFFF8DC);
