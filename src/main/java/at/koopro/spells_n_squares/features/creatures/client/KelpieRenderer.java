...
import at.koopro.spells_n_squares.features.creatures.aquatic.KelpieEntity;
...
/**
 * Renderer for Kelpie entity - shape-shifting water demon (horse form).
 */
public class KelpieRenderer extends EntityRenderer<KelpieEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(KelpieEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Horse form (dark blue-black)
                RendererUtils.renderCube(buffer, ps, half * 0.7f, 0xFF1A1A2A);
