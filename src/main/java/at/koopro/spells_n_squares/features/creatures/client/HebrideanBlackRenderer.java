...
import at.koopro.spells_n_squares.features.creatures.hostile.HebrideanBlackEntity;
...
/**
 * Renderer for Hebridean Black entity - black dragon.
 */
public class HebrideanBlackRenderer extends EntityRenderer<HebrideanBlackEntity, EntityRenderState> {
    
    public HebrideanBlackRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    public void extractRenderState(HebrideanBlackEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Black dragon body
                RendererUtils.renderCube(buffer, ps, half * 1.0f, 0xFF000000);
