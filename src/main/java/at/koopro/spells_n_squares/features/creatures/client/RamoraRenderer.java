...
import at.koopro.spells_n_squares.features.creatures.aquatic.RamoraEntity;
...
/**
 * Renderer for Ramora entity - silver fish.
 */
public class RamoraRenderer extends EntityRenderer<RamoraEntity, EntityRenderState> {
    
    public RamoraRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    public void extractRenderState(RamoraEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Silver fish body
                RendererUtils.renderCube(buffer, ps, half * 0.5f, half * 0.3f, half * 0.4f, 0, 0xFFC0C0C0);
