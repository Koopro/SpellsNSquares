...
import at.koopro.spells_n_squares.features.creatures.neutral.ReemEntity;
...
/**
 * Renderer for Re'em entity - giant golden oxen.
 */
public class ReemRenderer extends EntityRenderer<ReemEntity, EntityRenderState> {
    
    public ReemRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    public void extractRenderState(ReemEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Giant golden oxen body
                RendererUtils.renderCube(buffer, ps, half * 0.9f, 0xFFFFD700);
