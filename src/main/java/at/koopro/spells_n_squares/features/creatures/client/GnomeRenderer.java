...
import at.koopro.spells_n_squares.features.creatures.neutral.GnomeEntity;
...
/**
 * Renderer for Gnome entity - small garden pest.
 */
public class GnomeRenderer extends EntityRenderer<GnomeEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(GnomeEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Small gnome body (brown)
                RendererUtils.renderCube(buffer, ps, half * 0.4f, 0xFF8B4513);
