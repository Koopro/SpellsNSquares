...
/**
 * Peruvian Vipertooth - A small but fast dragon breed with copper-colored scales and venomous fangs.
 */
public class PeruvianVipertoothEntity extends PathfinderMob {
    
    public PeruvianVipertoothEntity(EntityType<? extends PeruvianVipertoothEntity> type, Level level) {
        super(type, level);
    }
