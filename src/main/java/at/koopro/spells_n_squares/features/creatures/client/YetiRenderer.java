...
import at.koopro.spells_n_squares.features.creatures.neutral.YetiEntity;
...
/**
 * Renderer for Yeti entity - giant humanoid creature.
 */
public class YetiRenderer extends EntityRenderer<YetiEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(YetiEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Giant white humanoid body
                RendererUtils.renderCube(buffer, ps, half * 0.8f, half * 1.2f, half * 0.5f, 0, 0xFFFFFFFF);
