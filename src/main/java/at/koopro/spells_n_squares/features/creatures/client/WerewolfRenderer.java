...
import at.koopro.spells_n_squares.features.creatures.special.WerewolfEntity;
...
/**
 * Renderer for Werewolf entity - wolf-like creature.
 */
public class WerewolfRenderer extends EntityRenderer<WerewolfEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(WerewolfEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Wolf-like body (gray-brown)
                RendererUtils.renderCube(buffer, ps, half * 0.6f, half * 0.8f, half * 0.5f, 0, 0xFF8B7355);
