...
import at.koopro.spells_n_squares.features.creatures.neutral.ImpEntity;
...
/**
 * Renderer for Imp entity - small mischievous creature.
 */
public class ImpRenderer extends EntityRenderer<ImpEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(ImpEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Small imp body (red)
                RendererUtils.renderCube(buffer, ps, half * 0.3f, 0xFFFF0000);
