...
import at.koopro.spells_n_squares.features.creatures.mount.HippogriffEntity;
...
/**
 * Renderer for Hippogriff entity.
 */
public class HippogriffRenderer extends EntityRenderer<HippogriffEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(HippogriffEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Body (brownish)
                RendererUtils.renderCube(buffer, ps, half * 0.8f, 0xFF8B4513);
