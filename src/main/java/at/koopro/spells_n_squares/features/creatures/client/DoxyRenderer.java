...
import at.koopro.spells_n_squares.features.creatures.hostile.DoxyEntity;
...
/**
 * Renderer for Doxy entity - small fairy-like creature.
 */
public class DoxyRenderer extends EntityRenderer<DoxyEntity, EntityRenderState> {
    
    public DoxyRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    public void extractRenderState(DoxyEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Small fairy-like body (blue)
                RendererUtils.renderCube(buffer, ps, half * 0.3f, 0xFF0000FF);
