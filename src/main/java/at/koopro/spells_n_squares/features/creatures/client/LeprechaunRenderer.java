...
import at.koopro.spells_n_squares.features.creatures.neutral.LeprechaunEntity;
...
/**
 * Renderer for Leprechaun entity - small gold-loving creature.
 */
public class LeprechaunRenderer extends EntityRenderer<LeprechaunEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(LeprechaunEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Small leprechaun body (green)
                RendererUtils.renderCube(buffer, ps, half * 0.4f, 0xFF00AA00);
