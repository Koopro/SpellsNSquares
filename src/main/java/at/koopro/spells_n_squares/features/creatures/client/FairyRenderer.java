...
import at.koopro.spells_n_squares.features.creatures.neutral.FairyEntity;
...
/**
 * Renderer for Fairy entity - small humanoid with insect wings.
 */
public class FairyRenderer extends EntityRenderer<FairyEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(FairyEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Small humanoid body
                RendererUtils.renderCube(buffer, ps, half * 0.4f, 0xFFFFD700);
