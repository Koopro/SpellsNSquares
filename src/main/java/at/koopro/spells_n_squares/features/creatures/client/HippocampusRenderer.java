...
import at.koopro.spells_n_squares.features.creatures.aquatic.HippocampusEntity;
...
/**
 * Renderer for Hippocampus entity - horse head, fish tail.
 */
public class HippocampusRenderer extends EntityRenderer<HippocampusEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(HippocampusEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Horse head and front, fish tail
                RendererUtils.renderCube(buffer, ps, half * 0.6f, half * 0.8f, half * 0.5f, 0, 0xFF4A90E2);
