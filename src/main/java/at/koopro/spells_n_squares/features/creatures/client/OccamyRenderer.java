...
import at.koopro.spells_n_squares.features.creatures.mount.OccamyEntity;
...
/**
 * Renderer for Occamy entity - a shape-shifting serpent.
 */
public class OccamyRenderer extends EntityRenderer<OccamyEntity, EntityRenderState> {
    
    public OccamyRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    public void extractRenderState(OccamyEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Serpent-like body (blue/silver colored)
                RendererUtils.renderCube(buffer, ps, half * 0.8f, 0xFF87CEEB);
                
                // Long body segments
                ps.pushPose();
                ps.translate(0, 0, half * 0.5f);
                RendererUtils.renderCube(buffer, ps, half * 0.7f, 0xFFB0E0E6);
                ps.popPose();
