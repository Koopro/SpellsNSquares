...
import at.koopro.spells_n_squares.features.creatures.mount.ThestralEntity;
...
/**
 * Renderer for Thestral entity - ethereal dark appearance.
 */
public class ThestralRenderer extends EntityRenderer<ThestralEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(ThestralEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Dark ethereal body
                RendererUtils.renderCube(buffer, ps, half * 0.7f, 0x80000000);
