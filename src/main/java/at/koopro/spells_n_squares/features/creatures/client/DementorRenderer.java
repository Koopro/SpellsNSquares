...
/**
 * Renderer for Dementor entity.
 */
public class DementorRenderer extends EntityRenderer<DementorEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(DementorEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Tall dark figure (dark gray/black tint for dementor)
                RendererUtils.renderCube(buffer, ps, half * 0.6f, half * 1.5f, half * 0.6f, 0.0f, 0xFF1A1A1A);
