...
/**
 * Raven - a familiar companion creature, intelligent bird.
 */
public class RavenEntity extends BaseTamableCreatureEntity {
        ...
        if (!hasOwner() && !stack.isEmpty()) {
            if (stack.is(net.minecraft.world.item.Items.WHEAT_SEEDS) || 
                ...
                if (!this.level().isClientSide() && player instanceof net.minecraft.server.level.ServerPlayer serverPlayer) {
                    ...
                    serverPlayer.sendSystemMessage(Component.translatable("message.spells_n_squares.raven.tamed"));
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob partner) {
        return null; // Ravens don't breed
    }
}
