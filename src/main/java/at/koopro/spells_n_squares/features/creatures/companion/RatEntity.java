...
/**
 * Rat - a familiar companion creature, small and quick.
 */
public class RatEntity extends BaseTamableCreatureEntity {
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (!hasOwner() && !stack.isEmpty()) {
            if (stack.is(net.minecraft.world.item.Items.BREAD) || 
                stack.is(net.minecraft.world.item.Items.COOKIE) ||
                ...
                if (!this.level().isClientSide() && player instanceof net.minecraft.server.level.ServerPlayer serverPlayer) {
                    ...
                    this.level().playSound(null, this.blockPosition(), SoundEvents.VILLAGER_YES, SoundSource.NEUTRAL, 0.8f, 1.5f);
                    serverPlayer.sendSystemMessage(Component.translatable("message.spells_n_squares.rat.tamed"));
