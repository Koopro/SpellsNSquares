...
/**
 * Renderer for Niffler entity - a small black creature with a long snout.
 */
public class NifflerRenderer extends EntityRenderer<NifflerEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(NifflerEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Small black body (Niffler is black/dark brown)
                RendererUtils.renderCube(buffer, ps, half * 0.8f, 0xFF2A1F1A);
                
                // Small snout
                ps.pushPose();
                ps.translate(0, 0, half * 0.5f);
                RendererUtils.renderCube(buffer, ps, half * 0.3f, 0xFF1A1510);
                ps.popPose();
