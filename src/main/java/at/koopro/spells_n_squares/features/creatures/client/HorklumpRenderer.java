...
import at.koopro.spells_n_squares.features.creatures.neutral.HorklumpEntity;
...
/**
 * Renderer for Horklump entity - pink mushroom-like creature.
 */
public class HorklumpRenderer extends EntityRenderer<HorklumpEntity, EntityRenderState> {
    
    public HorklumpRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    public void extractRenderState(HorklumpEntity entity, EntityRenderState state, float partialTick) {
    ...
    public void submit(EntityRenderState renderState, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraState) {
        ...
        collector.submitCustomGeometry(
            ...
            (pose, buffer) -> {
                ...
                // Pink mushroom-like body
                RendererUtils.renderCube(buffer, ps, half * 0.5f, 0xFFFFB6C1);
