...
import at.koopro.spells_n_squares.features.creatures.hostile.PixieEntity;
...
/**
 * Renderer for Pixie entity - small blue mischievous creature.
 */
public class PixieRenderer extends EntityRenderer<PixieEntity, EntityRenderState> {
    ...
    @Override
    public void extractRenderState(PixieEntity entity, EntityRenderState state, float partialTick) {
