...
public final class MirrorOfErisedData {
    ...
    public record MirrorOfErisedComponent(
        ...
        public Desire getPrimaryDesire() {
            ...
            // Return the most recent desire (safety check to prevent IndexOutOfBoundsException)
            int lastIndex = desires.size() - 1;
            if (lastIndex < 0 || lastIndex >= desires.size()) {
                return null;
            }
            return desires.get(lastIndex);
        }
    }
}
