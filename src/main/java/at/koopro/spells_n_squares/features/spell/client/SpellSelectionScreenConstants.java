...
/**
 * Constants for SpellSelectionScreen UI layout.
 */
public final class SpellSelectionScreenConstants {
    private SpellSelectionScreenConstants() {
    ...
    public static final int SLOT_BUTTON_Y = 30;
    public static final int SCROLL_BUTTON_Y_OFFSET = 40;
    
    // Title positioning
    public static final int TITLE_Y = 15;
    public static final int TITLE_BG_PADDING = 8;
