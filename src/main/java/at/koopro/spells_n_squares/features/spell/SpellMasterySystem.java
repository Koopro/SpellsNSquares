...
public final class SpellMasterySystem {
    ...
    public static void incrementSpellUse(Player player, Identifier spellId) {
        ...
        Map<Identifier, Integer> masteryUses = new HashMap<>(current.masteryUses());
        ...
        if (newLevel != oldLevel && player instanceof ServerPlayer serverPlayer) {
            ...
            at.koopro.spells_n_squares.features.spell.Spell spell = at.koopro.spells_n_squares.core.registry.SpellRegistry.get(spellId);
            if (spell != null) {
