package at.koopro.spells_n_squares.features.spell.base;
    ...
    default void spawnCastEffects(Player player, Level level, boolean success) {
        if (level.isClientSide()) {
            if (success) {
                ...
                // Enhanced failure feedback: subtle red flash and shake
                at.koopro.spells_n_squares.features.fx.ScreenEffectManager.triggerOverlay(
                    0xFFFF0000, 0.15f, 8, 
                    at.koopro.spells_n_squares.features.fx.ScreenEffectManager.ScreenOverlay.OverlayType.FLASH);
                at.koopro.spells_n_squares.features.fx.ScreenEffectManager.triggerShake(0.03f, 5);
            }
        }
    }
}
