package at.koopro.spells_n_squares.features.contracts.system;

import at.koopro.spells_n_squares.features.contracts.data.ContractData;
import at.koopro.spells_n_squares.features.contracts.handler.ContractHandler;
import at.koopro.spells_n_squares.features.contracts.item.ContractItem;
...
public final class ContractSystem {
    ...
    public static ContractData.ContractComponent getContractData(ItemStack stack) {
        ...
        return at.koopro.spells_n_squares.core.data.ItemDataHelper.getData(stack, ContractData.CONTRACT_DATA.get())
            .orElse(null);
    }
