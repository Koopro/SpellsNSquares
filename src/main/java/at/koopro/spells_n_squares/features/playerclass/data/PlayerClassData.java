package at.koopro.spells_n_squares.features.playerclass.data;
...
public final class PlayerClassData {
    ...
    public record PlayerClassComponent(
         ...
         * Delegates to PlayerClassManager.getPrimaryClass() to avoid code duplication.
         */
        private static PlayerClass getPrimaryClassFromSet(Set<PlayerClass> classes) {
            return PlayerClassManager.getPrimaryClass(classes);
        }
     ...
     * Uses PlayerDataComponent via PlayerDataHelper.
     */
    public static PlayerClassComponent getPlayerClassData(Player player) {
        // Get from PlayerDataComponent
        return at.koopro.spells_n_squares.core.data.PlayerDataHelper.getPlayerClassData(player);
    }
    ...
    public static void setPlayerClassData(Player player, PlayerClassComponent data) {
        // Save to PlayerDataComponent
        at.koopro.spells_n_squares.core.data.PlayerDataHelper.setPlayerClassData(player, data);
    }
