package at.koopro.spells_n_squares.features.quidditch.system;

import at.koopro.spells_n_squares.features.quidditch.QuidditchMatch;
import at.koopro.spells_n_squares.features.quidditch.QuidditchPitch;
...
public final class QuidditchTeamManager {
     ...
     * Gets all teams.
     */
    public static Collection<QuidditchTeam> getAllTeams() {
    ...
    public static boolean deleteTeam(String teamName) {
        QuidditchTeam team = teams.remove(teamName);
        if (team != null) {
            // Remove all players from the team
            for (ServerPlayer player : new ArrayList<>(team.getPlayers())) {
