...
public class ModMenus {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<EnchantmentTableMenu>> ENCHANTMENT_TABLE_MENU = MENUS.register(
        "enchantment_table_menu",
        () -> IMenuTypeExtension.create(EnchantmentTableMenu::new)
    );
